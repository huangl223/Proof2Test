// Automatically generated (04/01/2023 10:53:41.496 AM)
...
implementation ACCOUNT_1.invariant_admissibility_check(Current: ref)
{
  ...
  goto pre, a2, a3;
  pre:
  assert user_inv_readable(Heap, Current)[Current, ACCOUNT_1.credit_limit]; // type:access tag:attribute_readable line:99 cid:36 fid:80
  assume (0) >= (Heap[Current, ACCOUNT_1.credit_limit]);
  assert user_inv_readable(Heap, Current)[Current, ACCOUNT_1.balance]; // type:access tag:attribute_readable line:100 cid:36 fid:79
  assert user_inv_readable(Heap, Current)[Current, ACCOUNT_1.credit_limit]; // type:access tag:attribute_readable line:100 cid:36 fid:80
...
implementation create.ACCOUNT_1.make(Current: ref)
{
  ...
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\account\account_1.e:18
  // balance := 0
  call update_heap(Current, ACCOUNT_1.balance, 0); // line:18
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\account\account_1.e:19
  // credit_limit := 0
...
implementation ACCOUNT_1.available_amount(Current: ref) returns (Result: int)
{
  ...
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\account\account_1.e:38
  // Result := balance - credit_limit
  assert readable[Current, ACCOUNT_1.balance]; // type:access tag:attribute_readable line:38 cid:36 fid:79
  assert readable[Current, ACCOUNT_1.credit_limit]; // type:access tag:attribute_readable line:38 cid:36 fid:80
...
implementation ACCOUNT_1.set_credit_limit(Current: ref, limit: int)
{
  ...
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\account\account_1.e:49
  // credit_limit := limit
...
implementation ACCOUNT_1.deposit(Current: ref, amount: int)
{
  ...
  assume ACCOUNT_1.user_inv(Heap, Current);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\account\account_1.e:61
...
implementation ACCOUNT_1.withdraw(Current: ref, amount: int)
{
  ...
  assume ACCOUNT_1.user_inv(Heap, Current);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\account\account_1.e:74
  // balance := balance - amount
...
implementation ACCOUNT_1.transfer(Current: ref, amount: int, other: ref)
{
  ...
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\account\account_1.e:90
  // withdraw (amount)
  call ACCOUNT_1.withdraw(Current, amount); // line:90 cid:36 rid:1079
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\account\account_1.e:91
  // other.deposit (amount)
  assert {:subsumption 0} (other) != (Void); // type:attached line:91
  call ACCOUNT_1.deposit(other, amount); // line:91 cid:36 rid:1078
}
...
axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T2> $o: ref, $f: Field T2 :: { modify.ACCOUNT_1.make(heap, current)[$o, $f] } (modify.ACCOUNT_1.make(heap, current)[$o, $f]) <==> (($o) == (current))))));

function modify.ACCOUNT_1.available_amount(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T3> $o: ref, $f: Field T3 :: { modify.ACCOUNT_1.available_amount(heap, current)[$o, $f] } (modify.ACCOUNT_1.available_amount(heap, current)[$o, $f]) <==> (false)))));

function read.fun.ACCOUNT_1.available_amount(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T4> $o: ref, $f: Field T4 :: { read.fun.ACCOUNT_1.available_amount(heap, current)[$o, $f] } (read.fun.ACCOUNT_1.available_amount(heap, current)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));
...
axiom ((forall heap: HeapType, current: ref, limit: int :: (IsHeap(heap)) ==> ((forall <T5> $o: ref, $f: Field T5 :: { modify.ACCOUNT_1.set_credit_limit(heap, current, limit)[$o, $f] } (modify.ACCOUNT_1.set_credit_limit(heap, current, limit)[$o, $f]) <==> ((($o) == (current)) && ((($f) == (ACCOUNT_1.credit_limit)) || (($f) == (closed))))))));

function modify.ACCOUNT_1.deposit(heap: HeapType, current: ref, amount: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, amount: int :: (IsHeap(heap)) ==> ((forall <T6> $o: ref, $f: Field T6 :: { modify.ACCOUNT_1.deposit(heap, current, amount)[$o, $f] } (modify.ACCOUNT_1.deposit(heap, current, amount)[$o, $f]) <==> ((($o) == (current)) && ((($f) == (ACCOUNT_1.balance)) || (($f) == (closed))))))));

function modify.ACCOUNT_1.withdraw(heap: HeapType, current: ref, amount: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, amount: int :: (IsHeap(heap)) ==> ((forall <T7> $o: ref, $f: Field T7 :: { modify.ACCOUNT_1.withdraw(heap, current, amount)[$o, $f] } (modify.ACCOUNT_1.withdraw(heap, current, amount)[$o, $f]) <==> ((($o) == (current)) && ((($f) == (ACCOUNT_1.balance)) || (($f) == (closed))))))));

function modify.ACCOUNT_1.transfer(heap: HeapType, current: ref, amount: int, other: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, amount: int, other: ref :: (IsHeap(heap)) ==> ((forall <T8> $o: ref, $f: Field T8 :: { modify.ACCOUNT_1.transfer(heap, current, amount, other)[$o, $f] } (modify.ACCOUNT_1.transfer(heap, current, amount, other)[$o, $f]) <==> (((($o) == (current)) || (($o) == (other))) && ((($f) == (ACCOUNT_1.balance)) || (($f) == (closed))))))));
...
axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T11> $o: ref, $f: Field T11 :: { modify.ACCOUNT_1.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.ACCOUNT_1.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.ACCOUNT_1.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T12> $o: ref, $f: Field T12 :: { read.fun.ACCOUNT_1.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.ACCOUNT_1.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));
