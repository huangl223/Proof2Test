// Automatically generated (04/01/2023 11:45:49.555 AM)
...
const unique ACCOUNT_2: Type;

axiom ((ACCOUNT_2) <: (ANY));

axiom ((forall t: Type :: { (ACCOUNT_2) <: (t) } ((ACCOUNT_2) <: (t)) <==> (((t) == (ACCOUNT_2)) || ((ANY) <: (t)))));

axiom ((FieldId(allocated, ACCOUNT_2)) == (-1));

axiom ((FieldId(closed, ACCOUNT_2)) == (-2));

axiom ((FieldId(owner, ACCOUNT_2)) == (-3));

axiom ((FieldId(owns, ACCOUNT_2)) == (-4));

axiom ((FieldId(observers, ACCOUNT_2)) == (-5));

axiom ((FieldId(subjects, ACCOUNT_2)) == (-6));

axiom ((forall <T0> $f: Field T0 :: { IsModelField($f, ACCOUNT_2) } (IsModelField($f, ACCOUNT_2)) <==> ((($f) == (subjects)) || (($f) == (observers)))));

function { :inline } ACCOUNT_2.user_inv(heap: HeapType, current: ref) returns (bool) {
  ((0) >= (heap[current, ACCOUNT_2.credit_limit])) && ((heap[current, ACCOUNT_2.balance]) >= (heap[current, ACCOUNT_2.credit_limit])) && (Set#IsEmpty(heap[current, observers])) && (Set#IsEmpty(heap[current, subjects])) && (Set#IsEmpty(heap[current, owns])) && (admissibility2(heap, current))
}

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached_exact(heap, current, ACCOUNT_2)) ==> ((user_inv(heap, current)) <==> (ACCOUNT_2.user_inv(heap, current)))));

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached(heap, current, ACCOUNT_2)) ==> ((user_inv(heap, current)) ==> (ACCOUNT_2.user_inv(heap, current)))));

procedure ACCOUNT_2.invariant_admissibility_check(Current: ref);
  requires attached_exact(Heap, Current, ACCOUNT_2);



implementation ACCOUNT_2.invariant_admissibility_check(Current: ref)
{
  entry:
  goto pre, a2, a3;
  pre:
  assert user_inv_readable(Heap, Current)[Current, ACCOUNT_2.credit_limit]; // type:access tag:attribute_readable line:99 cid:37 fid:80
  assume (0) >= (Heap[Current, ACCOUNT_2.credit_limit]);
  assert user_inv_readable(Heap, Current)[Current, ACCOUNT_2.balance]; // type:access tag:attribute_readable line:100 cid:37 fid:79
  assert user_inv_readable(Heap, Current)[Current, ACCOUNT_2.credit_limit]; // type:access tag:attribute_readable line:100 cid:37 fid:80
  assume (Heap[Current, ACCOUNT_2.balance]) >= (Heap[Current, ACCOUNT_2.credit_limit]);
  return;
  a2:
...
procedure create.ACCOUNT_2.make(Current: ref);
  free requires attached_exact(Heap, Current, ACCOUNT_2); // info:type property for argument Current
  modifies Heap;
  ensures (Heap[Current, ACCOUNT_2.balance]) == (0); // type:post tag:balance_set line:21
  ensures (Heap[Current, ACCOUNT_2.credit_limit]) == (0); // type:post tag:credit_limit_set line:22
  ...
  requires Frame#Subset(modify.ACCOUNT_2.make(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.ACCOUNT_2.make(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts



implementation create.ACCOUNT_2.make(Current: ref)
{
  entry:
  assume {:captureState "create.ACCOUNT_2.make"} true;
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\account\account_2.e:18
  // balance := 0
  call update_heap(Current, ACCOUNT_2.balance, 0); // line:18
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\account\account_2.e:19
  // credit_limit := 0
  call update_heap(Current, ACCOUNT_2.credit_limit, 0); // line:19
  if (*) {
    assert (0) >= (Heap[Current, ACCOUNT_2.credit_limit]); // type:inv tag:credit_limit_not_positive line:79 cid:4 rid:53
    assume false;
  }
  if (*) {
    assert (Heap[Current, ACCOUNT_2.balance]) >= (Heap[Current, ACCOUNT_2.credit_limit]); // type:inv tag:balance_non_negative line:79 cid:4 rid:53
    assume false;
  }
  if (*) {
...
procedure ACCOUNT_2.available_amount(Current: ref) returns (Result: int where is_integer_32(Result));
  free requires attached_exact(Heap, Current, ACCOUNT_2); // info:type property for argument Current
  modifies Heap;
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.ACCOUNT_2.available_amount(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.ACCOUNT_2.available_amount(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.ACCOUNT_2.available_amount(Heap, Current), readable);



function fun.ACCOUNT_2.available_amount(heap: HeapType, current: ref) returns (int);

function fun0.ACCOUNT_2.available_amount(heap: HeapType, current: ref) returns (int);

axiom ((forall heap: HeapType, current: ref :: { fun.ACCOUNT_2.available_amount(heap, current) } (pre.fun.ACCOUNT_2.available_amount(heap, current)) ==> (is_integer_32(fun.ACCOUNT_2.available_amount(heap, current)))));

axiom ((forall heap: HeapType, current: ref :: { fun.ACCOUNT_2.available_amount(heap, current) } { trigger.fun.ACCOUNT_2.available_amount(heap, current) } (pre.fun.ACCOUNT_2.available_amount(heap, current)) ==> ((fun.ACCOUNT_2.available_amount(heap, current)) == ((heap[current, ACCOUNT_2.balance]) - (heap[current, ACCOUNT_2.credit_limit])))));

axiom ((forall heap: HeapType, current: ref :: { fun.ACCOUNT_2.available_amount(heap, current) } (fun.ACCOUNT_2.available_amount(heap, current)) == (fun0.ACCOUNT_2.available_amount(heap, current))));

axiom ((forall h: HeapType, h': HeapType, current: ref :: { HeapSucc(h, h'), fun0.ACCOUNT_2.available_amount(h, current), fun0.ACCOUNT_2.available_amount(h', current) } ((HeapSucc(h, h')) && (pre.fun.ACCOUNT_2.available_amount(h, current)) && (pre.fun.ACCOUNT_2.available_amount(h', current)) && (same_inside(h, h', read.fun.ACCOUNT_2.available_amount(h, current)))) ==> ((fun0.ACCOUNT_2.available_amount(h, current)) == (fun0.ACCOUNT_2.available_amount(h', current)))));

function { :inline } variant.ACCOUNT_2.available_amount.1(heap: HeapType, current: ref) returns (int) {
  0
}

implementation ACCOUNT_2.available_amount(Current: ref) returns (Result: int)
{
  ...
  entry:
  assume {:captureState "ACCOUNT_2.available_amount"} true;
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\account\account_2.e:38
  // Result := balance - credit_limit
  assert readable[Current, ACCOUNT_2.balance]; // type:access tag:attribute_readable line:38 cid:37 fid:79
  assert readable[Current, ACCOUNT_2.credit_limit]; // type:access tag:attribute_readable line:38 cid:37 fid:80
  Result := (Heap[Current, ACCOUNT_2.balance]) - (Heap[Current, ACCOUNT_2.credit_limit]);
}

procedure ACCOUNT_2.set_credit_limit(Current: ref, limit: int);
  free requires attached_exact(Heap, Current, ACCOUNT_2); // info:type property for argument Current
  ...
  requires (limit) <= (Heap[Current, ACCOUNT_2.balance]); // type:pre tag:limit_valid line:47
  ensures (Heap[Current, ACCOUNT_2.credit_limit]) == (limit); // type:post tag:credit_limit_set line:52
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.ACCOUNT_2.set_credit_limit(Heap, Current, limit), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.ACCOUNT_2.set_credit_limit(old(Heap), Current, limit));
  free ensures HeapSucc(old(Heap), Heap);
...
function { :inline } variant.ACCOUNT_2.set_credit_limit.1(heap: HeapType, current: ref, limit: int) returns (int) {
  limit
}

implementation ACCOUNT_2.set_credit_limit(Current: ref, limit: int)
{
  entry:
  assume {:captureState "ACCOUNT_2.set_credit_limit"} true;
  call unwrap(Current); // default:wrapping cid:4 rid:55 line:43
  assume ACCOUNT_2.user_inv(Heap, Current);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\account\account_2.e:49
  // credit_limit := limit
  call update_heap(Current, ACCOUNT_2.credit_limit, limit); // line:49
  if (*) {
    assert (0) >= (Heap[Current, ACCOUNT_2.credit_limit]); // type:inv tag:credit_limit_not_positive line:79 cid:4 rid:53
    assume false;
  }
...
procedure ACCOUNT_2.deposit(Current: ref, amount: int);
  free requires attached_exact(Heap, Current, ACCOUNT_2); // info:type property for argument Current
  free requires is_integer_32(amount); // info:type property for argument amount
  modifies Heap;
  requires (amount) >= (0); // type:pre tag:amount >= 0 line:58
  ensures (Heap[Current, ACCOUNT_2.balance]) >= (old(Heap)[Current, ACCOUNT_2.balance]); // type:post tag:balance_increased line:64
  ensures (Heap[Current, ACCOUNT_2.balance]) == ((old(Heap)[Current, ACCOUNT_2.balance]) + (amount)); // type:post tag:balance_set line:65
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.ACCOUNT_2.deposit(Heap, Current, amount), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.ACCOUNT_2.deposit(old(Heap), Current, amount));
  free ensures HeapSucc(old(Heap), Heap);
  requires is_wrapped(Heap, Current); // type:pre tag:default_is_wrapped default:contracts
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts
...
function { :inline } variant.ACCOUNT_2.deposit.1(heap: HeapType, current: ref, amount: int) returns (int) {
  amount
}

implementation ACCOUNT_2.deposit(Current: ref, amount: int)
{
  entry:
  assume {:captureState "ACCOUNT_2.deposit"} true;
  call unwrap(Current); // default:wrapping cid:4 rid:55 line:55
  assume ACCOUNT_2.user_inv(Heap, Current);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\account\account_2.e:61
  // balance := balance + amount
  call update_heap(Current, ACCOUNT_2.balance, (Heap[Current, ACCOUNT_2.balance]) + (amount)); // line:61
  if (*) {
    assert (0) >= (Heap[Current, ACCOUNT_2.credit_limit]); // type:inv tag:credit_limit_not_positive line:79 cid:4 rid:53
    assume false;
  }
...
procedure ACCOUNT_2.withdraw(Current: ref, amount: int);
  free requires attached_exact(Heap, Current, ACCOUNT_2); // info:type property for argument Current
  free requires is_integer_32(amount); // info:type property for argument amount
  modifies Heap;
  requires (amount) >= (0); // type:pre tag:amount_not_negative line:71
  ensures (Heap[Current, ACCOUNT_2.balance]) == ((old(Heap)[Current, ACCOUNT_2.balance]) - (amount)); // type:post tag:balance_set line:77
  ensures (Heap[Current, ACCOUNT_2.balance]) <= (old(Heap)[Current, ACCOUNT_2.balance]); // type:post tag:balance_decrease line:78
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.ACCOUNT_2.withdraw(Heap, Current, amount), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.ACCOUNT_2.withdraw(old(Heap), Current, amount));
  free ensures HeapSucc(old(Heap), Heap);
  requires is_wrapped(Heap, Current); // type:pre tag:default_is_wrapped default:contracts
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts
...
function { :inline } variant.ACCOUNT_2.withdraw.1(heap: HeapType, current: ref, amount: int) returns (int) {
  amount
}

implementation ACCOUNT_2.withdraw(Current: ref, amount: int)
{
  entry:
  assume {:captureState "ACCOUNT_2.withdraw"} true;
  call unwrap(Current); // default:wrapping cid:4 rid:55 line:68
  assume ACCOUNT_2.user_inv(Heap, Current);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\account\account_2.e:74
  // balance := balance - amount
  call update_heap(Current, ACCOUNT_2.balance, (Heap[Current, ACCOUNT_2.balance]) - (amount)); // line:74
  if (*) {
    assert (0) >= (Heap[Current, ACCOUNT_2.credit_limit]); // type:inv tag:credit_limit_not_positive line:79 cid:4 rid:53
    assume false;
  }
...
procedure ACCOUNT_2.transfer(Current: ref, amount: int, other: ref);
  free requires attached_exact(Heap, Current, ACCOUNT_2); // info:type property for argument Current
  free requires is_integer_32(amount); // info:type property for argument amount
  free requires attached(Heap, other, ACCOUNT_2); // info:type property for argument other
  modifies Heap;
  requires (amount) >= (0); // type:pre tag:amount_not_negative line:86
  requires (amount) <= (fun.ACCOUNT_2.available_amount(Heap, Current)); // type:pre tag:amount_available line:87
  requires (other) != (Current); // type:pre tag:other /= Current line:88
  ensures (Heap[Current, ACCOUNT_2.balance]) == ((old(Heap)[Current, ACCOUNT_2.balance]) - (amount)); // type:post tag:withdrawal_made line:94
  ensures (other) != (Void); // type:attached tag:despoit_made line:95
  ensures (Heap[other, ACCOUNT_2.balance]) == ((old(Heap)[other, ACCOUNT_2.balance]) + (amount)); // type:post tag:despoit_made line:95
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.ACCOUNT_2.transfer(Heap, Current, amount, other), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.ACCOUNT_2.transfer(old(Heap), Current, amount, other));
  free ensures HeapSucc(old(Heap), Heap);
  requires is_wrapped(Heap, Current); // type:pre tag:default_is_wrapped default:contracts
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts
...
function { :inline } variant.ACCOUNT_2.transfer.1(heap: HeapType, current: ref, amount: int, other: ref) returns (int) {
  amount
}

function { :inline } variant.ACCOUNT_2.transfer.2(heap: HeapType, current: ref, amount: int, other: ref) returns (ref) {
  other
}

implementation ACCOUNT_2.transfer(Current: ref, amount: int, other: ref)
{
  entry:
  assume {:captureState "ACCOUNT_2.transfer"} true;
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\account\account_2.e:90
  // withdraw (amount)
  call ACCOUNT_2.withdraw(Current, amount); // line:90 cid:37 rid:1071
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\account\account_2.e:91
  // other.deposit (amount)
  assert {:subsumption 0} (other) != (Void); // type:attached line:91
  call ACCOUNT_2.deposit(other, amount); // line:91 cid:37 rid:1070
}

const ACCOUNT_2.credit_limit: Field int;

axiom ((FieldId(ACCOUNT_2.credit_limit, ACCOUNT_2)) == (80));

axiom ((forall heap: HeapType, o: ref :: { heap[o, ACCOUNT_2.credit_limit] } ((IsHeap(heap)) && (attached(heap, o, ACCOUNT_2))) ==> (is_integer_32(heap[o, ACCOUNT_2.credit_limit]))));

axiom ((forall heap: HeapType, current: ref, v: int, o: ref :: { guard(heap, current, ACCOUNT_2.credit_limit, v, o) } (attached_exact(heap, current, ACCOUNT_2)) ==> ((guard(heap, current, ACCOUNT_2.credit_limit, v, o)) <==> ((user_inv(heap, o)) ==> (user_inv(heap[current, ACCOUNT_2.credit_limit := v], o))))));

axiom ((forall heap: HeapType, current: ref, v: int, o: ref :: { guard(heap, current, ACCOUNT_2.credit_limit, v, o) } (attached(heap, current, ACCOUNT_2)) ==> ((guard(heap, current, ACCOUNT_2.credit_limit, v, o)) ==> ((user_inv(heap, o)) ==> (user_inv(heap[current, ACCOUNT_2.credit_limit := v], o))))));

const ACCOUNT_2.balance: Field int;

axiom ((FieldId(ACCOUNT_2.balance, ACCOUNT_2)) == (79));

axiom ((forall heap: HeapType, o: ref :: { heap[o, ACCOUNT_2.balance] } ((IsHeap(heap)) && (attached(heap, o, ACCOUNT_2))) ==> (is_integer_32(heap[o, ACCOUNT_2.balance]))));

axiom ((forall heap: HeapType, current: ref, v: int, o: ref :: { guard(heap, current, ACCOUNT_2.balance, v, o) } (attached_exact(heap, current, ACCOUNT_2)) ==> ((guard(heap, current, ACCOUNT_2.balance, v, o)) <==> ((user_inv(heap, o)) ==> (user_inv(heap[current, ACCOUNT_2.balance := v], o))))));

axiom ((forall heap: HeapType, current: ref, v: int, o: ref :: { guard(heap, current, ACCOUNT_2.balance, v, o) } (attached(heap, current, ACCOUNT_2)) ==> ((guard(heap, current, ACCOUNT_2.balance, v, o)) ==> ((user_inv(heap, o)) ==> (user_inv(heap[current, ACCOUNT_2.balance := v], o))))));
...
axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, owns, v, o) } (attached_exact(heap, current, ACCOUNT_2)) ==> ((guard(heap, current, owns, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, subjects, v, o) } (attached_exact(heap, current, ACCOUNT_2)) ==> ((guard(heap, current, subjects, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached_exact(heap, current, ACCOUNT_2)) ==> ((guard(heap, current, observers, v, o)) <==> (fun.ACCOUNT_2.in_observers(heap, current, v, o)))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached(heap, current, ACCOUNT_2)) ==> ((guard(heap, current, observers, v, o)) ==> (fun.ACCOUNT_2.in_observers(heap, current, v, o)))));

function modify.ACCOUNT_2.make(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T4> $o: ref, $f: Field T4 :: { modify.ACCOUNT_2.make(heap, current)[$o, $f] } (modify.ACCOUNT_2.make(heap, current)[$o, $f]) <==> (($o) == (current))))));

function modify.ACCOUNT_2.available_amount(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T5> $o: ref, $f: Field T5 :: { modify.ACCOUNT_2.available_amount(heap, current)[$o, $f] } (modify.ACCOUNT_2.available_amount(heap, current)[$o, $f]) <==> (false)))));

function read.fun.ACCOUNT_2.available_amount(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T6> $o: ref, $f: Field T6 :: { read.fun.ACCOUNT_2.available_amount(heap, current)[$o, $f] } (read.fun.ACCOUNT_2.available_amount(heap, current)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.ACCOUNT_2.available_amount(heap: HeapType, current: ref) returns (bool) {
  true
}

function trigger.fun.ACCOUNT_2.available_amount(heap: HeapType, current: ref) returns (bool);

function modify.ACCOUNT_2.set_credit_limit(heap: HeapType, current: ref, limit: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, limit: int :: (IsHeap(heap)) ==> ((forall <T7> $o: ref, $f: Field T7 :: { modify.ACCOUNT_2.set_credit_limit(heap, current, limit)[$o, $f] } (modify.ACCOUNT_2.set_credit_limit(heap, current, limit)[$o, $f]) <==> ((($o) == (current)) && ((($f) == (ACCOUNT_2.credit_limit)) || (($f) == (closed))))))));

function modify.ACCOUNT_2.deposit(heap: HeapType, current: ref, amount: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, amount: int :: (IsHeap(heap)) ==> ((forall <T8> $o: ref, $f: Field T8 :: { modify.ACCOUNT_2.deposit(heap, current, amount)[$o, $f] } (modify.ACCOUNT_2.deposit(heap, current, amount)[$o, $f]) <==> ((($o) == (current)) && ((($f) == (ACCOUNT_2.balance)) || (($f) == (closed))))))));

function modify.ACCOUNT_2.withdraw(heap: HeapType, current: ref, amount: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, amount: int :: (IsHeap(heap)) ==> ((forall <T9> $o: ref, $f: Field T9 :: { modify.ACCOUNT_2.withdraw(heap, current, amount)[$o, $f] } (modify.ACCOUNT_2.withdraw(heap, current, amount)[$o, $f]) <==> ((($o) == (current)) && ((($f) == (ACCOUNT_2.balance)) || (($f) == (closed))))))));

function modify.ACCOUNT_2.transfer(heap: HeapType, current: ref, amount: int, other: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, amount: int, other: ref :: (IsHeap(heap)) ==> ((forall <T10> $o: ref, $f: Field T10 :: { modify.ACCOUNT_2.transfer(heap, current, amount, other)[$o, $f] } (modify.ACCOUNT_2.transfer(heap, current, amount, other)[$o, $f]) <==> (((($o) == (current)) || (($o) == (other))) && ((($f) == (ACCOUNT_2.balance)) || (($f) == (closed))))))));
...
procedure ACCOUNT_2.in_observers(Current: ref, new_observers: Set (ref), o: ref) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, ACCOUNT_2); // info:type property for argument Current
  free requires Set#ItemsType(Heap, new_observers, ANY); // info:type property for argument new_observers
  free requires ((o) != (Void)) && (Heap[o, allocated]); // info:type property for argument o
  modifies Heap;
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.ACCOUNT_2.in_observers(Heap, Current, new_observers, o), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.ACCOUNT_2.in_observers(old(Heap), Current, new_observers, o));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.ACCOUNT_2.in_observers(Heap, Current, new_observers, o), readable);



function fun.ACCOUNT_2.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

function fun0.ACCOUNT_2.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.ACCOUNT_2.in_observers(heap, current, new_observers, o) } { trigger.fun.ACCOUNT_2.in_observers(heap, current, new_observers, o) } (pre.fun.ACCOUNT_2.in_observers(heap, current, new_observers, o)) ==> ((fun.ACCOUNT_2.in_observers(heap, current, new_observers, o)) == ((attached(heap, o, ANY)) && (new_observers[o])))));

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.ACCOUNT_2.in_observers(heap, current, new_observers, o) } (fun.ACCOUNT_2.in_observers(heap, current, new_observers, o)) == (fun0.ACCOUNT_2.in_observers(heap, current, new_observers, o))));

axiom ((forall h: HeapType, h': HeapType, current: ref, new_observers: Set (ref), o: ref :: { HeapSucc(h, h'), fun0.ACCOUNT_2.in_observers(h, current, new_observers, o), fun0.ACCOUNT_2.in_observers(h', current, new_observers, o) } ((HeapSucc(h, h')) && (pre.fun.ACCOUNT_2.in_observers(h, current, new_observers, o)) && (pre.fun.ACCOUNT_2.in_observers(h', current, new_observers, o)) && (same_inside(h, h', read.fun.ACCOUNT_2.in_observers(h, current, new_observers, o)))) ==> ((fun0.ACCOUNT_2.in_observers(h, current, new_observers, o)) == (fun0.ACCOUNT_2.in_observers(h', current, new_observers, o)))));
...
function modify.ACCOUNT_2.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T13> $o: ref, $f: Field T13 :: { modify.ACCOUNT_2.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.ACCOUNT_2.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.ACCOUNT_2.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T14> $o: ref, $f: Field T14 :: { read.fun.ACCOUNT_2.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.ACCOUNT_2.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.ACCOUNT_2.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool) {
  true
}

function trigger.fun.ACCOUNT_2.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);
