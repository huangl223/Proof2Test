// Automatically generated (04/01/2023 2:52:24.397 PM)
...
const unique ACCOUNT_5: Type;

axiom ((ACCOUNT_5) <: (ANY));

axiom ((forall t: Type :: { (ACCOUNT_5) <: (t) } ((ACCOUNT_5) <: (t)) <==> (((t) == (ACCOUNT_5)) || ((ANY) <: (t)))));

axiom ((FieldId(allocated, ACCOUNT_5)) == (-1));

axiom ((FieldId(closed, ACCOUNT_5)) == (-2));

axiom ((FieldId(owner, ACCOUNT_5)) == (-3));

axiom ((FieldId(owns, ACCOUNT_5)) == (-4));

axiom ((FieldId(observers, ACCOUNT_5)) == (-5));

axiom ((FieldId(subjects, ACCOUNT_5)) == (-6));

axiom ((forall <T0> $f: Field T0 :: { IsModelField($f, ACCOUNT_5) } (IsModelField($f, ACCOUNT_5)) <==> ((($f) == (subjects)) || (($f) == (observers)))));

function { :inline } ACCOUNT_5.user_inv(heap: HeapType, current: ref) returns (bool) {
  ((0) >= (heap[current, ACCOUNT_5.credit_limit])) && ((heap[current, ACCOUNT_5.balance]) >= (heap[current, ACCOUNT_5.credit_limit])) && (Set#IsEmpty(heap[current, observers])) && (Set#IsEmpty(heap[current, subjects])) && (Set#IsEmpty(heap[current, owns])) && (admissibility2(heap, current))
}

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached_exact(heap, current, ACCOUNT_5)) ==> ((user_inv(heap, current)) <==> (ACCOUNT_5.user_inv(heap, current)))));

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached(heap, current, ACCOUNT_5)) ==> ((user_inv(heap, current)) ==> (ACCOUNT_5.user_inv(heap, current)))));

procedure ACCOUNT_5.invariant_admissibility_check(Current: ref);
  requires attached_exact(Heap, Current, ACCOUNT_5);



implementation ACCOUNT_5.invariant_admissibility_check(Current: ref)
{
  entry:
  goto pre, a2, a3;
  pre:
  assert user_inv_readable(Heap, Current)[Current, ACCOUNT_5.credit_limit]; // type:access tag:attribute_readable line:99 cid:40 fid:80
  assume (0) >= (Heap[Current, ACCOUNT_5.credit_limit]);
  assert user_inv_readable(Heap, Current)[Current, ACCOUNT_5.balance]; // type:access tag:attribute_readable line:100 cid:40 fid:79
  assert user_inv_readable(Heap, Current)[Current, ACCOUNT_5.credit_limit]; // type:access tag:attribute_readable line:100 cid:40 fid:80
  assume (Heap[Current, ACCOUNT_5.balance]) >= (Heap[Current, ACCOUNT_5.credit_limit]);
  return;
  a2:
...
procedure create.ACCOUNT_5.make(Current: ref);
  free requires attached_exact(Heap, Current, ACCOUNT_5); // info:type property for argument Current
  modifies Heap;
  ensures (Heap[Current, ACCOUNT_5.balance]) == (0); // type:post tag:balance_set line:23
  ensures (Heap[Current, ACCOUNT_5.credit_limit]) == (0); // type:post tag:credit_limit_set line:24
  ...
  requires Frame#Subset(modify.ACCOUNT_5.make(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.ACCOUNT_5.make(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts



implementation create.ACCOUNT_5.make(Current: ref)
{
  entry:
  assume {:captureState "create.ACCOUNT_5.make"} true;
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\account\account_5.e:20
  // balance := 0
  call update_heap(Current, ACCOUNT_5.balance, 0); // line:20
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\account\account_5.e:21
  // credit_limit := 0
  call update_heap(Current, ACCOUNT_5.credit_limit, 0); // line:21
  if (*) {
    assert (0) >= (Heap[Current, ACCOUNT_5.credit_limit]); // type:inv tag:credit_limit_not_positive line:77 cid:4 rid:53
    assume false;
  }
  if (*) {
    assert (Heap[Current, ACCOUNT_5.balance]) >= (Heap[Current, ACCOUNT_5.credit_limit]); // type:inv tag:balance_non_negative line:77 cid:4 rid:53
    assume false;
  }
  if (*) {
    assert Set#IsEmpty(Heap[Current, observers]); // type:inv tag:default_observers line:77 cid:4 rid:53
    assume false;
  }
  if (*) {
    assert Set#IsEmpty(Heap[Current, subjects]); // type:inv tag:default_subjects line:77 cid:4 rid:53
    assume false;
  }
  if (*) {
    assert Set#IsEmpty(Heap[Current, owns]); // type:inv tag:default_owns line:77 cid:4 rid:53
    assume false;
  }
  if (*) {
    assert admissibility2(Heap, Current); // type:inv tag:A2 line:77 cid:4 rid:53
    assume false;
  }
  call wrap(Current); // default:wrapping cid:4 rid:53 line:25
}

procedure ACCOUNT_5.available_amount(Current: ref) returns (Result: int where is_integer_32(Result));
  free requires attached_exact(Heap, Current, ACCOUNT_5); // info:type property for argument Current
  modifies Heap;
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.ACCOUNT_5.available_amount(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.ACCOUNT_5.available_amount(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.ACCOUNT_5.available_amount(Heap, Current), readable);



function fun.ACCOUNT_5.available_amount(heap: HeapType, current: ref) returns (int);

function fun0.ACCOUNT_5.available_amount(heap: HeapType, current: ref) returns (int);

axiom ((forall heap: HeapType, current: ref :: { fun.ACCOUNT_5.available_amount(heap, current) } (pre.fun.ACCOUNT_5.available_amount(heap, current)) ==> (is_integer_32(fun.ACCOUNT_5.available_amount(heap, current)))));

axiom ((forall heap: HeapType, current: ref :: { fun.ACCOUNT_5.available_amount(heap, current) } { trigger.fun.ACCOUNT_5.available_amount(heap, current) } (pre.fun.ACCOUNT_5.available_amount(heap, current)) ==> ((fun.ACCOUNT_5.available_amount(heap, current)) == ((heap[current, ACCOUNT_5.balance]) - (heap[current, ACCOUNT_5.credit_limit])))));

axiom ((forall heap: HeapType, current: ref :: { fun.ACCOUNT_5.available_amount(heap, current) } (fun.ACCOUNT_5.available_amount(heap, current)) == (fun0.ACCOUNT_5.available_amount(heap, current))));

axiom ((forall h: HeapType, h': HeapType, current: ref :: { HeapSucc(h, h'), fun0.ACCOUNT_5.available_amount(h, current), fun0.ACCOUNT_5.available_amount(h', current) } ((HeapSucc(h, h')) && (pre.fun.ACCOUNT_5.available_amount(h, current)) && (pre.fun.ACCOUNT_5.available_amount(h', current)) && (same_inside(h, h', read.fun.ACCOUNT_5.available_amount(h, current)))) ==> ((fun0.ACCOUNT_5.available_amount(h, current)) == (fun0.ACCOUNT_5.available_amount(h', current)))));

function { :inline } variant.ACCOUNT_5.available_amount.1(heap: HeapType, current: ref) returns (int) {
  0
}

implementation ACCOUNT_5.available_amount(Current: ref) returns (Result: int)
{
  ...
  entry:
  assume {:captureState "ACCOUNT_5.available_amount"} true;
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\account\account_5.e:39
  // Result := balance - credit_limit
  assert readable[Current, ACCOUNT_5.balance]; // type:access tag:attribute_readable line:39 cid:40 fid:79
  assert readable[Current, ACCOUNT_5.credit_limit]; // type:access tag:attribute_readable line:39 cid:40 fid:80
  Result := (Heap[Current, ACCOUNT_5.balance]) - (Heap[Current, ACCOUNT_5.credit_limit]);
}

procedure ACCOUNT_5.set_credit_limit(Current: ref, limit: int);
  free requires attached_exact(Heap, Current, ACCOUNT_5); // info:type property for argument Current
  free requires is_integer_32(limit); // info:type property for argument limit
  modifies Heap;
  requires (limit) <= (0); // type:pre tag:limit_not_positive line:47
  requires (limit) <= (Heap[Current, ACCOUNT_5.balance]); // type:pre tag:limit_valid line:48
  ensures (Heap[Current, ACCOUNT_5.credit_limit]) == (limit); // type:post tag:credit_limit_set line:53
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.ACCOUNT_5.set_credit_limit(Heap, Current, limit), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.ACCOUNT_5.set_credit_limit(old(Heap), Current, limit));
  free ensures HeapSucc(old(Heap), Heap);
...
function { :inline } variant.ACCOUNT_5.set_credit_limit.1(heap: HeapType, current: ref, limit: int) returns (int) {
  limit
}

implementation ACCOUNT_5.set_credit_limit(Current: ref, limit: int)
{
  entry:
  assume {:captureState "ACCOUNT_5.set_credit_limit"} true;
  call unwrap(Current); // default:wrapping cid:4 rid:55 line:44
  assume ACCOUNT_5.user_inv(Heap, Current);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\account\account_5.e:50
  // credit_limit := limit
  call update_heap(Current, ACCOUNT_5.credit_limit, limit); // line:50
  if (*) {
    assert (0) >= (Heap[Current, ACCOUNT_5.credit_limit]); // type:inv tag:credit_limit_not_positive line:77 cid:4 rid:53
    assume false;
  }
  ...
  call wrap(Current); // default:wrapping cid:4 rid:53 line:54
}

procedure ACCOUNT_5.deposit(Current: ref, amount: int);
  free requires attached_exact(Heap, Current, ACCOUNT_5); // info:type property for argument Current
  free requires is_integer_32(amount); // info:type property for argument amount
  modifies Heap;
  requires (amount) >= (0); // type:pre tag:amount_non_negative line:59
  ensures (Heap[Current, ACCOUNT_5.balance]) == ((old(Heap)[Current, ACCOUNT_5.balance]) + (amount)); // type:post tag:balance_set line:64
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.ACCOUNT_5.deposit(Heap, Current, amount), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.ACCOUNT_5.deposit(old(Heap), Current, amount));
  free ensures HeapSucc(old(Heap), Heap);
  requires is_wrapped(Heap, Current); // type:pre tag:default_is_wrapped default:contracts
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts
...
function { :inline } variant.ACCOUNT_5.deposit.1(heap: HeapType, current: ref, amount: int) returns (int) {
  amount
}

implementation ACCOUNT_5.deposit(Current: ref, amount: int)
{
  entry:
  assume {:captureState "ACCOUNT_5.deposit"} true;
  call unwrap(Current); // default:wrapping cid:4 rid:55 line:56
  assume ACCOUNT_5.user_inv(Heap, Current);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\account\account_5.e:61
  // balance := balance + amount
  call update_heap(Current, ACCOUNT_5.balance, (Heap[Current, ACCOUNT_5.balance]) + (amount)); // line:61
  if (*) {
    assert (0) >= (Heap[Current, ACCOUNT_5.credit_limit]); // type:inv tag:credit_limit_not_positive line:77 cid:4 rid:53
    assume false;
  }
  ...
  call wrap(Current); // default:wrapping cid:4 rid:53 line:65
}

procedure ACCOUNT_5.withdraw(Current: ref, amount: int);
  free requires attached_exact(Heap, Current, ACCOUNT_5); // info:type property for argument Current
  free requires is_integer_32(amount); // info:type property for argument amount
  modifies Heap;
  requires (amount) >= (0); // type:pre tag:amount_not_negative line:70
  requires (amount) <= (fun.ACCOUNT_5.available_amount(Heap, Current)); // type:pre tag:amount <= available_amount line:71
  ensures (Heap[Current, ACCOUNT_5.balance]) == ((old(Heap)[Current, ACCOUNT_5.balance]) - (amount)); // type:post tag:balance_set line:76
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.ACCOUNT_5.withdraw(Heap, Current, amount), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.ACCOUNT_5.withdraw(old(Heap), Current, amount));
  free ensures HeapSucc(old(Heap), Heap);
  requires is_wrapped(Heap, Current); // type:pre tag:default_is_wrapped default:contracts
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts
...
function { :inline } variant.ACCOUNT_5.withdraw.1(heap: HeapType, current: ref, amount: int) returns (int) {
  amount
}

implementation ACCOUNT_5.withdraw(Current: ref, amount: int)
{
  entry:
  assume {:captureState "ACCOUNT_5.withdraw"} true;
  call unwrap(Current); // default:wrapping cid:4 rid:55 line:67
  assume ACCOUNT_5.user_inv(Heap, Current);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\account\account_5.e:73
  // balance := balance - amount
  call update_heap(Current, ACCOUNT_5.balance, (Heap[Current, ACCOUNT_5.balance]) - (amount)); // line:73
  if (*) {
    assert (0) >= (Heap[Current, ACCOUNT_5.credit_limit]); // type:inv tag:credit_limit_not_positive line:77 cid:4 rid:53
    assume false;
  }
  ...
  call wrap(Current); // default:wrapping cid:4 rid:53 line:77
}

procedure ACCOUNT_5.transfer(Current: ref, amount: int, other: ref);
  free requires attached_exact(Heap, Current, ACCOUNT_5); // info:type property for argument Current
  free requires is_integer_32(amount); // info:type property for argument amount
  free requires attached(Heap, other, ACCOUNT_5); // info:type property for argument other
  modifies Heap;
  requires (other) != (Void); // type:pre tag:other /= Void line:84
  requires ((amount) >= (0)) && ((0) >= (Heap[Current, ACCOUNT_5.credit_limit])) && ((0) >= (Heap[other, ACCOUNT_5.credit_limit])); // type:pre tag:amount_not_negative line:85
  requires (amount) <= (fun.ACCOUNT_5.available_amount(Heap, Current)); // type:pre tag:amount_available line:86
  requires ((Heap[Current, ACCOUNT_5.balance]) >= (Heap[Current, ACCOUNT_5.credit_limit])) && ((Heap[other, ACCOUNT_5.balance]) >= (Heap[other, ACCOUNT_5.credit_limit])); // type:pre tag:balance_non_negative line:87
  ensures (Heap[Current, ACCOUNT_5.balance]) == ((old(Heap)[Current, ACCOUNT_5.balance]) - (amount)); // type:post tag:withdrawal_made line:94
  ensures (other) != (Void); // type:attached tag:desposit_made line:95
  ensures (Heap[other, ACCOUNT_5.balance]) == ((old(Heap)[other, ACCOUNT_5.balance]) + (amount)); // type:post tag:desposit_made line:95
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.ACCOUNT_5.transfer(Heap, Current, amount, other), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.ACCOUNT_5.transfer(old(Heap), Current, amount, other));
  free ensures HeapSucc(old(Heap), Heap);
  requires is_wrapped(Heap, Current); // type:pre tag:default_is_wrapped default:contracts
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts
...
function { :inline } variant.ACCOUNT_5.transfer.1(heap: HeapType, current: ref, amount: int, other: ref) returns (int) {
  amount
}

function { :inline } variant.ACCOUNT_5.transfer.2(heap: HeapType, current: ref, amount: int, other: ref) returns (ref) {
  other
}

implementation ACCOUNT_5.transfer(Current: ref, amount: int, other: ref)
{
  entry:
  assume {:captureState "ACCOUNT_5.transfer"} true;
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\account\account_5.e:90
  // withdraw (amount)
  call ACCOUNT_5.withdraw(Current, amount); // line:90 cid:40 rid:1047
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\account\account_5.e:91
  // other.deposit (amount)
  assert {:subsumption 0} (other) != (Void); // type:attached line:91
  call ACCOUNT_5.deposit(other, amount); // line:91 cid:40 rid:1046
}

const ACCOUNT_5.credit_limit: Field int;

axiom ((FieldId(ACCOUNT_5.credit_limit, ACCOUNT_5)) == (80));

axiom ((forall heap: HeapType, o: ref :: { heap[o, ACCOUNT_5.credit_limit] } ((IsHeap(heap)) && (attached(heap, o, ACCOUNT_5))) ==> (is_integer_32(heap[o, ACCOUNT_5.credit_limit]))));

axiom ((forall heap: HeapType, current: ref, v: int, o: ref :: { guard(heap, current, ACCOUNT_5.credit_limit, v, o) } (attached_exact(heap, current, ACCOUNT_5)) ==> ((guard(heap, current, ACCOUNT_5.credit_limit, v, o)) <==> ((user_inv(heap, o)) ==> (user_inv(heap[current, ACCOUNT_5.credit_limit := v], o))))));

axiom ((forall heap: HeapType, current: ref, v: int, o: ref :: { guard(heap, current, ACCOUNT_5.credit_limit, v, o) } (attached(heap, current, ACCOUNT_5)) ==> ((guard(heap, current, ACCOUNT_5.credit_limit, v, o)) ==> ((user_inv(heap, o)) ==> (user_inv(heap[current, ACCOUNT_5.credit_limit := v], o))))));

const ACCOUNT_5.balance: Field int;

axiom ((FieldId(ACCOUNT_5.balance, ACCOUNT_5)) == (79));

axiom ((forall heap: HeapType, o: ref :: { heap[o, ACCOUNT_5.balance] } ((IsHeap(heap)) && (attached(heap, o, ACCOUNT_5))) ==> (is_integer_32(heap[o, ACCOUNT_5.balance]))));

axiom ((forall heap: HeapType, current: ref, v: int, o: ref :: { guard(heap, current, ACCOUNT_5.balance, v, o) } (attached_exact(heap, current, ACCOUNT_5)) ==> ((guard(heap, current, ACCOUNT_5.balance, v, o)) <==> ((user_inv(heap, o)) ==> (user_inv(heap[current, ACCOUNT_5.balance := v], o))))));

axiom ((forall heap: HeapType, current: ref, v: int, o: ref :: { guard(heap, current, ACCOUNT_5.balance, v, o) } (attached(heap, current, ACCOUNT_5)) ==> ((guard(heap, current, ACCOUNT_5.balance, v, o)) ==> ((user_inv(heap, o)) ==> (user_inv(heap[current, ACCOUNT_5.balance := v], o))))));
...
axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, owns, v, o) } (attached_exact(heap, current, ACCOUNT_5)) ==> ((guard(heap, current, owns, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, subjects, v, o) } (attached_exact(heap, current, ACCOUNT_5)) ==> ((guard(heap, current, subjects, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached_exact(heap, current, ACCOUNT_5)) ==> ((guard(heap, current, observers, v, o)) <==> (fun.ACCOUNT_5.in_observers(heap, current, v, o)))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached(heap, current, ACCOUNT_5)) ==> ((guard(heap, current, observers, v, o)) ==> (fun.ACCOUNT_5.in_observers(heap, current, v, o)))));

function modify.ACCOUNT_5.make(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T2> $o: ref, $f: Field T2 :: { modify.ACCOUNT_5.make(heap, current)[$o, $f] } (modify.ACCOUNT_5.make(heap, current)[$o, $f]) <==> (($o) == (current))))));

function modify.ACCOUNT_5.available_amount(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T3> $o: ref, $f: Field T3 :: { modify.ACCOUNT_5.available_amount(heap, current)[$o, $f] } (modify.ACCOUNT_5.available_amount(heap, current)[$o, $f]) <==> (false)))));

function read.fun.ACCOUNT_5.available_amount(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T4> $o: ref, $f: Field T4 :: { read.fun.ACCOUNT_5.available_amount(heap, current)[$o, $f] } (read.fun.ACCOUNT_5.available_amount(heap, current)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.ACCOUNT_5.available_amount(heap: HeapType, current: ref) returns (bool) {
  true
}

function trigger.fun.ACCOUNT_5.available_amount(heap: HeapType, current: ref) returns (bool);

function modify.ACCOUNT_5.set_credit_limit(heap: HeapType, current: ref, limit: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, limit: int :: (IsHeap(heap)) ==> ((forall <T5> $o: ref, $f: Field T5 :: { modify.ACCOUNT_5.set_credit_limit(heap, current, limit)[$o, $f] } (modify.ACCOUNT_5.set_credit_limit(heap, current, limit)[$o, $f]) <==> ((($o) == (current)) && ((($f) == (ACCOUNT_5.credit_limit)) || (($f) == (closed))))))));

function modify.ACCOUNT_5.deposit(heap: HeapType, current: ref, amount: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, amount: int :: (IsHeap(heap)) ==> ((forall <T6> $o: ref, $f: Field T6 :: { modify.ACCOUNT_5.deposit(heap, current, amount)[$o, $f] } (modify.ACCOUNT_5.deposit(heap, current, amount)[$o, $f]) <==> ((($o) == (current)) && ((($f) == (ACCOUNT_5.balance)) || (($f) == (closed))))))));

function modify.ACCOUNT_5.withdraw(heap: HeapType, current: ref, amount: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, amount: int :: (IsHeap(heap)) ==> ((forall <T7> $o: ref, $f: Field T7 :: { modify.ACCOUNT_5.withdraw(heap, current, amount)[$o, $f] } (modify.ACCOUNT_5.withdraw(heap, current, amount)[$o, $f]) <==> ((($o) == (current)) && ((($f) == (ACCOUNT_5.balance)) || (($f) == (closed))))))));

function modify.ACCOUNT_5.transfer(heap: HeapType, current: ref, amount: int, other: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, amount: int, other: ref :: (IsHeap(heap)) ==> ((forall <T8> $o: ref, $f: Field T8 :: { modify.ACCOUNT_5.transfer(heap, current, amount, other)[$o, $f] } (modify.ACCOUNT_5.transfer(heap, current, amount, other)[$o, $f]) <==> (((($o) == (current)) || (($o) == (other))) && ((($f) == (ACCOUNT_5.balance)) || (($f) == (closed))))))));
...
procedure ACCOUNT_5.in_observers(Current: ref, new_observers: Set (ref), o: ref) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, ACCOUNT_5); // info:type property for argument Current
  free requires Set#ItemsType(Heap, new_observers, ANY); // info:type property for argument new_observers
  free requires ((o) != (Void)) && (Heap[o, allocated]); // info:type property for argument o
  modifies Heap;
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.ACCOUNT_5.in_observers(Heap, Current, new_observers, o), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.ACCOUNT_5.in_observers(old(Heap), Current, new_observers, o));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.ACCOUNT_5.in_observers(Heap, Current, new_observers, o), readable);



function fun.ACCOUNT_5.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

function fun0.ACCOUNT_5.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.ACCOUNT_5.in_observers(heap, current, new_observers, o) } { trigger.fun.ACCOUNT_5.in_observers(heap, current, new_observers, o) } (pre.fun.ACCOUNT_5.in_observers(heap, current, new_observers, o)) ==> ((fun.ACCOUNT_5.in_observers(heap, current, new_observers, o)) == ((attached(heap, o, ANY)) && (new_observers[o])))));

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.ACCOUNT_5.in_observers(heap, current, new_observers, o) } (fun.ACCOUNT_5.in_observers(heap, current, new_observers, o)) == (fun0.ACCOUNT_5.in_observers(heap, current, new_observers, o))));

axiom ((forall h: HeapType, h': HeapType, current: ref, new_observers: Set (ref), o: ref :: { HeapSucc(h, h'), fun0.ACCOUNT_5.in_observers(h, current, new_observers, o), fun0.ACCOUNT_5.in_observers(h', current, new_observers, o) } ((HeapSucc(h, h')) && (pre.fun.ACCOUNT_5.in_observers(h, current, new_observers, o)) && (pre.fun.ACCOUNT_5.in_observers(h', current, new_observers, o)) && (same_inside(h, h', read.fun.ACCOUNT_5.in_observers(h, current, new_observers, o)))) ==> ((fun0.ACCOUNT_5.in_observers(h, current, new_observers, o)) == (fun0.ACCOUNT_5.in_observers(h', current, new_observers, o)))));
...
function modify.ACCOUNT_5.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T11> $o: ref, $f: Field T11 :: { modify.ACCOUNT_5.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.ACCOUNT_5.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.ACCOUNT_5.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T12> $o: ref, $f: Field T12 :: { read.fun.ACCOUNT_5.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.ACCOUNT_5.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.ACCOUNT_5.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool) {
  true
}

function trigger.fun.ACCOUNT_5.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);
