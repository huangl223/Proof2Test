// Automatically generated (04/02/2023 8:42:20.346 PM)
...
const unique BINARY_SEARCH_1: Type;

axiom ((BINARY_SEARCH_1) <: (ANY));

axiom ((forall t: Type :: { (BINARY_SEARCH_1) <: (t) } ((BINARY_SEARCH_1) <: (t)) <==> (((t) == (BINARY_SEARCH_1)) || ((ANY) <: (t)))));

axiom ((FieldId(allocated, BINARY_SEARCH_1)) == (-1));

axiom ((FieldId(closed, BINARY_SEARCH_1)) == (-2));

axiom ((FieldId(owner, BINARY_SEARCH_1)) == (-3));

axiom ((FieldId(owns, BINARY_SEARCH_1)) == (-4));

axiom ((FieldId(observers, BINARY_SEARCH_1)) == (-5));

axiom ((FieldId(subjects, BINARY_SEARCH_1)) == (-6));

axiom ((forall <T0> $f: Field T0 :: { IsModelField($f, BINARY_SEARCH_1) } (IsModelField($f, BINARY_SEARCH_1)) <==> ((($f) == (subjects)) || (($f) == (observers)))));

function { :inline } BINARY_SEARCH_1.user_inv(heap: HeapType, current: ref) returns (bool) {
...
axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached_exact(heap, current, BINARY_SEARCH_1)) ==> ((user_inv(heap, current)) <==> (BINARY_SEARCH_1.user_inv(heap, current)))));

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached(heap, current, BINARY_SEARCH_1)) ==> ((user_inv(heap, current)) ==> (BINARY_SEARCH_1.user_inv(heap, current)))));

procedure BINARY_SEARCH_1.invariant_admissibility_check(Current: ref);
  requires attached_exact(Heap, Current, BINARY_SEARCH_1);



implementation BINARY_SEARCH_1.invariant_admissibility_check(Current: ref)
{
  entry:
  goto pre, a2, a3;
  pre:
...
procedure create.BINARY_SEARCH_1.default_create(Current: ref);
  free requires attached_exact(Heap, Current, BINARY_SEARCH_1); // info:type property for argument Current
  modifies Heap;
  ...
  requires Frame#Subset(modify.BINARY_SEARCH_1.default_create(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.BINARY_SEARCH_1.default_create(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts



implementation create.BINARY_SEARCH_1.default_create(Current: ref)
{
  entry:
  assume {:captureState "create.BINARY_SEARCH_1.default_create"} true;
  if (*) {
...
procedure BINARY_SEARCH_1.binary_search(Current: ref, a: ref, value: int) returns (Result: int where is_integer_32(Result));
  free requires attached_exact(Heap, Current, BINARY_SEARCH_1); // info:type property for argument Current
  ...
  ensures (a) != (Void); // type:attached tag:present line:52
  ensures (Seq#Has(Heap[a, V_ARRAY^INTEGER_32^.sequence], value)) == (((Result) >= (Heap[a, V_ARRAY^INTEGER_32^.lower])) && ((Result) <= (Heap[a, V_ARRAY^INTEGER_32^.upper]))); // type:post tag:present line:52
  ensures (!(Seq#Has(Heap[a, V_ARRAY^INTEGER_32^.sequence], value))) == ((Result) == ((Heap[a, V_ARRAY^INTEGER_32^.lower]) - (1))); // type:post tag:not_present line:53
  ensures (((Result) >= (Heap[a, V_ARRAY^INTEGER_32^.lower])) && ((Result) <= (Heap[a, V_ARRAY^INTEGER_32^.upper]))) ==> ((a) != (Void)); // type:attached tag:found_if_present line:54
  ensures (((Result) >= (Heap[a, V_ARRAY^INTEGER_32^.lower])) && ((Result) <= (Heap[a, V_ARRAY^INTEGER_32^.upper]))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, V_ARRAY^INTEGER_32^.sequence], ((Result) - (Heap[a, V_ARRAY^INTEGER_32^.lower])) + (1))); // type:check tag:function_precondition line:54 cid:81 rid:3811
  ensures (((Result) >= (Heap[a, V_ARRAY^INTEGER_32^.lower])) && ((Result) <= (Heap[a, V_ARRAY^INTEGER_32^.upper]))) ==> ((Seq#Item(Heap[a, V_ARRAY^INTEGER_32^.sequence], ((Result) - (Heap[a, V_ARRAY^INTEGER_32^.lower])) + (1))) == (value)); // type:post tag:found_if_present line:54
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.BINARY_SEARCH_1.binary_search(Heap, Current, a, value), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.BINARY_SEARCH_1.binary_search(old(Heap), Current, a, value));
  free ensures HeapSucc(old(Heap), Heap);
...
function { :inline } variant.BINARY_SEARCH_1.binary_search.1(heap: HeapType, current: ref, a: ref, value: int) returns (ref) {
  a
}

function { :inline } variant.BINARY_SEARCH_1.binary_search.2(heap: HeapType, current: ref, a: ref, value: int) returns (int) {
  value
}

implementation BINARY_SEARCH_1.binary_search(Current: ref, a: ref, value: int) returns (Result: int)
{
  ...
  entry:
  assume {:captureState "BINARY_SEARCH_1.binary_search"} true;
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_1.e:27
  // low := a.lower
  assert {:subsumption 0} (a) != (Void); // type:attached line:27
  local1 := Heap[a, V_ARRAY^INTEGER_32^.lower];
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_1.e:28
  // up := a.upper + 1
  assert {:subsumption 0} (a) != (Void); // type:attached line:28
  local2 := (Heap[a, V_ARRAY^INTEGER_32^.upper]) + (1);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_1.e:29
  // Result := a.lower - 1
  ...
  goto loop_head_3;
  loop_head_3:
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_1.e:31
  // low_and_up_range: a.lower <= low and low <= up and up <= a.upper + 1
  assert {:subsumption 0} (a) != (Void); // type:attached line:31
  assert {:subsumption 0} (a) != (Void); // type:attached line:31
  assert ((Heap[a, V_ARRAY^INTEGER_32^.lower]) <= (local1)) && ((local1) <= (local2)) && ((local2) <= ((Heap[a, V_ARRAY^INTEGER_32^.upper]) + (1))); // type:loop_inv tag:low_and_up_range line:31
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_1.e:32
  // valid_bound: a.lower < a.upper
  assert {:subsumption 0} (a) != (Void); // type:attached line:32
  assert {:subsumption 0} (a) != (Void); // type:attached line:32
  assert (Heap[a, V_ARRAY^INTEGER_32^.lower]) < (Heap[a, V_ARRAY^INTEGER_32^.upper]); // type:loop_inv tag:valid_bound line:32
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_1.e:33
  // result_range: Result = a.lower - 1 or a.lower <= Result and Result <= a.upper
  assert {:subsumption 0} (a) != (Void); // type:attached line:33
  assert {:subsumption 0} (a) != (Void); // type:attached line:33
  assert {:subsumption 0} (a) != (Void); // type:attached line:33
  assert ((Result) == ((Heap[a, V_ARRAY^INTEGER_32^.lower]) - (1))) || (((Heap[a, V_ARRAY^INTEGER_32^.lower]) <= (Result)) && ((Result) <= (Heap[a, V_ARRAY^INTEGER_32^.upper]))); // type:loop_inv tag:result_range line:33
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_1.e:34
  // not_in_lower_part: across 1 |..| (low - a.lower) as i all a.sequence [i] < value end
  assert {:subsumption 0} (a) != (Void); // type:attached line:34
  assert {:subsumption 0} (a) != (Void); // type:attached line:34
  assert (forall i_7: int :: (((1) <= (i_7)) && ((i_7) <= ((local1) - (Heap[a, V_ARRAY^INTEGER_32^.lower])))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, V_ARRAY^INTEGER_32^.sequence], i_7))); // type:check tag:function_precondition line:34 cid:81 rid:3811
  assert (forall i_7: int :: (((1) <= (i_7)) && ((i_7) <= ((local1) - (Heap[a, V_ARRAY^INTEGER_32^.lower])))) ==> ((Seq#Item(Heap[a, V_ARRAY^INTEGER_32^.sequence], i_7)) < (value))); // type:loop_inv tag:not_in_lower_part line:34
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_1.e:35
  ...
  assert {:subsumption 0} (a) != (Void); // type:attached line:35
  assert {:subsumption 0} (a) != (Void); // type:attached line:35
  assert (forall i_8: int :: (((((local2) - (Heap[a, V_ARRAY^INTEGER_32^.lower])) + (1)) <= (i_8)) && ((i_8) <= (Seq#Length(Heap[a, V_ARRAY^INTEGER_32^.sequence])))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, V_ARRAY^INTEGER_32^.sequence], i_8))); // type:check tag:function_precondition line:35 cid:81 rid:3811
  assert (forall i_8: int :: (((((local2) - (Heap[a, V_ARRAY^INTEGER_32^.lower])) + (1)) <= (i_8)) && ((i_8) <= (Seq#Length(Heap[a, V_ARRAY^INTEGER_32^.sequence])))) ==> ((value) < (Seq#Item(Heap[a, V_ARRAY^INTEGER_32^.sequence], i_8)))); // type:loop_inv tag:not_in_upper_part line:35
  assume HeapSucc(PreLoopHeap_6, Heap);
  assume same_outside(old(Heap), Heap, modify.BINARY_SEARCH_1.binary_search(old(Heap), Current, a, value));
  assume global(Heap);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_1.e:-1
  ...
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_1.e:49
  // (a.upper - Result) + (up - low)
  variant_9 := ((Heap[a, V_ARRAY^INTEGER_32^.upper]) - (Result)) + ((local2) - (local1));
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_1.e:40
  // middle := low + ((up - low) // 2)
  local3 := (local1) + (((local2) - (local1)) div (2));
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_1.e:41
  // if a [middle] < value then
  assert {:subsumption 0} (a) != (Void); // type:attached line:41
  call temp_10 := V_ARRAY^INTEGER_32^.item(a, local3); // line:41 cid:146 rid:4018
  if ((temp_10) < (value)) {
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_1.e:42
    // low := middle + 1
    local1 := (local3) + (1);
  } else {
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_1.e:43
    // elseif a [middle] > value then
    assert {:subsumption 0} (a) != (Void); // type:attached line:43
    call temp_11 := V_ARRAY^INTEGER_32^.item(a, local3); // line:43 cid:146 rid:4018
    if ((temp_11) > (value)) {
      // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_1.e:44
      // up := middle
      local2 := local3;
    } else {
      // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_1.e:46
      // Result := middle
      Result := local3;
    }
  }
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_1.e:49
  // (a.upper - Result) + (up - low)
  assert {:subsumption 0} (((((Heap[a, V_ARRAY^INTEGER_32^.upper]) - (Result)) + ((local2) - (local1))) <= (variant_9)) && ((variant_9) <= (((Heap[a, V_ARRAY^INTEGER_32^.upper]) - (Result)) + ((local2) - (local1))))) || ((0) <= (variant_9)); // type:termination tag:bounded line:49 varid:1
  assert {:subsumption 0} ((((Heap[a, V_ARRAY^INTEGER_32^.upper]) - (Result)) + ((local2) - (local1))) <= (variant_9)) && (!((variant_9) <= (((Heap[a, V_ARRAY^INTEGER_32^.upper]) - (Result)) + ((local2) - (local1))))); // type:termination tag:variant_decreases line:49
  goto loop_head_3;
  loop_end_5:
  assume ((local1) >= (local2)) || ((Result) >= (Heap[a, V_ARRAY^INTEGER_32^.lower]));
}
...
axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, owns, v, o) } (attached_exact(heap, current, BINARY_SEARCH_1)) ==> ((guard(heap, current, owns, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, subjects, v, o) } (attached_exact(heap, current, BINARY_SEARCH_1)) ==> ((guard(heap, current, subjects, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached_exact(heap, current, BINARY_SEARCH_1)) ==> ((guard(heap, current, observers, v, o)) <==> (fun.BINARY_SEARCH_1.in_observers(heap, current, v, o)))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached(heap, current, BINARY_SEARCH_1)) ==> ((guard(heap, current, observers, v, o)) ==> (fun.BINARY_SEARCH_1.in_observers(heap, current, v, o)))));

function modify.BINARY_SEARCH_1.default_create(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T3> $o: ref, $f: Field T3 :: { modify.BINARY_SEARCH_1.default_create(heap, current)[$o, $f] } (modify.BINARY_SEARCH_1.default_create(heap, current)[$o, $f]) <==> (($o) == (current))))));
...
function modify.BINARY_SEARCH_1.binary_search(heap: HeapType, current: ref, a: ref, value: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: ref, value: int :: (IsHeap(heap)) ==> ((forall <T5> $o: ref, $f: Field T5 :: { modify.BINARY_SEARCH_1.binary_search(heap, current, a, value)[$o, $f] } (modify.BINARY_SEARCH_1.binary_search(heap, current, a, value)[$o, $f]) <==> (false)))));
...
procedure BINARY_SEARCH_1.in_observers(Current: ref, new_observers: Set (ref), o: ref) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, BINARY_SEARCH_1); // info:type property for argument Current
  free requires Set#ItemsType(Heap, new_observers, ANY); // info:type property for argument new_observers
  free requires ((o) != (Void)) && (Heap[o, allocated]); // info:type property for argument o
  modifies Heap;
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.BINARY_SEARCH_1.in_observers(Heap, Current, new_observers, o), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.BINARY_SEARCH_1.in_observers(old(Heap), Current, new_observers, o));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.BINARY_SEARCH_1.in_observers(Heap, Current, new_observers, o), readable);



function fun.BINARY_SEARCH_1.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

function fun0.BINARY_SEARCH_1.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.BINARY_SEARCH_1.in_observers(heap, current, new_observers, o) } { trigger.fun.BINARY_SEARCH_1.in_observers(heap, current, new_observers, o) } (pre.fun.BINARY_SEARCH_1.in_observers(heap, current, new_observers, o)) ==> ((fun.BINARY_SEARCH_1.in_observers(heap, current, new_observers, o)) == ((attached(heap, o, ANY)) && (new_observers[o])))));

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.BINARY_SEARCH_1.in_observers(heap, current, new_observers, o) } (fun.BINARY_SEARCH_1.in_observers(heap, current, new_observers, o)) == (fun0.BINARY_SEARCH_1.in_observers(heap, current, new_observers, o))));

axiom ((forall h: HeapType, h': HeapType, current: ref, new_observers: Set (ref), o: ref :: { HeapSucc(h, h'), fun0.BINARY_SEARCH_1.in_observers(h, current, new_observers, o), fun0.BINARY_SEARCH_1.in_observers(h', current, new_observers, o) } ((HeapSucc(h, h')) && (pre.fun.BINARY_SEARCH_1.in_observers(h, current, new_observers, o)) && (pre.fun.BINARY_SEARCH_1.in_observers(h', current, new_observers, o)) && (same_inside(h, h', read.fun.BINARY_SEARCH_1.in_observers(h, current, new_observers, o)))) ==> ((fun0.BINARY_SEARCH_1.in_observers(h, current, new_observers, o)) == (fun0.BINARY_SEARCH_1.in_observers(h', current, new_observers, o)))));
...
function modify.BINARY_SEARCH_1.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T12> $o: ref, $f: Field T12 :: { modify.BINARY_SEARCH_1.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.BINARY_SEARCH_1.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.BINARY_SEARCH_1.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T13> $o: ref, $f: Field T13 :: { read.fun.BINARY_SEARCH_1.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.BINARY_SEARCH_1.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.BINARY_SEARCH_1.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool) {
  true
}

function trigger.fun.BINARY_SEARCH_1.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);
