// Automatically generated (04/02/2023 9:16:53.028 PM)
...
const unique BINARY_SEARCH_3: Type;

axiom ((BINARY_SEARCH_3) <: (ANY));

axiom ((forall t: Type :: { (BINARY_SEARCH_3) <: (t) } ((BINARY_SEARCH_3) <: (t)) <==> (((t) == (BINARY_SEARCH_3)) || ((ANY) <: (t)))));

axiom ((FieldId(allocated, BINARY_SEARCH_3)) == (-1));

axiom ((FieldId(closed, BINARY_SEARCH_3)) == (-2));

axiom ((FieldId(owner, BINARY_SEARCH_3)) == (-3));

axiom ((FieldId(owns, BINARY_SEARCH_3)) == (-4));

axiom ((FieldId(observers, BINARY_SEARCH_3)) == (-5));

axiom ((FieldId(subjects, BINARY_SEARCH_3)) == (-6));

axiom ((forall <T0> $f: Field T0 :: { IsModelField($f, BINARY_SEARCH_3) } (IsModelField($f, BINARY_SEARCH_3)) <==> ((($f) == (subjects)) || (($f) == (observers)))));

function { :inline } BINARY_SEARCH_3.user_inv(heap: HeapType, current: ref) returns (bool) {
...
axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached_exact(heap, current, BINARY_SEARCH_3)) ==> ((user_inv(heap, current)) <==> (BINARY_SEARCH_3.user_inv(heap, current)))));

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached(heap, current, BINARY_SEARCH_3)) ==> ((user_inv(heap, current)) ==> (BINARY_SEARCH_3.user_inv(heap, current)))));

procedure BINARY_SEARCH_3.invariant_admissibility_check(Current: ref);
  requires attached_exact(Heap, Current, BINARY_SEARCH_3);



implementation BINARY_SEARCH_3.invariant_admissibility_check(Current: ref)
{
  entry:
  goto pre, a2, a3;
  pre:
...
procedure create.BINARY_SEARCH_3.default_create(Current: ref);
  free requires attached_exact(Heap, Current, BINARY_SEARCH_3); // info:type property for argument Current
  modifies Heap;
  ...
  requires Frame#Subset(modify.BINARY_SEARCH_3.default_create(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.BINARY_SEARCH_3.default_create(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts



implementation create.BINARY_SEARCH_3.default_create(Current: ref)
{
  entry:
  assume {:captureState "create.BINARY_SEARCH_3.default_create"} true;
  if (*) {
...
procedure BINARY_SEARCH_3.binary_search(Current: ref, a: ref, value: int) returns (Result: int where is_integer_32(Result));
  free requires attached_exact(Heap, Current, BINARY_SEARCH_3); // info:type property for argument Current
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.BINARY_SEARCH_3.binary_search(Heap, Current, a, value), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.BINARY_SEARCH_3.binary_search(old(Heap), Current, a, value));
  free ensures HeapSucc(old(Heap), Heap);
...
function { :inline } variant.BINARY_SEARCH_3.binary_search.1(heap: HeapType, current: ref, a: ref, value: int) returns (ref) {
  a
}

function { :inline } variant.BINARY_SEARCH_3.binary_search.2(heap: HeapType, current: ref, a: ref, value: int) returns (int) {
  value
}

implementation BINARY_SEARCH_3.binary_search(Current: ref, a: ref, value: int) returns (Result: int)
{
  ...
  entry:
  assume {:captureState "BINARY_SEARCH_3.binary_search"} true;
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_3.e:28
  // low := a.lower
  assert {:subsumption 0} (a) != (Void); // type:attached line:28
  local1 := Heap[a, V_ARRAY^INTEGER_32^.lower];
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_3.e:29
  // up := a.upper + 1
  assert {:subsumption 0} (a) != (Void); // type:attached line:29
  local2 := (Heap[a, V_ARRAY^INTEGER_32^.upper]) + (1);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_3.e:30
  // Result := a.lower - 1
  ...
  goto loop_head_3;
  loop_head_3:
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_3.e:32
  ...
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_3.e:33
  ...
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_3.e:34
  ...
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_3.e:35
  ...
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_3.e:36
  ...
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_3.e:37
  ...
  assume same_outside(old(Heap), Heap, modify.BINARY_SEARCH_3.binary_search(old(Heap), Current, a, value));
  assume global(Heap);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_3.e:-1
  ...
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_3.e:50
  // (a.upper - Result) + (up - low)
  variant_9 := ((Heap[a, V_ARRAY^INTEGER_32^.upper]) - (Result)) + ((local2) - (local1));
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_3.e:41
  // middle := low + ((up - low) // 2)
  local3 := (local1) + (((local2) - (local1)) div (2));
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_3.e:42
  ...
  if ((temp_10) < (value)) {
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_3.e:43
    // low := middle
    local1 := local3;
  } else {
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_3.e:44
    ...
    if ((temp_11) > (value)) {
      // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_3.e:45
      // up := middle
      local2 := local3;
    } else {
      // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_3.e:47
      // Result := middle
      Result := local3;
    }
  }
...
axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, owns, v, o) } (attached_exact(heap, current, BINARY_SEARCH_3)) ==> ((guard(heap, current, owns, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, subjects, v, o) } (attached_exact(heap, current, BINARY_SEARCH_3)) ==> ((guard(heap, current, subjects, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached_exact(heap, current, BINARY_SEARCH_3)) ==> ((guard(heap, current, observers, v, o)) <==> (fun.BINARY_SEARCH_3.in_observers(heap, current, v, o)))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached(heap, current, BINARY_SEARCH_3)) ==> ((guard(heap, current, observers, v, o)) ==> (fun.BINARY_SEARCH_3.in_observers(heap, current, v, o)))));

function modify.BINARY_SEARCH_3.default_create(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T3> $o: ref, $f: Field T3 :: { modify.BINARY_SEARCH_3.default_create(heap, current)[$o, $f] } (modify.BINARY_SEARCH_3.default_create(heap, current)[$o, $f]) <==> (($o) == (current))))));
...
function modify.BINARY_SEARCH_3.binary_search(heap: HeapType, current: ref, a: ref, value: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: ref, value: int :: (IsHeap(heap)) ==> ((forall <T5> $o: ref, $f: Field T5 :: { modify.BINARY_SEARCH_3.binary_search(heap, current, a, value)[$o, $f] } (modify.BINARY_SEARCH_3.binary_search(heap, current, a, value)[$o, $f]) <==> (false)))));
...
procedure BINARY_SEARCH_3.in_observers(Current: ref, new_observers: Set (ref), o: ref) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, BINARY_SEARCH_3); // info:type property for argument Current
  free requires Set#ItemsType(Heap, new_observers, ANY); // info:type property for argument new_observers
  free requires ((o) != (Void)) && (Heap[o, allocated]); // info:type property for argument o
  modifies Heap;
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.BINARY_SEARCH_3.in_observers(Heap, Current, new_observers, o), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.BINARY_SEARCH_3.in_observers(old(Heap), Current, new_observers, o));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.BINARY_SEARCH_3.in_observers(Heap, Current, new_observers, o), readable);



function fun.BINARY_SEARCH_3.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

function fun0.BINARY_SEARCH_3.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.BINARY_SEARCH_3.in_observers(heap, current, new_observers, o) } { trigger.fun.BINARY_SEARCH_3.in_observers(heap, current, new_observers, o) } (pre.fun.BINARY_SEARCH_3.in_observers(heap, current, new_observers, o)) ==> ((fun.BINARY_SEARCH_3.in_observers(heap, current, new_observers, o)) == ((attached(heap, o, ANY)) && (new_observers[o])))));

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.BINARY_SEARCH_3.in_observers(heap, current, new_observers, o) } (fun.BINARY_SEARCH_3.in_observers(heap, current, new_observers, o)) == (fun0.BINARY_SEARCH_3.in_observers(heap, current, new_observers, o))));

axiom ((forall h: HeapType, h': HeapType, current: ref, new_observers: Set (ref), o: ref :: { HeapSucc(h, h'), fun0.BINARY_SEARCH_3.in_observers(h, current, new_observers, o), fun0.BINARY_SEARCH_3.in_observers(h', current, new_observers, o) } ((HeapSucc(h, h')) && (pre.fun.BINARY_SEARCH_3.in_observers(h, current, new_observers, o)) && (pre.fun.BINARY_SEARCH_3.in_observers(h', current, new_observers, o)) && (same_inside(h, h', read.fun.BINARY_SEARCH_3.in_observers(h, current, new_observers, o)))) ==> ((fun0.BINARY_SEARCH_3.in_observers(h, current, new_observers, o)) == (fun0.BINARY_SEARCH_3.in_observers(h', current, new_observers, o)))));
...
function modify.BINARY_SEARCH_3.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T12> $o: ref, $f: Field T12 :: { modify.BINARY_SEARCH_3.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.BINARY_SEARCH_3.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.BINARY_SEARCH_3.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T13> $o: ref, $f: Field T13 :: { read.fun.BINARY_SEARCH_3.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.BINARY_SEARCH_3.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.BINARY_SEARCH_3.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool) {
  true
}

function trigger.fun.BINARY_SEARCH_3.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);
