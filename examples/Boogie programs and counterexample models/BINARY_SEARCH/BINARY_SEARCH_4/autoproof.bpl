// Automatically generated (04/02/2023 9:27:55.423 PM)
...
const unique BINARY_SEARCH_4: Type;

axiom ((BINARY_SEARCH_4) <: (ANY));

axiom ((forall t: Type :: { (BINARY_SEARCH_4) <: (t) } ((BINARY_SEARCH_4) <: (t)) <==> (((t) == (BINARY_SEARCH_4)) || ((ANY) <: (t)))));

axiom ((FieldId(allocated, BINARY_SEARCH_4)) == (-1));

axiom ((FieldId(closed, BINARY_SEARCH_4)) == (-2));

axiom ((FieldId(owner, BINARY_SEARCH_4)) == (-3));

axiom ((FieldId(owns, BINARY_SEARCH_4)) == (-4));

axiom ((FieldId(observers, BINARY_SEARCH_4)) == (-5));

axiom ((FieldId(subjects, BINARY_SEARCH_4)) == (-6));

axiom ((forall <T0> $f: Field T0 :: { IsModelField($f, BINARY_SEARCH_4) } (IsModelField($f, BINARY_SEARCH_4)) <==> ((($f) == (subjects)) || (($f) == (observers)))));

function { :inline } BINARY_SEARCH_4.user_inv(heap: HeapType, current: ref) returns (bool) {
...
axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached_exact(heap, current, BINARY_SEARCH_4)) ==> ((user_inv(heap, current)) <==> (BINARY_SEARCH_4.user_inv(heap, current)))));

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached(heap, current, BINARY_SEARCH_4)) ==> ((user_inv(heap, current)) ==> (BINARY_SEARCH_4.user_inv(heap, current)))));

procedure BINARY_SEARCH_4.invariant_admissibility_check(Current: ref);
  requires attached_exact(Heap, Current, BINARY_SEARCH_4);



implementation BINARY_SEARCH_4.invariant_admissibility_check(Current: ref)
{
  entry:
  goto pre, a2, a3;
  pre:
...
procedure create.BINARY_SEARCH_4.default_create(Current: ref);
  free requires attached_exact(Heap, Current, BINARY_SEARCH_4); // info:type property for argument Current
  modifies Heap;
  ...
  requires Frame#Subset(modify.BINARY_SEARCH_4.default_create(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.BINARY_SEARCH_4.default_create(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts



implementation create.BINARY_SEARCH_4.default_create(Current: ref)
{
  entry:
  assume {:captureState "create.BINARY_SEARCH_4.default_create"} true;
  if (*) {
...
procedure BINARY_SEARCH_4.binary_search(Current: ref, a: ref, value: int) returns (Result: int where is_integer_32(Result));
  free requires attached_exact(Heap, Current, BINARY_SEARCH_4); // info:type property for argument Current
  free requires attached_exact(Heap, a, SIMPLE_ARRAY^INTEGER_32^); // info:type property for argument a
  free requires is_integer_32(value); // info:type property for argument value
  modifies Heap;
  requires (a) != (Void); // type:attached tag:a_sorted line:15
  requires (true) ==> ((a) != (Void)); // type:attached tag:a_sorted line:15
  requires (forall i_1: int :: (((1) <= (i_1)) && ((i_1) <= (Seq#Length(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence])))) ==> ((true) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_1)))); // type:check tag:function_precondition line:15 cid:81 rid:3811
  requires (forall i_1: int :: (((1) <= (i_1)) && ((i_1) <= (Seq#Length(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence])))) ==> ((forall i_2: int :: (((1) <= (i_2)) && ((i_2) <= (Seq#Length(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence])))) ==> (((i_1) <= (i_2)) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_2)))))); // type:check tag:function_precondition line:15 cid:81 rid:3811
  requires (forall i_1: int :: (((1) <= (i_1)) && ((i_1) <= (Seq#Length(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence])))) ==> ((forall i_2: int :: (((1) <= (i_2)) && ((i_2) <= (Seq#Length(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence])))) ==> (((i_1) <= (i_2)) ==> ((Seq#Item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_1)) <= (Seq#Item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_2))))))); // type:pre tag:a_sorted line:15
  requires pre.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a); // type:check tag:function_precondition line:18 cid:82 rid:3798
  requires ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) > (0)) && ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) <= (10)); // type:pre tag:a_size_limit line:18
  requires (forall i_3: int :: (((1) <= (i_3)) && ((i_3) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_3))); // type:check tag:function_precondition line:19 cid:81 rid:3811
  requires (forall i_3: int :: (((1) <= (i_3)) && ((i_3) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)))) ==> (((0) < (Seq#Item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_3))) && ((Seq#Item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_3)) <= (10)))); // type:pre tag:a_element_value line:19
  ensures (a) != (Void); // type:attached tag:result_range line:47
  ensures pre.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a); // type:check tag:function_precondition line:47 cid:82 rid:3798
  ensures ((0) <= (Result)) && ((Result) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a))); // type:post tag:result_range line:47
  ensures (Seq#Has(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], value)) == ((Result) > (0)); // type:post tag:present line:48
  ensures (!(Seq#Has(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], value))) == ((Result) == (0)); // type:post tag:not_present line:49
  ensures ((Result) > (0)) ==> ((a) != (Void)); // type:attached tag:found_if_present line:50
  ensures ((Result) > (0)) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], Result)); // type:check tag:function_precondition line:50 cid:81 rid:3811
  ensures ((Result) > (0)) ==> ((Seq#Item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], Result)) == (value)); // type:post tag:found_if_present line:50
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.BINARY_SEARCH_4.binary_search(Heap, Current, a, value), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.BINARY_SEARCH_4.binary_search(old(Heap), Current, a, value));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.BINARY_SEARCH_4.binary_search(Heap, Current, a, value), readable);
  ...
  free ensures (Result) == (fun.BINARY_SEARCH_4.binary_search(old(Heap), Current, a, value));



function fun.BINARY_SEARCH_4.binary_search(heap: HeapType, current: ref, a: ref, value: int) returns (int);

axiom ((forall heap: HeapType, current: ref, a: ref, value: int :: { fun.BINARY_SEARCH_4.binary_search(heap, current, a, value) } (pre.fun.BINARY_SEARCH_4.binary_search(heap, current, a, value)) ==> (((0) <= (fun.BINARY_SEARCH_4.binary_search(heap, current, a, value))) && ((fun.BINARY_SEARCH_4.binary_search(heap, current, a, value)) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a))) && ((Seq#Has(heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], value)) == ((fun.BINARY_SEARCH_4.binary_search(heap, current, a, value)) > (0))) && ((!(Seq#Has(heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], value))) == ((fun.BINARY_SEARCH_4.binary_search(heap, current, a, value)) == (0))) && (((fun.BINARY_SEARCH_4.binary_search(heap, current, a, value)) > (0)) ==> ((Seq#Item(heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], fun.BINARY_SEARCH_4.binary_search(heap, current, a, value))) == (value))) && (is_integer_32(fun.BINARY_SEARCH_4.binary_search(heap, current, a, value))))));

axiom ((forall h: HeapType, h': HeapType, current: ref, a: ref, value: int :: { HeapSucc(h, h'), fun.BINARY_SEARCH_4.binary_search(h, current, a, value), fun.BINARY_SEARCH_4.binary_search(h', current, a, value) } ((HeapSucc(h, h')) && (pre.fun.BINARY_SEARCH_4.binary_search(h, current, a, value)) && (pre.fun.BINARY_SEARCH_4.binary_search(h', current, a, value)) && (same_inside(h, h', read.fun.BINARY_SEARCH_4.binary_search(h, current, a, value)))) ==> ((fun.BINARY_SEARCH_4.binary_search(h, current, a, value)) == (fun.BINARY_SEARCH_4.binary_search(h', current, a, value)))));

function { :inline } variant.BINARY_SEARCH_4.binary_search.1(heap: HeapType, current: ref, a: ref, value: int) returns (ref) {
  a
}

function { :inline } variant.BINARY_SEARCH_4.binary_search.2(heap: HeapType, current: ref, a: ref, value: int) returns (int) {
  value
}

implementation BINARY_SEARCH_4.binary_search(Current: ref, a: ref, value: int) returns (Result: int)
{
  ...
  entry:
  assume {:captureState "BINARY_SEARCH_4.binary_search"} true;
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_4.e:24
  // low := 1
  local1 := 1;
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_4.e:25
  // up := a.count + 1
  assert {:subsumption 0} (a) != (Void); // type:attached line:25
  assert pre.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a); // type:check tag:function_precondition line:25 cid:82 rid:3798
  assert Frame#Subset(read.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a), readable); // type:access tag:frame_readable line:25 cid:82 rid:3798
  local2 := (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1);
  PreLoopHeap_10 := Heap;
  goto loop_head_7;
  loop_head_7:
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_4.e:27
  // low_and_up_range: 1 <= low and low <= up and up <= a.sequence.count + 1
  assert {:subsumption 0} (a) != (Void); // type:attached line:27
  assert readable[a, SIMPLE_ARRAY^INTEGER_32^.sequence]; // type:access tag:attribute_readable line:27 cid:82 fid:82
  assert ((1) <= (local1)) && ((local1) <= (local2)) && ((local2) <= ((Seq#Length(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence])) + (1))); // type:loop_inv tag:low_and_up_range line:27
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_4.e:28
  // result_range: Result = 0 or 1 <= Result and Result <= a.sequence.count
  assert {:subsumption 0} (a) != (Void); // type:attached line:28
  assert readable[a, SIMPLE_ARRAY^INTEGER_32^.sequence]; // type:access tag:attribute_readable line:28 cid:82 fid:82
  assert ((Result) == (0)) || (((1) <= (Result)) && ((Result) <= (Seq#Length(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence])))); // type:loop_inv tag:result_range line:28
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_4.e:29
  // not_in_lower_part: across 1 |..| (low-1) as i all a.sequence[i] < value end
  assert {:subsumption 0} (a) != (Void); // type:attached line:29
  assert readable[a, SIMPLE_ARRAY^INTEGER_32^.sequence]; // type:access tag:attribute_readable line:29 cid:82 fid:82
  assert (forall i_11: int :: (((1) <= (i_11)) && ((i_11) <= ((local1) - (1)))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_11))); // type:check tag:function_precondition line:29 cid:81 rid:3811
  assert (forall i_11: int :: (((1) <= (i_11)) && ((i_11) <= ((local1) - (1)))) ==> ((Seq#Item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_11)) < (value))); // type:loop_inv tag:not_in_lower_part line:29
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_4.e:30
  ...
  assert readable[a, SIMPLE_ARRAY^INTEGER_32^.sequence]; // type:access tag:attribute_readable line:30 cid:82 fid:82
  assert {:subsumption 0} (a) != (Void); // type:attached line:30
  assert readable[a, SIMPLE_ARRAY^INTEGER_32^.sequence]; // type:access tag:attribute_readable line:30 cid:82 fid:82
  assert (forall i_12: int :: (((local2) <= (i_12)) && ((i_12) <= (Seq#Length(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence])))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_12))); // type:check tag:function_precondition line:30 cid:81 rid:3811
  assert (forall i_12: int :: (((local2) <= (i_12)) && ((i_12) <= (Seq#Length(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence])))) ==> ((value) < (Seq#Item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_12)))); // type:loop_inv tag:not_in_upper_part line:30
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_4.e:31
  // found: Result > 0 implies a.sequence[Result] = value
  assert {:subsumption 0} ((Result) > (0)) ==> ((a) != (Void)); // type:attached line:31
  assert ((Result) > (0)) ==> (readable[a, SIMPLE_ARRAY^INTEGER_32^.sequence]); // type:access tag:attribute_readable line:31 cid:82 fid:82
  assert ((Result) > (0)) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], Result)); // type:check tag:function_precondition line:31 cid:81 rid:3811
  assert ((Result) > (0)) ==> ((Seq#Item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], Result)) == (value)); // type:loop_inv tag:found line:31
  assume HeapSucc(PreLoopHeap_10, Heap);
  assume same_outside(old(Heap), Heap, modify.BINARY_SEARCH_4.binary_search(old(Heap), Current, a, value));
  assume global(Heap);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_4.e:-1
  goto loop_body_8, loop_end_9;
  loop_body_8:
  assume !(((local1) >= (local2)) || ((Result) > (0)));
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_4.e:44
  // (a.count - Result) + (up - low)
  variant_13 := ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (Result)) + ((local2) - (local1));
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_4.e:35
  // middle := low + ((up - low) // 2)
  local3 := (local1) + (((local2) - (local1)) div (2));
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_4.e:36
  // if a[middle] < value then
  assert {:subsumption 0} (a) != (Void); // type:attached line:36
  assert Frame#Subset(read.fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, local3), readable); // type:access tag:frame_readable line:36 cid:82 rid:3799
  call temp_14 := SIMPLE_ARRAY^INTEGER_32^.item(a, local3); // line:36 cid:82 rid:3799
  if ((temp_14) < (value)) {
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_4.e:37
    // low := middle + 1
    local1 := (local3) + (1);
  } else {
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_4.e:38
    // elseif a[middle] >= value then
    assert {:subsumption 0} (a) != (Void); // type:attached line:38
    assert Frame#Subset(read.fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, local3), readable); // type:access tag:frame_readable line:38 cid:82 rid:3799
    call temp_15 := SIMPLE_ARRAY^INTEGER_32^.item(a, local3); // line:38 cid:82 rid:3799
    if ((temp_15) >= (value)) {
      // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_4.e:39
      // up := middle
      local2 := local3;
    } else {
      // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_4.e:41
      // Result := middle
      Result := local3;
    }
  }
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_4.e:44
  // (a.count - Result) + (up - low)
  assert {:subsumption 0} (((((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (Result)) + ((local2) - (local1))) <= (variant_13)) && ((variant_13) <= (((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (Result)) + ((local2) - (local1))))) || ((0) <= (variant_13)); // type:termination tag:bounded line:44 varid:1
  assert {:subsumption 0} ((((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (Result)) + ((local2) - (local1))) <= (variant_13)) && (!((variant_13) <= (((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (Result)) + ((local2) - (local1))))); // type:termination tag:variant_decreases line:44
  goto loop_head_7;
  loop_end_9:
  assume ((local1) >= (local2)) || ((Result) > (0));
}
...
axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, owns, v, o) } (attached_exact(heap, current, BINARY_SEARCH_4)) ==> ((guard(heap, current, owns, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, subjects, v, o) } (attached_exact(heap, current, BINARY_SEARCH_4)) ==> ((guard(heap, current, subjects, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached_exact(heap, current, BINARY_SEARCH_4)) ==> ((guard(heap, current, observers, v, o)) <==> (fun.BINARY_SEARCH_4.in_observers(heap, current, v, o)))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached(heap, current, BINARY_SEARCH_4)) ==> ((guard(heap, current, observers, v, o)) ==> (fun.BINARY_SEARCH_4.in_observers(heap, current, v, o)))));

function modify.BINARY_SEARCH_4.default_create(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T3> $o: ref, $f: Field T3 :: { modify.BINARY_SEARCH_4.default_create(heap, current)[$o, $f] } (modify.BINARY_SEARCH_4.default_create(heap, current)[$o, $f]) <==> (($o) == (current))))));
...
axiom ((forall <T4> $f: Field T4 :: { IsModelField($f, SIMPLE_ARRAY^INTEGER_32^) } (IsModelField($f, SIMPLE_ARRAY^INTEGER_32^)) <==> ((($f) == (subjects)) || (($f) == (observers)))));
...
axiom ((FieldId(SIMPLE_ARRAY^INTEGER_32^.sequence, SIMPLE_ARRAY^INTEGER_32^)) == (82));
...
function modify.BINARY_SEARCH_4.binary_search(heap: HeapType, current: ref, a: ref, value: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: ref, value: int :: (IsHeap(heap)) ==> ((forall <T5> $o: ref, $f: Field T5 :: { modify.BINARY_SEARCH_4.binary_search(heap, current, a, value)[$o, $f] } (modify.BINARY_SEARCH_4.binary_search(heap, current, a, value)[$o, $f]) <==> (false)))));

function read.fun.BINARY_SEARCH_4.binary_search(heap: HeapType, current: ref, a: ref, value: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: ref, value: int :: (IsHeap(heap)) ==> ((forall <T6> $o: ref, $f: Field T6 :: { read.fun.BINARY_SEARCH_4.binary_search(heap, current, a, value)[$o, $f] } (read.fun.BINARY_SEARCH_4.binary_search(heap, current, a, value)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.BINARY_SEARCH_4.binary_search(heap: HeapType, current: ref, a: ref, value: int) returns (bool) {
  ((forall i_16: int :: (((1) <= (i_16)) && ((i_16) <= (Seq#Length(heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence])))) ==> ((forall i_17: int :: (((1) <= (i_17)) && ((i_17) <= (Seq#Length(heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence])))) ==> (((i_16) <= (i_17)) ==> ((Seq#Item(heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_16)) <= (Seq#Item(heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_17)))))))) && ((fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a)) > (0)) && ((fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a)) <= (10)) && ((forall i_18: int :: (((1) <= (i_18)) && ((i_18) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a)))) ==> (((0) < (Seq#Item(heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_18))) && ((Seq#Item(heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_18)) <= (10))))) && (is_closed(heap, current)) && (is_closed(heap, a))
}

function trigger.fun.BINARY_SEARCH_4.binary_search(heap: HeapType, current: ref, a: ref, value: int) returns (bool);
...
procedure SIMPLE_ARRAY^INTEGER_32^.item(Current: ref, i: int) returns (Result: int where is_integer_32(Result));
  ...
  modifies Heap;
  ensures pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[Current, SIMPLE_ARRAY^INTEGER_32^.sequence], i); // type:check tag:function_precondition line:89 cid:81 rid:3811
...
procedure BINARY_SEARCH_4.in_observers(Current: ref, new_observers: Set (ref), o: ref) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, BINARY_SEARCH_4); // info:type property for argument Current
  free requires Set#ItemsType(Heap, new_observers, ANY); // info:type property for argument new_observers
  free requires ((o) != (Void)) && (Heap[o, allocated]); // info:type property for argument o
  modifies Heap;
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.BINARY_SEARCH_4.in_observers(Heap, Current, new_observers, o), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.BINARY_SEARCH_4.in_observers(old(Heap), Current, new_observers, o));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.BINARY_SEARCH_4.in_observers(Heap, Current, new_observers, o), readable);



function fun.BINARY_SEARCH_4.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

function fun0.BINARY_SEARCH_4.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.BINARY_SEARCH_4.in_observers(heap, current, new_observers, o) } { trigger.fun.BINARY_SEARCH_4.in_observers(heap, current, new_observers, o) } (pre.fun.BINARY_SEARCH_4.in_observers(heap, current, new_observers, o)) ==> ((fun.BINARY_SEARCH_4.in_observers(heap, current, new_observers, o)) == ((attached(heap, o, ANY)) && (new_observers[o])))));

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.BINARY_SEARCH_4.in_observers(heap, current, new_observers, o) } (fun.BINARY_SEARCH_4.in_observers(heap, current, new_observers, o)) == (fun0.BINARY_SEARCH_4.in_observers(heap, current, new_observers, o))));

axiom ((forall h: HeapType, h': HeapType, current: ref, new_observers: Set (ref), o: ref :: { HeapSucc(h, h'), fun0.BINARY_SEARCH_4.in_observers(h, current, new_observers, o), fun0.BINARY_SEARCH_4.in_observers(h', current, new_observers, o) } ((HeapSucc(h, h')) && (pre.fun.BINARY_SEARCH_4.in_observers(h, current, new_observers, o)) && (pre.fun.BINARY_SEARCH_4.in_observers(h', current, new_observers, o)) && (same_inside(h, h', read.fun.BINARY_SEARCH_4.in_observers(h, current, new_observers, o)))) ==> ((fun0.BINARY_SEARCH_4.in_observers(h, current, new_observers, o)) == (fun0.BINARY_SEARCH_4.in_observers(h', current, new_observers, o)))));
...
axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T7> $o: ref, $f: Field T7 :: { modify.SIMPLE_ARRAY^INTEGER_32^.count(heap, current)[$o, $f] } (modify.SIMPLE_ARRAY^INTEGER_32^.count(heap, current)[$o, $f]) <==> (false)))));

function read.fun.SIMPLE_ARRAY^INTEGER_32^.count(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T8> $o: ref, $f: Field T8 :: { read.fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, current)[$o, $f] } (read.fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, current)[$o, $f]) <==> ((($o) == (current)) && (($f) != (closed)) && (($f) != (owner)))))));
...
axiom ((forall heap: HeapType, current: ref, i: int :: (IsHeap(heap)) ==> ((forall <T9> $o: ref, $f: Field T9 :: { modify.SIMPLE_ARRAY^INTEGER_32^.item(heap, current, i)[$o, $f] } (modify.SIMPLE_ARRAY^INTEGER_32^.item(heap, current, i)[$o, $f]) <==> (false)))));

function read.fun.SIMPLE_ARRAY^INTEGER_32^.item(heap: HeapType, current: ref, i: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, i: int :: (IsHeap(heap)) ==> ((forall <T10> $o: ref, $f: Field T10 :: { read.fun.SIMPLE_ARRAY^INTEGER_32^.item(heap, current, i)[$o, $f] } (read.fun.SIMPLE_ARRAY^INTEGER_32^.item(heap, current, i)[$o, $f]) <==> ((($o) == (current)) && (($f) != (closed)) && (($f) != (owner)))))));
...
function modify.BINARY_SEARCH_4.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T13> $o: ref, $f: Field T13 :: { modify.BINARY_SEARCH_4.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.BINARY_SEARCH_4.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.BINARY_SEARCH_4.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T14> $o: ref, $f: Field T14 :: { read.fun.BINARY_SEARCH_4.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.BINARY_SEARCH_4.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.BINARY_SEARCH_4.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool) {
  true
}

function trigger.fun.BINARY_SEARCH_4.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);
...
axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T15> $o: ref, $f: Field T15 :: { modify.SIMPLE_ARRAY^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.SIMPLE_ARRAY^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));
...
axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T16> $o: ref, $f: Field T16 :: { read.fun.SIMPLE_ARRAY^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.SIMPLE_ARRAY^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));
