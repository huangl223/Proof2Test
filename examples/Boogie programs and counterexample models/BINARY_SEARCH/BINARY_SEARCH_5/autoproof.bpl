// Automatically generated (04/02/2023 9:35:19.564 PM)
...
const unique BINARY_SEARCH_5: Type;

axiom ((BINARY_SEARCH_5) <: (ANY));

axiom ((forall t: Type :: { (BINARY_SEARCH_5) <: (t) } ((BINARY_SEARCH_5) <: (t)) <==> (((t) == (BINARY_SEARCH_5)) || ((ANY) <: (t)))));

axiom ((FieldId(allocated, BINARY_SEARCH_5)) == (-1));

axiom ((FieldId(closed, BINARY_SEARCH_5)) == (-2));

axiom ((FieldId(owner, BINARY_SEARCH_5)) == (-3));

axiom ((FieldId(owns, BINARY_SEARCH_5)) == (-4));

axiom ((FieldId(observers, BINARY_SEARCH_5)) == (-5));

axiom ((FieldId(subjects, BINARY_SEARCH_5)) == (-6));

axiom ((forall <T0> $f: Field T0 :: { IsModelField($f, BINARY_SEARCH_5) } (IsModelField($f, BINARY_SEARCH_5)) <==> ((($f) == (subjects)) || (($f) == (observers)))));

function { :inline } BINARY_SEARCH_5.user_inv(heap: HeapType, current: ref) returns (bool) {
...
axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached_exact(heap, current, BINARY_SEARCH_5)) ==> ((user_inv(heap, current)) <==> (BINARY_SEARCH_5.user_inv(heap, current)))));

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached(heap, current, BINARY_SEARCH_5)) ==> ((user_inv(heap, current)) ==> (BINARY_SEARCH_5.user_inv(heap, current)))));

procedure BINARY_SEARCH_5.binary_search(Current: ref, a: ref, value: int) returns (Result: int where is_integer_32(Result));
  free requires attached_exact(Heap, Current, BINARY_SEARCH_5); // info:type property for argument Current
  ...
  requires Frame#Subset(modify.BINARY_SEARCH_5.binary_search(Heap, Current, a, value), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.BINARY_SEARCH_5.binary_search(old(Heap), Current, a, value));
  free ensures HeapSucc(old(Heap), Heap);
...
function { :inline } variant.BINARY_SEARCH_5.binary_search.1(heap: HeapType, current: ref, a: ref, value: int) returns (ref) {
  a
}

function { :inline } variant.BINARY_SEARCH_5.binary_search.2(heap: HeapType, current: ref, a: ref, value: int) returns (int) {
  value
}

implementation BINARY_SEARCH_5.binary_search(Current: ref, a: ref, value: int) returns (Result: int)
{
  ...
  entry:
  assume {:captureState "BINARY_SEARCH_5.binary_search"} true;
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_5.e:28
  // low := a.lower
  assert {:subsumption 0} (a) != (Void); // type:attached line:28
  local1 := Heap[a, V_ARRAY^INTEGER_32^.lower];
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_5.e:29
  // up := a.upper + 1
  assert {:subsumption 0} (a) != (Void); // type:attached line:29
  local2 := (Heap[a, V_ARRAY^INTEGER_32^.upper]) + (1);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_5.e:30
  // Result := a.lower - 1
  ...
  goto loop_head_3;
  loop_head_3:
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_5.e:32
  ...
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_5.e:33
  ...
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_5.e:34
  ...
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_5.e:36
  ...
  assert {:subsumption 0} (a) != (Void); // type:attached line:36
  assert {:subsumption 0} (a) != (Void); // type:attached line:36
  assert (forall i_7: int :: (((((local2) - (Heap[a, V_ARRAY^INTEGER_32^.lower])) + (1)) <= (i_7)) && ((i_7) <= (Seq#Length(Heap[a, V_ARRAY^INTEGER_32^.sequence])))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, V_ARRAY^INTEGER_32^.sequence], i_7))); // type:check tag:function_precondition line:36 cid:81 rid:3811
  assert (forall i_7: int :: (((((local2) - (Heap[a, V_ARRAY^INTEGER_32^.lower])) + (1)) <= (i_7)) && ((i_7) <= (Seq#Length(Heap[a, V_ARRAY^INTEGER_32^.sequence])))) ==> ((value) < (Seq#Item(Heap[a, V_ARRAY^INTEGER_32^.sequence], i_7)))); // type:loop_inv tag:not_in_upper_part line:36
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_5.e:37
  ...
  assume same_outside(old(Heap), Heap, modify.BINARY_SEARCH_5.binary_search(old(Heap), Current, a, value));
  assume global(Heap);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_5.e:-1
  ...
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_5.e:50
  // (a.upper - Result) + (up - low)
  variant_8 := ((Heap[a, V_ARRAY^INTEGER_32^.upper]) - (Result)) + ((local2) - (local1));
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_5.e:41
  // middle := low + ((up - low) // 2)
  local3 := (local1) + (((local2) - (local1)) div (2));
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_5.e:42
  // if a[middle] < value then
  assert {:subsumption 0} (a) != (Void); // type:attached line:42
  call temp_9 := V_ARRAY^INTEGER_32^.item(a, local3); // line:42 cid:146 rid:4018
  if ((temp_9) < (value)) {
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_5.e:43
    // low := middle + 1
    local1 := (local3) + (1);
  } else {
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_5.e:44
    // elseif a[middle] > value then
    assert {:subsumption 0} (a) != (Void); // type:attached line:44
    call temp_10 := V_ARRAY^INTEGER_32^.item(a, local3); // line:44 cid:146 rid:4018
    if ((temp_10) > (value)) {
      // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_5.e:45
      // up := middle
      local2 := local3;
    } else {
      // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_5.e:47
      // Result := middle
      Result := local3;
    }
  }
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\binary_search\binary_search_5.e:50
  // (a.upper - Result) + (up - low)
  assert {:subsumption 0} (((((Heap[a, V_ARRAY^INTEGER_32^.upper]) - (Result)) + ((local2) - (local1))) <= (variant_8)) && ((variant_8) <= (((Heap[a, V_ARRAY^INTEGER_32^.upper]) - (Result)) + ((local2) - (local1))))) || ((0) <= (variant_8)); // type:termination tag:bounded line:50 varid:1
  assert {:subsumption 0} ((((Heap[a, V_ARRAY^INTEGER_32^.upper]) - (Result)) + ((local2) - (local1))) <= (variant_8)) && (!((variant_8) <= (((Heap[a, V_ARRAY^INTEGER_32^.upper]) - (Result)) + ((local2) - (local1))))); // type:termination tag:variant_decreases line:50
  goto loop_head_3;
  loop_end_5:
  assume ((local1) >= (local2)) || ((Result) >= (Heap[a, V_ARRAY^INTEGER_32^.lower]));
}
...
axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, owns, v, o) } (attached_exact(heap, current, BINARY_SEARCH_5)) ==> ((guard(heap, current, owns, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, subjects, v, o) } (attached_exact(heap, current, BINARY_SEARCH_5)) ==> ((guard(heap, current, subjects, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached_exact(heap, current, BINARY_SEARCH_5)) ==> ((guard(heap, current, observers, v, o)) <==> (fun.BINARY_SEARCH_5.in_observers(heap, current, v, o)))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached(heap, current, BINARY_SEARCH_5)) ==> ((guard(heap, current, observers, v, o)) ==> (fun.BINARY_SEARCH_5.in_observers(heap, current, v, o)))));
...
axiom ((forall <T1> $f: Field T1 :: { IsModelField($f, V_ARRAY^INTEGER_32^) } (IsModelField($f, V_ARRAY^INTEGER_32^)) <==> ((($f) == (V_ARRAY^INTEGER_32^.sequence)) || (($f) == (V_ARRAY^INTEGER_32^.lower_)) || (($f) == (closed)) || (($f) == (V_ARRAY^INTEGER_32^.bag)) || (($f) == (subjects)) || (($f) == (observers)))));
...
function modify.BINARY_SEARCH_5.binary_search(heap: HeapType, current: ref, a: ref, value: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: ref, value: int :: (IsHeap(heap)) ==> ((forall <T2> $o: ref, $f: Field T2 :: { modify.BINARY_SEARCH_5.binary_search(heap, current, a, value)[$o, $f] } (modify.BINARY_SEARCH_5.binary_search(heap, current, a, value)[$o, $f]) <==> (false)))));
...
procedure BINARY_SEARCH_5.in_observers(Current: ref, new_observers: Set (ref), o: ref) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, BINARY_SEARCH_5); // info:type property for argument Current
  free requires Set#ItemsType(Heap, new_observers, ANY); // info:type property for argument new_observers
  free requires ((o) != (Void)) && (Heap[o, allocated]); // info:type property for argument o
  modifies Heap;
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.BINARY_SEARCH_5.in_observers(Heap, Current, new_observers, o), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.BINARY_SEARCH_5.in_observers(old(Heap), Current, new_observers, o));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.BINARY_SEARCH_5.in_observers(Heap, Current, new_observers, o), readable);



function fun.BINARY_SEARCH_5.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

function fun0.BINARY_SEARCH_5.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.BINARY_SEARCH_5.in_observers(heap, current, new_observers, o) } { trigger.fun.BINARY_SEARCH_5.in_observers(heap, current, new_observers, o) } (pre.fun.BINARY_SEARCH_5.in_observers(heap, current, new_observers, o)) ==> ((fun.BINARY_SEARCH_5.in_observers(heap, current, new_observers, o)) == ((attached(heap, o, ANY)) && (new_observers[o])))));

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.BINARY_SEARCH_5.in_observers(heap, current, new_observers, o) } (fun.BINARY_SEARCH_5.in_observers(heap, current, new_observers, o)) == (fun0.BINARY_SEARCH_5.in_observers(heap, current, new_observers, o))));

axiom ((forall h: HeapType, h': HeapType, current: ref, new_observers: Set (ref), o: ref :: { HeapSucc(h, h'), fun0.BINARY_SEARCH_5.in_observers(h, current, new_observers, o), fun0.BINARY_SEARCH_5.in_observers(h', current, new_observers, o) } ((HeapSucc(h, h')) && (pre.fun.BINARY_SEARCH_5.in_observers(h, current, new_observers, o)) && (pre.fun.BINARY_SEARCH_5.in_observers(h', current, new_observers, o)) && (same_inside(h, h', read.fun.BINARY_SEARCH_5.in_observers(h, current, new_observers, o)))) ==> ((fun0.BINARY_SEARCH_5.in_observers(h, current, new_observers, o)) == (fun0.BINARY_SEARCH_5.in_observers(h', current, new_observers, o)))));
...
axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T3> $o: ref, $f: Field T3 :: { modify.V_ARRAY^INTEGER_32^.count(heap, current)[$o, $f] } (modify.V_ARRAY^INTEGER_32^.count(heap, current)[$o, $f]) <==> (false)))));

function read.fun.V_ARRAY^INTEGER_32^.count(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T4> $o: ref, $f: Field T4 :: { read.fun.V_ARRAY^INTEGER_32^.count(heap, current)[$o, $f] } (read.fun.V_ARRAY^INTEGER_32^.count(heap, current)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));
...
axiom ((forall heap: HeapType, current: ref, i: int :: (IsHeap(heap)) ==> ((forall <T5> $o: ref, $f: Field T5 :: { modify.V_ARRAY^INTEGER_32^.item(heap, current, i)[$o, $f] } (modify.V_ARRAY^INTEGER_32^.item(heap, current, i)[$o, $f]) <==> (false)))));

function read.fun.V_ARRAY^INTEGER_32^.item(heap: HeapType, current: ref, i: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, i: int :: (IsHeap(heap)) ==> ((forall <T6> $o: ref, $f: Field T6 :: { read.fun.V_ARRAY^INTEGER_32^.item(heap, current, i)[$o, $f] } (read.fun.V_ARRAY^INTEGER_32^.item(heap, current, i)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));
...
function modify.BINARY_SEARCH_5.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T9> $o: ref, $f: Field T9 :: { modify.BINARY_SEARCH_5.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.BINARY_SEARCH_5.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.BINARY_SEARCH_5.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T10> $o: ref, $f: Field T10 :: { read.fun.BINARY_SEARCH_5.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.BINARY_SEARCH_5.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.BINARY_SEARCH_5.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool) {
  true
}

function trigger.fun.BINARY_SEARCH_5.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);
...
axiom ((forall <T11> $f: Field T11 :: { IsModelField($f, V_SPECIAL^INTEGER_32^) } (IsModelField($f, V_SPECIAL^INTEGER_32^)) <==> ((($f) == (V_SPECIAL^INTEGER_32^.sequence)) || (($f) == (V_SPECIAL^INTEGER_32^.capacity)) || (($f) == (subjects)) || (($f) == (observers)))));
...
axiom ((forall heap: HeapType, current: ref, i: int :: (IsHeap(heap)) ==> ((forall <T12> $o: ref, $f: Field T12 :: { modify.V_ARRAY^INTEGER_32^.has_index(heap, current, i)[$o, $f] } (modify.V_ARRAY^INTEGER_32^.has_index(heap, current, i)[$o, $f]) <==> (false)))));

function read.fun.V_ARRAY^INTEGER_32^.has_index(heap: HeapType, current: ref, i: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, i: int :: (IsHeap(heap)) ==> ((forall <T13> $o: ref, $f: Field T13 :: { read.fun.V_ARRAY^INTEGER_32^.has_index(heap, current, i)[$o, $f] } (read.fun.V_ARRAY^INTEGER_32^.has_index(heap, current, i)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));
...
axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T14> $o: ref, $f: Field T14 :: { modify.V_ARRAY^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.V_ARRAY^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.V_ARRAY^INTEGER_32^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T15> $o: ref, $f: Field T15 :: { read.fun.V_ARRAY^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.V_ARRAY^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));
...
axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T16> $o: ref, $f: Field T16 :: { modify.V_ARRAY^INTEGER_32^.upper_(heap, current)[$o, $f] } (modify.V_ARRAY^INTEGER_32^.upper_(heap, current)[$o, $f]) <==> (false)))));

function read.fun.V_ARRAY^INTEGER_32^.upper_(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T17> $o: ref, $f: Field T17 :: { read.fun.V_ARRAY^INTEGER_32^.upper_(heap, current)[$o, $f] } (read.fun.V_ARRAY^INTEGER_32^.upper_(heap, current)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));
...
axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T18> $o: ref, $f: Field T18 :: { modify.V_SPECIAL^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.V_SPECIAL^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.V_SPECIAL^INTEGER_32^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T19> $o: ref, $f: Field T19 :: { read.fun.V_SPECIAL^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.V_SPECIAL^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));
