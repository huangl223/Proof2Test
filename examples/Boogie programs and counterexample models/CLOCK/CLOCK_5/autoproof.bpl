// Automatically generated (04/01/2023 9:06:10.333 PM)
...
const unique CLOCK_5: Type;

axiom ((CLOCK_5) <: (ANY));

axiom ((forall t: Type :: { (CLOCK_5) <: (t) } ((CLOCK_5) <: (t)) <==> (((t) == (CLOCK_5)) || ((ANY) <: (t)))));

axiom ((FieldId(allocated, CLOCK_5)) == (-1));

axiom ((FieldId(closed, CLOCK_5)) == (-2));

axiom ((FieldId(owner, CLOCK_5)) == (-3));

axiom ((FieldId(owns, CLOCK_5)) == (-4));

axiom ((FieldId(observers, CLOCK_5)) == (-5));

axiom ((FieldId(subjects, CLOCK_5)) == (-6));

axiom ((forall <T0> $f: Field T0 :: { IsModelField($f, CLOCK_5) } (IsModelField($f, CLOCK_5)) <==> ((($f) == (CLOCK_5.hours)) || (($f) == (CLOCK_5.minutes)) || (($f) == (CLOCK_5.seconds)) || (($f) == (subjects)) || (($f) == (observers)))));

function { :inline } CLOCK_5.user_inv(heap: HeapType, current: ref) returns (bool) {
  ((0) <= (heap[current, CLOCK_5.hours])) && ((heap[current, CLOCK_5.hours]) <= (23)) && ((0) <= (heap[current, CLOCK_5.minutes])) && ((heap[current, CLOCK_5.minutes]) <= (59)) && ((0) <= (heap[current, CLOCK_5.seconds])) && ((heap[current, CLOCK_5.seconds]) <= (59)) && (Set#IsEmpty(heap[current, observers])) && (Set#IsEmpty(heap[current, subjects])) && (Set#IsEmpty(heap[current, owns])) && (admissibility2(heap, current))
}

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached_exact(heap, current, CLOCK_5)) ==> ((user_inv(heap, current)) <==> (CLOCK_5.user_inv(heap, current)))));

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached(heap, current, CLOCK_5)) ==> ((user_inv(heap, current)) ==> (CLOCK_5.user_inv(heap, current)))));

procedure CLOCK_5.invariant_admissibility_check(Current: ref);
  requires attached_exact(Heap, Current, CLOCK_5);



implementation CLOCK_5.invariant_admissibility_check(Current: ref)
{
  entry:
  goto pre, a2, a3;
  pre:
  assert user_inv_readable(Heap, Current)[Current, CLOCK_5.hours]; // type:access tag:attribute_readable line:134 cid:42 fid:79
  assert user_inv_readable(Heap, Current)[Current, CLOCK_5.hours]; // type:access tag:attribute_readable line:134 cid:42 fid:79
  assume ((0) <= (Heap[Current, CLOCK_5.hours])) && ((Heap[Current, CLOCK_5.hours]) <= (23));
  assert user_inv_readable(Heap, Current)[Current, CLOCK_5.minutes]; // type:access tag:attribute_readable line:135 cid:42 fid:80
  assert user_inv_readable(Heap, Current)[Current, CLOCK_5.minutes]; // type:access tag:attribute_readable line:135 cid:42 fid:80
  assume ((0) <= (Heap[Current, CLOCK_5.minutes])) && ((Heap[Current, CLOCK_5.minutes]) <= (59));
  assert user_inv_readable(Heap, Current)[Current, CLOCK_5.seconds]; // type:access tag:attribute_readable line:136 cid:42 fid:81
  assert user_inv_readable(Heap, Current)[Current, CLOCK_5.seconds]; // type:access tag:attribute_readable line:136 cid:42 fid:81
  assume ((0) <= (Heap[Current, CLOCK_5.seconds])) && ((Heap[Current, CLOCK_5.seconds]) <= (59));
  return;
  a2:
...
procedure create.CLOCK_5.make(Current: ref);
  free requires attached_exact(Heap, Current, CLOCK_5); // info:type property for argument Current
  modifies Heap;
  ensures ((Heap[Current, CLOCK_5.hours]) == (0)) && ((Heap[Current, CLOCK_5.minutes]) == (0)) && ((Heap[Current, CLOCK_5.seconds]) == (0)); // type:post tag:initialized line:23
  ...
  requires Frame#Subset(modify.CLOCK_5.make(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.CLOCK_5.make(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts



implementation create.CLOCK_5.make(Current: ref)
{
  entry:
  assume {:captureState "create.CLOCK_5.make"} true;
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\clock\clock_5.e:18
  // hours := 0
  call update_heap(Current, CLOCK_5.hours, 0); // line:18
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\clock\clock_5.e:19
  // minutes := 0
  call update_heap(Current, CLOCK_5.minutes, 0); // line:19
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\clock\clock_5.e:20
  // seconds := 0
  call update_heap(Current, CLOCK_5.seconds, 0); // line:20
  if (*) {
    assert ((0) <= (Heap[Current, CLOCK_5.hours])) && ((Heap[Current, CLOCK_5.hours]) <= (23)); // type:inv tag:hours_valid line:71 cid:4 rid:53
    assume false;
  }
  if (*) {
    assert ((0) <= (Heap[Current, CLOCK_5.minutes])) && ((Heap[Current, CLOCK_5.minutes]) <= (59)); // type:inv tag:minutes_valid line:71 cid:4 rid:53
    assume false;
  }
  if (*) {
    assert ((0) <= (Heap[Current, CLOCK_5.seconds])) && ((Heap[Current, CLOCK_5.seconds]) <= (59)); // type:inv tag:seconds_valid line:71 cid:4 rid:53
    assume false;
  }
  if (*) {
    assert Set#IsEmpty(Heap[Current, observers]); // type:inv tag:default_observers line:71 cid:4 rid:53
    assume false;
  }
  if (*) {
    assert Set#IsEmpty(Heap[Current, subjects]); // type:inv tag:default_subjects line:71 cid:4 rid:53
    assume false;
  }
  if (*) {
    assert Set#IsEmpty(Heap[Current, owns]); // type:inv tag:default_owns line:71 cid:4 rid:53
    assume false;
  }
  if (*) {
    assert admissibility2(Heap, Current); // type:inv tag:A2 line:71 cid:4 rid:53
    assume false;
  }
  call wrap(Current); // default:wrapping cid:4 rid:53 line:24
}

procedure CLOCK_5.set_hours(Current: ref, a_value: int);
  free requires attached_exact(Heap, Current, CLOCK_5); // info:type property for argument Current
  free requires is_integer_32(a_value); // info:type property for argument a_value
  modifies Heap;
  requires ((0) <= (a_value)) && ((a_value) < (24)); // type:pre tag:valid_hours line:42
  ensures (Heap[Current, CLOCK_5.hours]) == (a_value); // type:post tag:hours_set line:46
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.CLOCK_5.set_hours(Heap, Current, a_value), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.CLOCK_5.set_hours(old(Heap), Current, a_value));
  free ensures HeapSucc(old(Heap), Heap);
...
function { :inline } variant.CLOCK_5.set_hours.1(heap: HeapType, current: ref, a_value: int) returns (int) {
  a_value
}

implementation CLOCK_5.set_hours(Current: ref, a_value: int)
{
  entry:
  assume {:captureState "CLOCK_5.set_hours"} true;
  call unwrap(Current); // default:wrapping cid:4 rid:55 line:39
  assume CLOCK_5.user_inv(Heap, Current);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\clock\clock_5.e:44
  // hours := a_value
  call update_heap(Current, CLOCK_5.hours, a_value); // line:44
  if (*) {
    assert ((0) <= (Heap[Current, CLOCK_5.hours])) && ((Heap[Current, CLOCK_5.hours]) <= (23)); // type:inv tag:hours_valid line:71 cid:4 rid:53
    assume false;
  }
  ...
  call wrap(Current); // default:wrapping cid:4 rid:53 line:48
}

procedure CLOCK_5.set_minutes(Current: ref, a_value: int);
  free requires attached_exact(Heap, Current, CLOCK_5); // info:type property for argument Current
  free requires is_integer_32(a_value); // info:type property for argument a_value
  modifies Heap;
  requires ((0) <= (a_value)) && ((a_value) < (60)); // type:pre tag:valid_minutes line:53
  ensures (Heap[Current, CLOCK_5.minutes]) == (a_value); // type:post tag:minutes_set line:57
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.CLOCK_5.set_minutes(Heap, Current, a_value), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.CLOCK_5.set_minutes(old(Heap), Current, a_value));
  free ensures HeapSucc(old(Heap), Heap);
  requires is_wrapped(Heap, Current); // type:pre tag:default_is_wrapped default:contracts
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts
...
function { :inline } variant.CLOCK_5.set_minutes.1(heap: HeapType, current: ref, a_value: int) returns (int) {
  a_value
}

implementation CLOCK_5.set_minutes(Current: ref, a_value: int)
{
  entry:
  assume {:captureState "CLOCK_5.set_minutes"} true;
  call unwrap(Current); // default:wrapping cid:4 rid:55 line:50
  assume CLOCK_5.user_inv(Heap, Current);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\clock\clock_5.e:55
  // minutes := a_value
  call update_heap(Current, CLOCK_5.minutes, a_value); // line:55
  if (*) {
    assert ((0) <= (Heap[Current, CLOCK_5.hours])) && ((Heap[Current, CLOCK_5.hours]) <= (23)); // type:inv tag:hours_valid line:71 cid:4 rid:53
    assume false;
  }
  ...
  call wrap(Current); // default:wrapping cid:4 rid:53 line:59
}

procedure CLOCK_5.set_seconds(Current: ref, a_value: int);
  free requires attached_exact(Heap, Current, CLOCK_5); // info:type property for argument Current
  free requires is_integer_32(a_value); // info:type property for argument a_value
  modifies Heap;
  requires ((0) <= (a_value)) && ((a_value) < (60)); // type:pre tag:valid_seconds line:64
  ensures (Heap[Current, CLOCK_5.seconds]) == (a_value); // type:post tag:seconds_set line:69
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.CLOCK_5.set_seconds(Heap, Current, a_value), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.CLOCK_5.set_seconds(old(Heap), Current, a_value));
  free ensures HeapSucc(old(Heap), Heap);
  requires is_wrapped(Heap, Current); // type:pre tag:default_is_wrapped default:contracts
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts
...
function { :inline } variant.CLOCK_5.set_seconds.1(heap: HeapType, current: ref, a_value: int) returns (int) {
  a_value
}

implementation CLOCK_5.set_seconds(Current: ref, a_value: int)
{
  entry:
  assume {:captureState "CLOCK_5.set_seconds"} true;
  call unwrap(Current); // default:wrapping cid:4 rid:55 line:61
  assume CLOCK_5.user_inv(Heap, Current);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\clock\clock_5.e:67
  // seconds := a_value
  call update_heap(Current, CLOCK_5.seconds, a_value); // line:67
  if (*) {
    assert ((0) <= (Heap[Current, CLOCK_5.hours])) && ((Heap[Current, CLOCK_5.hours]) <= (23)); // type:inv tag:hours_valid line:71 cid:4 rid:53
    assume false;
  }
  ...
  call wrap(Current); // default:wrapping cid:4 rid:53 line:71
}

procedure CLOCK_5.increase_hours(Current: ref);
  free requires attached_exact(Heap, Current, CLOCK_5); // info:type property for argument Current
  modifies Heap;
  ensures (Heap[Current, CLOCK_5.hours]) == (((old(Heap)[Current, CLOCK_5.hours]) + (1)) mod (24)); // type:post tag:hours_increased line:87
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.CLOCK_5.increase_hours(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.CLOCK_5.increase_hours(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  requires is_wrapped(Heap, Current); // type:pre tag:default_is_wrapped default:contracts
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts
...
function { :inline } variant.CLOCK_5.increase_hours.1(heap: HeapType, current: ref) returns (int) {
  0
}

implementation CLOCK_5.increase_hours(Current: ref)
{
  entry:
  assume {:captureState "CLOCK_5.increase_hours"} true;
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\clock\clock_5.e:81
  // if hours = 23 then
  if ((Heap[Current, CLOCK_5.hours]) == (23)) {
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\clock\clock_5.e:82
    // set_hours (0)
    call CLOCK_5.set_hours(Current, 0); // line:82 cid:42 rid:1039
  } else {
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\clock\clock_5.e:84
    // set_hours (hours + 1)
    call CLOCK_5.set_hours(Current, (Heap[Current, CLOCK_5.hours]) + (1)); // line:84 cid:42 rid:1039
  }
}

procedure CLOCK_5.increase_minutes(Current: ref);
  free requires attached_exact(Heap, Current, CLOCK_5); // info:type property for argument Current
  modifies Heap;
  ensures ((old(Heap)[Current, CLOCK_5.minutes]) == (59)) ==> ((Heap[Current, CLOCK_5.hours]) == (((old(Heap)[Current, CLOCK_5.hours]) + (1)) mod (24))); // type:post tag:hours_increased line:106
  ensures ((old(Heap)[Current, CLOCK_5.minutes]) < (59)) ==> ((Heap[Current, CLOCK_5.hours]) == (old(Heap)[Current, CLOCK_5.hours])); // type:post tag:hours_unchanged line:107
  ensures (Heap[Current, CLOCK_5.minutes]) == (((old(Heap)[Current, CLOCK_5.minutes]) + (1)) mod (60)); // type:post tag:minutes_increased line:108
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.CLOCK_5.increase_minutes(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.CLOCK_5.increase_minutes(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  requires is_wrapped(Heap, Current); // type:pre tag:default_is_wrapped default:contracts
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts
...
function { :inline } variant.CLOCK_5.increase_minutes.1(heap: HeapType, current: ref) returns (int) {
  0
}

implementation CLOCK_5.increase_minutes(Current: ref)
{
  entry:
  assume {:captureState "CLOCK_5.increase_minutes"} true;
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\clock\clock_5.e:97
  // if minutes < 59 then
  if ((Heap[Current, CLOCK_5.minutes]) < (59)) {
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\clock\clock_5.e:98
    // set_minutes (minutes + 1)
    call CLOCK_5.set_minutes(Current, (Heap[Current, CLOCK_5.minutes]) + (1)); // line:98 cid:42 rid:1040
  } else {
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\clock\clock_5.e:102
    // set_minutes (0)
    call CLOCK_5.set_minutes(Current, 0); // line:102 cid:42 rid:1040
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\clock\clock_5.e:103
    // increase_hours
    call CLOCK_5.increase_hours(Current); // line:103 cid:42 rid:1042
  }
}

procedure CLOCK_5.increase_seconds(Current: ref);
  free requires attached_exact(Heap, Current, CLOCK_5); // info:type property for argument Current
  modifies Heap;
  ensures (((old(Heap)[Current, CLOCK_5.seconds]) == (59)) && ((old(Heap)[Current, CLOCK_5.minutes]) == (59))) ==> ((Heap[Current, CLOCK_5.hours]) == (((old(Heap)[Current, CLOCK_5.hours]) + (1)) mod (24))); // type:post tag:hours_increased line:125
  ensures (((old(Heap)[Current, CLOCK_5.seconds]) < (59)) || ((old(Heap)[Current, CLOCK_5.minutes]) < (59))) ==> ((Heap[Current, CLOCK_5.hours]) == (old(Heap)[Current, CLOCK_5.hours])); // type:post tag:hours_unchanged line:126
  ensures ((old(Heap)[Current, CLOCK_5.seconds]) == (59)) ==> ((Heap[Current, CLOCK_5.minutes]) == (((old(Heap)[Current, CLOCK_5.minutes]) + (1)) mod (60))); // type:post tag:minutes_increased line:127
  ensures ((old(Heap)[Current, CLOCK_5.seconds]) < (59)) ==> ((Heap[Current, CLOCK_5.minutes]) == (old(Heap)[Current, CLOCK_5.minutes])); // type:post tag:minutes_unchanged line:128
  ensures (Heap[Current, CLOCK_5.seconds]) == (((old(Heap)[Current, CLOCK_5.seconds]) + (1)) mod (60)); // type:post tag:seonds_inreased line:129
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.CLOCK_5.increase_seconds(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.CLOCK_5.increase_seconds(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  requires is_wrapped(Heap, Current); // type:pre tag:default_is_wrapped default:contracts
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts
...
function { :inline } variant.CLOCK_5.increase_seconds.1(heap: HeapType, current: ref) returns (int) {
  0
}

implementation CLOCK_5.increase_seconds(Current: ref)
{
  entry:
  assume {:captureState "CLOCK_5.increase_seconds"} true;
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\clock\clock_5.e:118
  // if seconds > 59 then
  if ((Heap[Current, CLOCK_5.seconds]) > (59)) {
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\clock\clock_5.e:119
    // set_seconds (0)
    call CLOCK_5.set_seconds(Current, 0); // line:119 cid:42 rid:1041
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\clock\clock_5.e:120
    // increase_minutes
    call CLOCK_5.increase_minutes(Current); // line:120 cid:42 rid:1043
  } else {
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\clock\clock_5.e:122
    // set_seconds (seconds + 1)
    call CLOCK_5.set_seconds(Current, (Heap[Current, CLOCK_5.seconds]) + (1)); // line:122 cid:42 rid:1041
  }
}

const CLOCK_5.hours: Field int;

axiom ((FieldId(CLOCK_5.hours, CLOCK_5)) == (79));

axiom ((forall heap: HeapType, o: ref :: { heap[o, CLOCK_5.hours] } ((IsHeap(heap)) && (attached(heap, o, CLOCK_5))) ==> (is_integer_32(heap[o, CLOCK_5.hours]))));

axiom ((forall heap: HeapType, current: ref, v: int, o: ref :: { guard(heap, current, CLOCK_5.hours, v, o) } (attached_exact(heap, current, CLOCK_5)) ==> ((guard(heap, current, CLOCK_5.hours, v, o)) <==> ((user_inv(heap, o)) ==> (user_inv(heap[current, CLOCK_5.hours := v], o))))));

axiom ((forall heap: HeapType, current: ref, v: int, o: ref :: { guard(heap, current, CLOCK_5.hours, v, o) } (attached(heap, current, CLOCK_5)) ==> ((guard(heap, current, CLOCK_5.hours, v, o)) ==> ((user_inv(heap, o)) ==> (user_inv(heap[current, CLOCK_5.hours := v], o))))));

const CLOCK_5.minutes: Field int;

axiom ((FieldId(CLOCK_5.minutes, CLOCK_5)) == (80));

axiom ((forall heap: HeapType, o: ref :: { heap[o, CLOCK_5.minutes] } ((IsHeap(heap)) && (attached(heap, o, CLOCK_5))) ==> (is_integer_32(heap[o, CLOCK_5.minutes]))));

axiom ((forall heap: HeapType, current: ref, v: int, o: ref :: { guard(heap, current, CLOCK_5.minutes, v, o) } (attached_exact(heap, current, CLOCK_5)) ==> ((guard(heap, current, CLOCK_5.minutes, v, o)) <==> ((user_inv(heap, o)) ==> (user_inv(heap[current, CLOCK_5.minutes := v], o))))));

axiom ((forall heap: HeapType, current: ref, v: int, o: ref :: { guard(heap, current, CLOCK_5.minutes, v, o) } (attached(heap, current, CLOCK_5)) ==> ((guard(heap, current, CLOCK_5.minutes, v, o)) ==> ((user_inv(heap, o)) ==> (user_inv(heap[current, CLOCK_5.minutes := v], o))))));

const CLOCK_5.seconds: Field int;

axiom ((FieldId(CLOCK_5.seconds, CLOCK_5)) == (81));

axiom ((forall heap: HeapType, o: ref :: { heap[o, CLOCK_5.seconds] } ((IsHeap(heap)) && (attached(heap, o, CLOCK_5))) ==> (is_integer_32(heap[o, CLOCK_5.seconds]))));

axiom ((forall heap: HeapType, current: ref, v: int, o: ref :: { guard(heap, current, CLOCK_5.seconds, v, o) } (attached_exact(heap, current, CLOCK_5)) ==> ((guard(heap, current, CLOCK_5.seconds, v, o)) <==> ((user_inv(heap, o)) ==> (user_inv(heap[current, CLOCK_5.seconds := v], o))))));

axiom ((forall heap: HeapType, current: ref, v: int, o: ref :: { guard(heap, current, CLOCK_5.seconds, v, o) } (attached(heap, current, CLOCK_5)) ==> ((guard(heap, current, CLOCK_5.seconds, v, o)) ==> ((user_inv(heap, o)) ==> (user_inv(heap[current, CLOCK_5.seconds := v], o))))));
...
axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, owns, v, o) } (attached_exact(heap, current, CLOCK_5)) ==> ((guard(heap, current, owns, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, subjects, v, o) } (attached_exact(heap, current, CLOCK_5)) ==> ((guard(heap, current, subjects, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached_exact(heap, current, CLOCK_5)) ==> ((guard(heap, current, observers, v, o)) <==> (fun.CLOCK_5.in_observers(heap, current, v, o)))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached(heap, current, CLOCK_5)) ==> ((guard(heap, current, observers, v, o)) ==> (fun.CLOCK_5.in_observers(heap, current, v, o)))));

function modify.CLOCK_5.make(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T2> $o: ref, $f: Field T2 :: { modify.CLOCK_5.make(heap, current)[$o, $f] } (modify.CLOCK_5.make(heap, current)[$o, $f]) <==> ((($o) == (current)) && ((!(IsModelField($f, CLOCK_5))) || (($f) == (CLOCK_5.hours)) || (($f) == (CLOCK_5.minutes)) || (($f) == (CLOCK_5.seconds))))))));

function modify.CLOCK_5.set_hours(heap: HeapType, current: ref, a_value: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a_value: int :: (IsHeap(heap)) ==> ((forall <T3> $o: ref, $f: Field T3 :: { modify.CLOCK_5.set_hours(heap, current, a_value)[$o, $f] } (modify.CLOCK_5.set_hours(heap, current, a_value)[$o, $f]) <==> ((($o) == (current)) && ((!(IsModelField($f, CLOCK_5))) || (($f) == (CLOCK_5.hours))))))));

function modify.CLOCK_5.set_minutes(heap: HeapType, current: ref, a_value: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a_value: int :: (IsHeap(heap)) ==> ((forall <T4> $o: ref, $f: Field T4 :: { modify.CLOCK_5.set_minutes(heap, current, a_value)[$o, $f] } (modify.CLOCK_5.set_minutes(heap, current, a_value)[$o, $f]) <==> ((($o) == (current)) && ((!(IsModelField($f, CLOCK_5))) || (($f) == (CLOCK_5.minutes))))))));

function modify.CLOCK_5.set_seconds(heap: HeapType, current: ref, a_value: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a_value: int :: (IsHeap(heap)) ==> ((forall <T5> $o: ref, $f: Field T5 :: { modify.CLOCK_5.set_seconds(heap, current, a_value)[$o, $f] } (modify.CLOCK_5.set_seconds(heap, current, a_value)[$o, $f]) <==> ((($o) == (current)) && ((!(IsModelField($f, CLOCK_5))) || (($f) == (CLOCK_5.seconds))))))));

function modify.CLOCK_5.increase_hours(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T6> $o: ref, $f: Field T6 :: { modify.CLOCK_5.increase_hours(heap, current)[$o, $f] } (modify.CLOCK_5.increase_hours(heap, current)[$o, $f]) <==> ((($o) == (current)) && ((!(IsModelField($f, CLOCK_5))) || (($f) == (CLOCK_5.hours))))))));

function modify.CLOCK_5.increase_minutes(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T7> $o: ref, $f: Field T7 :: { modify.CLOCK_5.increase_minutes(heap, current)[$o, $f] } (modify.CLOCK_5.increase_minutes(heap, current)[$o, $f]) <==> ((($o) == (current)) && ((!(IsModelField($f, CLOCK_5))) || (($f) == (CLOCK_5.minutes)) || (($f) == (CLOCK_5.hours))))))));

function modify.CLOCK_5.increase_seconds(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T8> $o: ref, $f: Field T8 :: { modify.CLOCK_5.increase_seconds(heap, current)[$o, $f] } (modify.CLOCK_5.increase_seconds(heap, current)[$o, $f]) <==> ((($o) == (current)) && ((!(IsModelField($f, CLOCK_5))) || (($f) == (CLOCK_5.seconds)) || (($f) == (CLOCK_5.minutes)) || (($f) == (CLOCK_5.hours))))))));
...
procedure CLOCK_5.in_observers(Current: ref, new_observers: Set (ref), o: ref) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, CLOCK_5); // info:type property for argument Current
  free requires Set#ItemsType(Heap, new_observers, ANY); // info:type property for argument new_observers
  free requires ((o) != (Void)) && (Heap[o, allocated]); // info:type property for argument o
  modifies Heap;
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.CLOCK_5.in_observers(Heap, Current, new_observers, o), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.CLOCK_5.in_observers(old(Heap), Current, new_observers, o));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.CLOCK_5.in_observers(Heap, Current, new_observers, o), readable);



function fun.CLOCK_5.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

function fun0.CLOCK_5.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.CLOCK_5.in_observers(heap, current, new_observers, o) } { trigger.fun.CLOCK_5.in_observers(heap, current, new_observers, o) } (pre.fun.CLOCK_5.in_observers(heap, current, new_observers, o)) ==> ((fun.CLOCK_5.in_observers(heap, current, new_observers, o)) == ((attached(heap, o, ANY)) && (new_observers[o])))));

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.CLOCK_5.in_observers(heap, current, new_observers, o) } (fun.CLOCK_5.in_observers(heap, current, new_observers, o)) == (fun0.CLOCK_5.in_observers(heap, current, new_observers, o))));

axiom ((forall h: HeapType, h': HeapType, current: ref, new_observers: Set (ref), o: ref :: { HeapSucc(h, h'), fun0.CLOCK_5.in_observers(h, current, new_observers, o), fun0.CLOCK_5.in_observers(h', current, new_observers, o) } ((HeapSucc(h, h')) && (pre.fun.CLOCK_5.in_observers(h, current, new_observers, o)) && (pre.fun.CLOCK_5.in_observers(h', current, new_observers, o)) && (same_inside(h, h', read.fun.CLOCK_5.in_observers(h, current, new_observers, o)))) ==> ((fun0.CLOCK_5.in_observers(h, current, new_observers, o)) == (fun0.CLOCK_5.in_observers(h', current, new_observers, o)))));
...
function modify.CLOCK_5.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T11> $o: ref, $f: Field T11 :: { modify.CLOCK_5.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.CLOCK_5.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.CLOCK_5.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T12> $o: ref, $f: Field T12 :: { read.fun.CLOCK_5.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.CLOCK_5.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.CLOCK_5.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool) {
  true
}

function trigger.fun.CLOCK_5.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);
