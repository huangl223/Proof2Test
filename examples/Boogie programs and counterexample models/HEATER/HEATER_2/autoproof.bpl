// Automatically generated (04/02/2023 9:09:49.930 AM)
...
const unique HEATER_2: Type;

axiom ((HEATER_2) <: (ANY));

axiom ((forall t: Type :: { (HEATER_2) <: (t) } ((HEATER_2) <: (t)) <==> (((t) == (HEATER_2)) || ((ANY) <: (t)))));

axiom ((FieldId(allocated, HEATER_2)) == (-1));

axiom ((FieldId(closed, HEATER_2)) == (-2));

axiom ((FieldId(owner, HEATER_2)) == (-3));

axiom ((FieldId(owns, HEATER_2)) == (-4));

axiom ((FieldId(observers, HEATER_2)) == (-5));

axiom ((FieldId(subjects, HEATER_2)) == (-6));

axiom ((forall <T0> $f: Field T0 :: { IsModelField($f, HEATER_2) } (IsModelField($f, HEATER_2)) <==> ((($f) == (subjects)) || (($f) == (observers)))));

function { :inline } HEATER_2.user_inv(heap: HeapType, current: ref) returns (bool) {
  ((heap[current, HEATER_2.desired_temp]) >= (10)) && ((heap[current, HEATER_2.desired_temp]) <= (100)) && (Set#IsEmpty(heap[current, observers])) && (Set#IsEmpty(heap[current, subjects])) && (Set#IsEmpty(heap[current, owns])) && (admissibility2(heap, current))
}

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached_exact(heap, current, HEATER_2)) ==> ((user_inv(heap, current)) <==> (HEATER_2.user_inv(heap, current)))));

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached(heap, current, HEATER_2)) ==> ((user_inv(heap, current)) ==> (HEATER_2.user_inv(heap, current)))));

procedure HEATER_2.invariant_admissibility_check(Current: ref);
  requires attached_exact(Heap, Current, HEATER_2);



implementation HEATER_2.invariant_admissibility_check(Current: ref)
{
  entry:
  goto pre, a2, a3;
  pre:
  assert user_inv_readable(Heap, Current)[Current, HEATER_2.desired_temp]; // type:access tag:attribute_readable line:76 cid:36 fid:80
  assert user_inv_readable(Heap, Current)[Current, HEATER_2.desired_temp]; // type:access tag:attribute_readable line:76 cid:36 fid:80
  assume ((Heap[Current, HEATER_2.desired_temp]) >= (10)) && ((Heap[Current, HEATER_2.desired_temp]) <= (100));
  return;
  a2:
...
procedure create.HEATER_2.make(Current: ref);
  free requires attached_exact(Heap, Current, HEATER_2); // info:type property for argument Current
  modifies Heap;
  ensures ((Heap[Current, HEATER_2.desired_temp]) == (20)) && ((Heap[Current, HEATER_2.is_on]) == (false)); // type:post tag:default_condition line:19
  ...
  requires Frame#Subset(modify.HEATER_2.make(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.HEATER_2.make(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts



implementation create.HEATER_2.make(Current: ref)
{
  entry:
  assume {:captureState "create.HEATER_2.make"} true;
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\heater\heater_2.e:16
  // desired_temp := 20
  call update_heap(Current, HEATER_2.desired_temp, 20); // line:16
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\heater\heater_2.e:17
  // is_on := False
  call update_heap(Current, HEATER_2.is_on, false); // line:17
  if (*) {
    assert ((Heap[Current, HEATER_2.desired_temp]) >= (10)) && ((Heap[Current, HEATER_2.desired_temp]) <= (100)); // type:inv tag:desired_temp_in_bound line:73 cid:4 rid:53
    assume false;
  }
  if (*) {
...
procedure HEATER_2.make(Current: ref);
  free requires attached_exact(Heap, Current, HEATER_2); // info:type property for argument Current
  modifies Heap;
  ensures ((Heap[Current, HEATER_2.desired_temp]) == (20)) && ((Heap[Current, HEATER_2.is_on]) == (false)); // type:post tag:default_condition line:19
  free requires global(Heap);
...
function { :inline } variant.HEATER_2.make.1(heap: HeapType, current: ref) returns (int) {
  0
}

implementation HEATER_2.make(Current: ref)
{
  entry:
  assume {:captureState "HEATER_2.make"} true;
  call unwrap(Current); // default:wrapping cid:4 rid:55 line:13
  assume HEATER_2.user_inv(Heap, Current);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\heater\heater_2.e:16
  // desired_temp := 20
  call update_heap(Current, HEATER_2.desired_temp, 20); // line:16
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\heater\heater_2.e:17
...
procedure HEATER_2.set_temperature(Current: ref, a_value: int);
  free requires attached_exact(Heap, Current, HEATER_2); // info:type property for argument Current
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.HEATER_2.set_temperature(Heap, Current, a_value), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.HEATER_2.set_temperature(old(Heap), Current, a_value));
  free ensures HeapSucc(old(Heap), Heap);
  requires is_wrapped(Heap, Current); // type:pre tag:default_is_wrapped default:contracts
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts
...
function { :inline } variant.HEATER_2.set_temperature.1(heap: HeapType, current: ref, a_value: int) returns (int) {
  a_value
}

implementation HEATER_2.set_temperature(Current: ref, a_value: int)
{
  entry:
  assume {:captureState "HEATER_2.set_temperature"} true;
  call unwrap(Current); // default:wrapping cid:4 rid:55 line:38
  assume HEATER_2.user_inv(Heap, Current);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\heater\heater_2.e:41
  // temperature := a_value
  call update_heap(Current, HEATER_2.temperature, a_value); // line:41
  if (*) {
    assert ((Heap[Current, HEATER_2.desired_temp]) >= (10)) && ((Heap[Current, HEATER_2.desired_temp]) <= (100)); // type:inv tag:desired_temp_in_bound line:73 cid:4 rid:53
    assume false;
  }
...
procedure HEATER_2.set_desired_temperature(Current: ref, value: int);
  free requires attached_exact(Heap, Current, HEATER_2); // info:type property for argument Current
  ...
  ensures (Heap[Current, HEATER_2.desired_temp]) == (value); // type:post tag:temperature_set line:51
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.HEATER_2.set_desired_temperature(Heap, Current, value), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.HEATER_2.set_desired_temperature(old(Heap), Current, value));
  free ensures HeapSucc(old(Heap), Heap);
  requires is_wrapped(Heap, Current); // type:pre tag:default_is_wrapped default:contracts
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts
...
function { :inline } variant.HEATER_2.set_desired_temperature.1(heap: HeapType, current: ref, value: int) returns (int) {
  value
}

implementation HEATER_2.set_desired_temperature(Current: ref, value: int)
{
  entry:
  assume {:captureState "HEATER_2.set_desired_temperature"} true;
  call unwrap(Current); // default:wrapping cid:4 rid:55 line:44
  assume HEATER_2.user_inv(Heap, Current);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\heater\heater_2.e:49
  // desired_temp := value
  call update_heap(Current, HEATER_2.desired_temp, value); // line:49
  if (*) {
    assert ((Heap[Current, HEATER_2.desired_temp]) >= (10)) && ((Heap[Current, HEATER_2.desired_temp]) <= (100)); // type:inv tag:desired_temp_in_bound line:73 cid:4 rid:53
    assume false;
  }
...
procedure HEATER_2.turn_on_off(Current: ref);
  free requires attached_exact(Heap, Current, HEATER_2); // info:type property for argument Current
  modifies Heap;
  requires ((Heap[Current, HEATER_2.desired_temp]) >= (10)) && ((Heap[Current, HEATER_2.desired_temp]) <= (100)); // type:pre tag:desired_temp_valid line:57
  ensures ((old(Heap)[Current, HEATER_2.is_on]) && ((old(Heap)[Current, HEATER_2.temperature]) > ((old(Heap)[Current, HEATER_2.desired_temp]) + (2)))) ==> (!(Heap[Current, HEATER_2.is_on])); // type:post tag:heater_is_turned_off line:69
  ensures ((old(Heap)[Current, HEATER_2.is_on]) && ((old(Heap)[Current, HEATER_2.temperature]) <= ((old(Heap)[Current, HEATER_2.desired_temp]) + (2)))) ==> (Heap[Current, HEATER_2.is_on]); // type:post tag:heater_remains_on line:70
  ensures ((!(old(Heap)[Current, HEATER_2.is_on])) && ((old(Heap)[Current, HEATER_2.temperature]) < ((old(Heap)[Current, HEATER_2.desired_temp]) - (2)))) ==> (Heap[Current, HEATER_2.is_on]); // type:post tag:heater_is_turned_on line:71
  ensures ((!(old(Heap)[Current, HEATER_2.is_on])) && ((old(Heap)[Current, HEATER_2.temperature]) >= ((old(Heap)[Current, HEATER_2.desired_temp]) - (2)))) ==> (!(Heap[Current, HEATER_2.is_on])); // type:post tag:heater_remains_off line:72
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.HEATER_2.turn_on_off(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.HEATER_2.turn_on_off(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  requires is_wrapped(Heap, Current); // type:pre tag:default_is_wrapped default:contracts
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts
...
function { :inline } variant.HEATER_2.turn_on_off.1(heap: HeapType, current: ref) returns (int) {
  0
}

implementation HEATER_2.turn_on_off(Current: ref)
{
  entry:
  assume {:captureState "HEATER_2.turn_on_off"} true;
  call unwrap(Current); // default:wrapping cid:4 rid:55 line:54
  assume HEATER_2.user_inv(Heap, Current);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\heater\heater_2.e:59
  // if is_on then
  if (Heap[Current, HEATER_2.is_on]) {
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\heater\heater_2.e:60
    // if temperature >= desired_temp + deviation then
    if ((Heap[Current, HEATER_2.temperature]) >= ((Heap[Current, HEATER_2.desired_temp]) + (2))) {
      // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\heater\heater_2.e:61
      // is_on := False
      call update_heap(Current, HEATER_2.is_on, false); // line:61
    }
  } else {
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\heater\heater_2.e:64
    // if temperature < desired_temp - deviation then
    if ((Heap[Current, HEATER_2.temperature]) < ((Heap[Current, HEATER_2.desired_temp]) - (2))) {
      // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\heater\heater_2.e:65
      // is_on := True
      call update_heap(Current, HEATER_2.is_on, true); // line:65
    }
  }
  if (*) {
    assert ((Heap[Current, HEATER_2.desired_temp]) >= (10)) && ((Heap[Current, HEATER_2.desired_temp]) <= (100)); // type:inv tag:desired_temp_in_bound line:73 cid:4 rid:53
...
const HEATER_2.desired_temp: Field int;

axiom ((FieldId(HEATER_2.desired_temp, HEATER_2)) == (80));

axiom ((forall heap: HeapType, o: ref :: { heap[o, HEATER_2.desired_temp] } ((IsHeap(heap)) && (attached(heap, o, HEATER_2))) ==> (is_integer_32(heap[o, HEATER_2.desired_temp]))));

axiom ((forall heap: HeapType, current: ref, v: int, o: ref :: { guard(heap, current, HEATER_2.desired_temp, v, o) } (attached_exact(heap, current, HEATER_2)) ==> ((guard(heap, current, HEATER_2.desired_temp, v, o)) <==> ((user_inv(heap, o)) ==> (user_inv(heap[current, HEATER_2.desired_temp := v], o))))));

axiom ((forall heap: HeapType, current: ref, v: int, o: ref :: { guard(heap, current, HEATER_2.desired_temp, v, o) } (attached(heap, current, HEATER_2)) ==> ((guard(heap, current, HEATER_2.desired_temp, v, o)) ==> ((user_inv(heap, o)) ==> (user_inv(heap[current, HEATER_2.desired_temp := v], o))))));
...
axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, owns, v, o) } (attached_exact(heap, current, HEATER_2)) ==> ((guard(heap, current, owns, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, subjects, v, o) } (attached_exact(heap, current, HEATER_2)) ==> ((guard(heap, current, subjects, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached_exact(heap, current, HEATER_2)) ==> ((guard(heap, current, observers, v, o)) <==> (fun.HEATER_2.in_observers(heap, current, v, o)))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached(heap, current, HEATER_2)) ==> ((guard(heap, current, observers, v, o)) ==> (fun.HEATER_2.in_observers(heap, current, v, o)))));

const HEATER_2.is_on: Field bool;

axiom ((FieldId(HEATER_2.is_on, HEATER_2)) == (81));

axiom ((forall heap: HeapType, current: ref, v: bool, o: ref :: { guard(heap, current, HEATER_2.is_on, v, o) } (attached_exact(heap, current, HEATER_2)) ==> ((guard(heap, current, HEATER_2.is_on, v, o)) <==> ((user_inv(heap, o)) ==> (user_inv(heap[current, HEATER_2.is_on := v], o))))));

axiom ((forall heap: HeapType, current: ref, v: bool, o: ref :: { guard(heap, current, HEATER_2.is_on, v, o) } (attached(heap, current, HEATER_2)) ==> ((guard(heap, current, HEATER_2.is_on, v, o)) ==> ((user_inv(heap, o)) ==> (user_inv(heap[current, HEATER_2.is_on := v], o))))));

function modify.HEATER_2.make(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T2> $o: ref, $f: Field T2 :: { modify.HEATER_2.make(heap, current)[$o, $f] } (modify.HEATER_2.make(heap, current)[$o, $f]) <==> (($o) == (current))))));

function modify.HEATER_2.set_temperature(heap: HeapType, current: ref, a_value: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a_value: int :: (IsHeap(heap)) ==> ((forall <T3> $o: ref, $f: Field T3 :: { modify.HEATER_2.set_temperature(heap, current, a_value)[$o, $f] } (modify.HEATER_2.set_temperature(heap, current, a_value)[$o, $f]) <==> (($o) == (current))))));

const HEATER_2.temperature: Field int;

axiom ((FieldId(HEATER_2.temperature, HEATER_2)) == (79));

axiom ((forall heap: HeapType, o: ref :: { heap[o, HEATER_2.temperature] } ((IsHeap(heap)) && (attached(heap, o, HEATER_2))) ==> (is_integer_32(heap[o, HEATER_2.temperature]))));

axiom ((forall heap: HeapType, current: ref, v: int, o: ref :: { guard(heap, current, HEATER_2.temperature, v, o) } (attached_exact(heap, current, HEATER_2)) ==> ((guard(heap, current, HEATER_2.temperature, v, o)) <==> ((user_inv(heap, o)) ==> (user_inv(heap[current, HEATER_2.temperature := v], o))))));

axiom ((forall heap: HeapType, current: ref, v: int, o: ref :: { guard(heap, current, HEATER_2.temperature, v, o) } (attached(heap, current, HEATER_2)) ==> ((guard(heap, current, HEATER_2.temperature, v, o)) ==> ((user_inv(heap, o)) ==> (user_inv(heap[current, HEATER_2.temperature := v], o))))));

function modify.HEATER_2.set_desired_temperature(heap: HeapType, current: ref, value: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, value: int :: (IsHeap(heap)) ==> ((forall <T4> $o: ref, $f: Field T4 :: { modify.HEATER_2.set_desired_temperature(heap, current, value)[$o, $f] } (modify.HEATER_2.set_desired_temperature(heap, current, value)[$o, $f]) <==> (($o) == (current))))));

function modify.HEATER_2.turn_on_off(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T5> $o: ref, $f: Field T5 :: { modify.HEATER_2.turn_on_off(heap, current)[$o, $f] } (modify.HEATER_2.turn_on_off(heap, current)[$o, $f]) <==> (($o) == (current))))));
...
procedure HEATER_2.in_observers(Current: ref, new_observers: Set (ref), o: ref) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, HEATER_2); // info:type property for argument Current
  free requires Set#ItemsType(Heap, new_observers, ANY); // info:type property for argument new_observers
  free requires ((o) != (Void)) && (Heap[o, allocated]); // info:type property for argument o
  modifies Heap;
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.HEATER_2.in_observers(Heap, Current, new_observers, o), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.HEATER_2.in_observers(old(Heap), Current, new_observers, o));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.HEATER_2.in_observers(Heap, Current, new_observers, o), readable);



function fun.HEATER_2.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

function fun0.HEATER_2.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.HEATER_2.in_observers(heap, current, new_observers, o) } { trigger.fun.HEATER_2.in_observers(heap, current, new_observers, o) } (pre.fun.HEATER_2.in_observers(heap, current, new_observers, o)) ==> ((fun.HEATER_2.in_observers(heap, current, new_observers, o)) == ((attached(heap, o, ANY)) && (new_observers[o])))));

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.HEATER_2.in_observers(heap, current, new_observers, o) } (fun.HEATER_2.in_observers(heap, current, new_observers, o)) == (fun0.HEATER_2.in_observers(heap, current, new_observers, o))));

axiom ((forall h: HeapType, h': HeapType, current: ref, new_observers: Set (ref), o: ref :: { HeapSucc(h, h'), fun0.HEATER_2.in_observers(h, current, new_observers, o), fun0.HEATER_2.in_observers(h', current, new_observers, o) } ((HeapSucc(h, h')) && (pre.fun.HEATER_2.in_observers(h, current, new_observers, o)) && (pre.fun.HEATER_2.in_observers(h', current, new_observers, o)) && (same_inside(h, h', read.fun.HEATER_2.in_observers(h, current, new_observers, o)))) ==> ((fun0.HEATER_2.in_observers(h, current, new_observers, o)) == (fun0.HEATER_2.in_observers(h', current, new_observers, o)))));
...
function modify.HEATER_2.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T8> $o: ref, $f: Field T8 :: { modify.HEATER_2.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.HEATER_2.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.HEATER_2.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T9> $o: ref, $f: Field T9 :: { read.fun.HEATER_2.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.HEATER_2.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.HEATER_2.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool) {
  true
}

function trigger.fun.HEATER_2.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);
