// Automatically generated (04/02/2023 2:54:10.787 PM)
...
const unique LAMP_2: Type;

axiom ((LAMP_2) <: (ANY));

axiom ((forall t: Type :: { (LAMP_2) <: (t) } ((LAMP_2) <: (t)) <==> (((t) == (LAMP_2)) || ((ANY) <: (t)))));

axiom ((FieldId(allocated, LAMP_2)) == (-1));

axiom ((FieldId(closed, LAMP_2)) == (-2));

axiom ((FieldId(owner, LAMP_2)) == (-3));

axiom ((FieldId(owns, LAMP_2)) == (-4));

axiom ((FieldId(observers, LAMP_2)) == (-5));

axiom ((FieldId(subjects, LAMP_2)) == (-6));

axiom ((forall <T0> $f: Field T0 :: { IsModelField($f, LAMP_2) } (IsModelField($f, LAMP_2)) <==> ((($f) == (subjects)) || (($f) == (observers)))));

function { :inline } LAMP_2.user_inv(heap: HeapType, current: ref) returns (bool) {
  (((heap[current, LAMP_2.light_intensity]) == (0)) || ((heap[current, LAMP_2.light_intensity]) == (25)) || ((heap[current, LAMP_2.light_intensity]) == (75)) || ((heap[current, LAMP_2.light_intensity]) == (100))) && (((heap[current, LAMP_2.previous_light_intensity]) == (0)) || ((heap[current, LAMP_2.previous_light_intensity]) == (25)) || ((heap[current, LAMP_2.previous_light_intensity]) == (75)) || ((heap[current, LAMP_2.previous_light_intensity]) == (100))) && ((heap[current, LAMP_2.is_on]) == ((heap[current, LAMP_2.light_intensity]) != (0))) && (Set#IsEmpty(heap[current, observers])) && (Set#IsEmpty(heap[current, subjects])) && (Set#IsEmpty(heap[current, owns])) && (admissibility2(heap, current))
}

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached_exact(heap, current, LAMP_2)) ==> ((user_inv(heap, current)) <==> (LAMP_2.user_inv(heap, current)))));

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached(heap, current, LAMP_2)) ==> ((user_inv(heap, current)) ==> (LAMP_2.user_inv(heap, current)))));

procedure LAMP_2.invariant_admissibility_check(Current: ref);
  requires attached_exact(Heap, Current, LAMP_2);



implementation LAMP_2.invariant_admissibility_check(Current: ref)
{
  entry:
  goto pre, a2, a3;
  pre:
  assert user_inv_readable(Heap, Current)[Current, LAMP_2.light_intensity]; // type:access tag:attribute_readable line:75 cid:37 fid:78
  assert user_inv_readable(Heap, Current)[Current, LAMP_2.light_intensity]; // type:access tag:attribute_readable line:75 cid:37 fid:78
  assert user_inv_readable(Heap, Current)[Current, LAMP_2.light_intensity]; // type:access tag:attribute_readable line:75 cid:37 fid:78
  assert user_inv_readable(Heap, Current)[Current, LAMP_2.light_intensity]; // type:access tag:attribute_readable line:75 cid:37 fid:78
  assume ((Heap[Current, LAMP_2.light_intensity]) == (0)) || ((Heap[Current, LAMP_2.light_intensity]) == (25)) || ((Heap[Current, LAMP_2.light_intensity]) == (75)) || ((Heap[Current, LAMP_2.light_intensity]) == (100));
  assert user_inv_readable(Heap, Current)[Current, LAMP_2.previous_light_intensity]; // type:access tag:attribute_readable line:77 cid:37 fid:80
  assert user_inv_readable(Heap, Current)[Current, LAMP_2.previous_light_intensity]; // type:access tag:attribute_readable line:77 cid:37 fid:80
  assert user_inv_readable(Heap, Current)[Current, LAMP_2.previous_light_intensity]; // type:access tag:attribute_readable line:77 cid:37 fid:80
  assert user_inv_readable(Heap, Current)[Current, LAMP_2.previous_light_intensity]; // type:access tag:attribute_readable line:77 cid:37 fid:80
  assume ((Heap[Current, LAMP_2.previous_light_intensity]) == (0)) || ((Heap[Current, LAMP_2.previous_light_intensity]) == (25)) || ((Heap[Current, LAMP_2.previous_light_intensity]) == (75)) || ((Heap[Current, LAMP_2.previous_light_intensity]) == (100));
  assert user_inv_readable(Heap, Current)[Current, LAMP_2.is_on]; // type:access tag:attribute_readable line:79 cid:37 fid:79
  assert user_inv_readable(Heap, Current)[Current, LAMP_2.light_intensity]; // type:access tag:attribute_readable line:79 cid:37 fid:78
  assume (Heap[Current, LAMP_2.is_on]) == ((Heap[Current, LAMP_2.light_intensity]) != (0));
  return;
  a2:
...
procedure create.LAMP_2.default_create(Current: ref);
  free requires attached_exact(Heap, Current, LAMP_2); // info:type property for argument Current
  modifies Heap;
  ...
  requires Frame#Subset(modify.LAMP_2.default_create(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.LAMP_2.default_create(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts



implementation create.LAMP_2.default_create(Current: ref)
{
  entry:
  assume {:captureState "create.LAMP_2.default_create"} true;
  if (*) {
    assert ((Heap[Current, LAMP_2.light_intensity]) == (0)) || ((Heap[Current, LAMP_2.light_intensity]) == (25)) || ((Heap[Current, LAMP_2.light_intensity]) == (75)) || ((Heap[Current, LAMP_2.light_intensity]) == (100)); // type:inv tag:value_of_light_intensity line:72 cid:4 rid:53
    assume false;
  }
  if (*) {
    assert ((Heap[Current, LAMP_2.previous_light_intensity]) == (0)) || ((Heap[Current, LAMP_2.previous_light_intensity]) == (25)) || ((Heap[Current, LAMP_2.previous_light_intensity]) == (75)) || ((Heap[Current, LAMP_2.previous_light_intensity]) == (100)); // type:inv tag:value_of_previous_intensity line:72 cid:4 rid:53
    assume false;
  }
  if (*) {
    assert (Heap[Current, LAMP_2.is_on]) == ((Heap[Current, LAMP_2.light_intensity]) != (0)); // type:inv tag:light_intensity_when_off line:72 cid:4 rid:53
    assume false;
  }
  if (*) {
...
procedure LAMP_2.turn_on_off(Current: ref);
  free requires attached_exact(Heap, Current, LAMP_2); // info:type property for argument Current
  modifies Heap;
  ensures ((!(old(Heap)[Current, LAMP_2.is_on])) && ((old(Heap)[Current, LAMP_2.previous_light_intensity]) > (0))) ==> ((Heap[Current, LAMP_2.is_on]) && ((Heap[Current, LAMP_2.light_intensity]) == (old(Heap)[Current, LAMP_2.previous_light_intensity]))); // type:post tag:turn_on_1 line:51
  ensures ((!(old(Heap)[Current, LAMP_2.is_on])) && ((old(Heap)[Current, LAMP_2.previous_light_intensity]) == (0))) ==> ((Heap[Current, LAMP_2.is_on]) && ((Heap[Current, LAMP_2.light_intensity]) == (25))); // type:post tag:turn_on_2 line:52
  ensures (old(Heap)[Current, LAMP_2.is_on]) ==> ((!(Heap[Current, LAMP_2.is_on])) && ((Heap[Current, LAMP_2.previous_light_intensity]) == (old(Heap)[Current, LAMP_2.light_intensity])) && ((Heap[Current, LAMP_2.light_intensity]) == (0))); // type:post tag:turn_off line:53
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.LAMP_2.turn_on_off(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.LAMP_2.turn_on_off(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
...
function { :inline } variant.LAMP_2.turn_on_off.1(heap: HeapType, current: ref) returns (int) {
  0
}

implementation LAMP_2.turn_on_off(Current: ref)
{
  entry:
  assume {:captureState "LAMP_2.turn_on_off"} true;
  call unwrap(Current); // default:wrapping cid:4 rid:55 line:35
  assume LAMP_2.user_inv(Heap, Current);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\lamp\lamp_2.e:38
  // if not is_on then
  if (!(Heap[Current, LAMP_2.is_on])) {
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\lamp\lamp_2.e:39
    // is_on := True
    call update_heap(Current, LAMP_2.is_on, true); // line:39
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\lamp\lamp_2.e:40
    // if previous_light_intensity > 0 then
    if ((Heap[Current, LAMP_2.previous_light_intensity]) > (0)) {
      // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\lamp\lamp_2.e:41
      // light_intensity := previous_light_intensity
      call update_heap(Current, LAMP_2.light_intensity, Heap[Current, LAMP_2.previous_light_intensity]); // line:41
    } else {
      // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\lamp\lamp_2.e:43
      // light_intensity := Low_intensity
      call update_heap(Current, LAMP_2.light_intensity, 25); // line:43
    }
  } else {
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\lamp\lamp_2.e:46
    // is_on := False
    call update_heap(Current, LAMP_2.is_on, false); // line:46
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\lamp\lamp_2.e:48
    // light_intensity := Zero_intensity
    call update_heap(Current, LAMP_2.light_intensity, 0); // line:48
  }
  if (*) {
    assert ((Heap[Current, LAMP_2.light_intensity]) == (0)) || ((Heap[Current, LAMP_2.light_intensity]) == (25)) || ((Heap[Current, LAMP_2.light_intensity]) == (75)) || ((Heap[Current, LAMP_2.light_intensity]) == (100)); // type:inv tag:value_of_light_intensity line:72 cid:4 rid:53
    assume false;
...
procedure LAMP_2.adjust_light(Current: ref);
  free requires attached_exact(Heap, Current, LAMP_2); // info:type property for argument Current
  modifies Heap;
  requires (Heap[Current, LAMP_2.is_on]) == (true); // type:pre tag:lamp_is_on line:59
  ensures ((old(Heap)[Current, LAMP_2.light_intensity]) == (25)) ==> ((Heap[Current, LAMP_2.light_intensity]) == (75)); // type:post tag:from_low_to_medium line:69
  ensures ((old(Heap)[Current, LAMP_2.light_intensity]) == (75)) ==> ((Heap[Current, LAMP_2.light_intensity]) == (100)); // type:post tag:from_medium_to_high line:70
  ensures ((old(Heap)[Current, LAMP_2.light_intensity]) == (100)) ==> ((Heap[Current, LAMP_2.light_intensity]) == (25)); // type:post tag:from_high_to_low line:71
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.LAMP_2.adjust_light(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.LAMP_2.adjust_light(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  requires is_wrapped(Heap, Current); // type:pre tag:default_is_wrapped default:contracts
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts
...
function { :inline } variant.LAMP_2.adjust_light.1(heap: HeapType, current: ref) returns (int) {
  0
}

implementation LAMP_2.adjust_light(Current: ref)
{
  entry:
  assume {:captureState "LAMP_2.adjust_light"} true;
  call unwrap(Current); // default:wrapping cid:4 rid:55 line:56
  assume LAMP_2.user_inv(Heap, Current);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\lamp\lamp_2.e:61
  // if light_intensity = Low_intensity then
  if ((Heap[Current, LAMP_2.light_intensity]) == (25)) {
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\lamp\lamp_2.e:62
    // light_intensity := Medium_intensity
    call update_heap(Current, LAMP_2.light_intensity, 75); // line:62
  } else {
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\lamp\lamp_2.e:63
    // elseif light_intensity = Medium_intensity then
    if ((Heap[Current, LAMP_2.light_intensity]) == (75)) {
      // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\lamp\lamp_2.e:64
      // light_intensity := High_intensity
      call update_heap(Current, LAMP_2.light_intensity, 100); // line:64
    } else {
      // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\lamp\lamp_2.e:65
      // elseif light_intensity = High_intensity then
      if ((Heap[Current, LAMP_2.light_intensity]) == (100)) {
        // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\lamp\lamp_2.e:66
        // light_intensity := Low_intensity
        call update_heap(Current, LAMP_2.light_intensity, 25); // line:66
      }
    }
  }
  if (*) {
...
const LAMP_2.light_intensity: Field int;

axiom ((FieldId(LAMP_2.light_intensity, LAMP_2)) == (78));

axiom ((forall heap: HeapType, o: ref :: { heap[o, LAMP_2.light_intensity] } ((IsHeap(heap)) && (attached(heap, o, LAMP_2))) ==> (is_integer_32(heap[o, LAMP_2.light_intensity]))));

axiom ((forall heap: HeapType, current: ref, v: int, o: ref :: { guard(heap, current, LAMP_2.light_intensity, v, o) } (attached_exact(heap, current, LAMP_2)) ==> ((guard(heap, current, LAMP_2.light_intensity, v, o)) <==> ((user_inv(heap, o)) ==> (user_inv(heap[current, LAMP_2.light_intensity := v], o))))));

axiom ((forall heap: HeapType, current: ref, v: int, o: ref :: { guard(heap, current, LAMP_2.light_intensity, v, o) } (attached(heap, current, LAMP_2)) ==> ((guard(heap, current, LAMP_2.light_intensity, v, o)) ==> ((user_inv(heap, o)) ==> (user_inv(heap[current, LAMP_2.light_intensity := v], o))))));

const LAMP_2.previous_light_intensity: Field int;

axiom ((FieldId(LAMP_2.previous_light_intensity, LAMP_2)) == (80));

axiom ((forall heap: HeapType, o: ref :: { heap[o, LAMP_2.previous_light_intensity] } ((IsHeap(heap)) && (attached(heap, o, LAMP_2))) ==> (is_integer_32(heap[o, LAMP_2.previous_light_intensity]))));

axiom ((forall heap: HeapType, current: ref, v: int, o: ref :: { guard(heap, current, LAMP_2.previous_light_intensity, v, o) } (attached_exact(heap, current, LAMP_2)) ==> ((guard(heap, current, LAMP_2.previous_light_intensity, v, o)) <==> ((user_inv(heap, o)) ==> (user_inv(heap[current, LAMP_2.previous_light_intensity := v], o))))));

axiom ((forall heap: HeapType, current: ref, v: int, o: ref :: { guard(heap, current, LAMP_2.previous_light_intensity, v, o) } (attached(heap, current, LAMP_2)) ==> ((guard(heap, current, LAMP_2.previous_light_intensity, v, o)) ==> ((user_inv(heap, o)) ==> (user_inv(heap[current, LAMP_2.previous_light_intensity := v], o))))));

const LAMP_2.is_on: Field bool;

axiom ((FieldId(LAMP_2.is_on, LAMP_2)) == (79));

axiom ((forall heap: HeapType, current: ref, v: bool, o: ref :: { guard(heap, current, LAMP_2.is_on, v, o) } (attached_exact(heap, current, LAMP_2)) ==> ((guard(heap, current, LAMP_2.is_on, v, o)) <==> ((user_inv(heap, o)) ==> (user_inv(heap[current, LAMP_2.is_on := v], o))))));

axiom ((forall heap: HeapType, current: ref, v: bool, o: ref :: { guard(heap, current, LAMP_2.is_on, v, o) } (attached(heap, current, LAMP_2)) ==> ((guard(heap, current, LAMP_2.is_on, v, o)) ==> ((user_inv(heap, o)) ==> (user_inv(heap[current, LAMP_2.is_on := v], o))))));
...
axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, owns, v, o) } (attached_exact(heap, current, LAMP_2)) ==> ((guard(heap, current, owns, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, subjects, v, o) } (attached_exact(heap, current, LAMP_2)) ==> ((guard(heap, current, subjects, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached_exact(heap, current, LAMP_2)) ==> ((guard(heap, current, observers, v, o)) <==> (fun.LAMP_2.in_observers(heap, current, v, o)))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached(heap, current, LAMP_2)) ==> ((guard(heap, current, observers, v, o)) ==> (fun.LAMP_2.in_observers(heap, current, v, o)))));

function modify.LAMP_2.default_create(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T3> $o: ref, $f: Field T3 :: { modify.LAMP_2.default_create(heap, current)[$o, $f] } (modify.LAMP_2.default_create(heap, current)[$o, $f]) <==> (($o) == (current))))));

function modify.LAMP_2.turn_on_off(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T4> $o: ref, $f: Field T4 :: { modify.LAMP_2.turn_on_off(heap, current)[$o, $f] } (modify.LAMP_2.turn_on_off(heap, current)[$o, $f]) <==> (($o) == (current))))));

function modify.LAMP_2.adjust_light(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T5> $o: ref, $f: Field T5 :: { modify.LAMP_2.adjust_light(heap, current)[$o, $f] } (modify.LAMP_2.adjust_light(heap, current)[$o, $f]) <==> (($o) == (current))))));
...
procedure LAMP_2.in_observers(Current: ref, new_observers: Set (ref), o: ref) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, LAMP_2); // info:type property for argument Current
  free requires Set#ItemsType(Heap, new_observers, ANY); // info:type property for argument new_observers
  free requires ((o) != (Void)) && (Heap[o, allocated]); // info:type property for argument o
  modifies Heap;
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.LAMP_2.in_observers(Heap, Current, new_observers, o), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.LAMP_2.in_observers(old(Heap), Current, new_observers, o));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.LAMP_2.in_observers(Heap, Current, new_observers, o), readable);



function fun.LAMP_2.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

function fun0.LAMP_2.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.LAMP_2.in_observers(heap, current, new_observers, o) } { trigger.fun.LAMP_2.in_observers(heap, current, new_observers, o) } (pre.fun.LAMP_2.in_observers(heap, current, new_observers, o)) ==> ((fun.LAMP_2.in_observers(heap, current, new_observers, o)) == ((attached(heap, o, ANY)) && (new_observers[o])))));

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.LAMP_2.in_observers(heap, current, new_observers, o) } (fun.LAMP_2.in_observers(heap, current, new_observers, o)) == (fun0.LAMP_2.in_observers(heap, current, new_observers, o))));

axiom ((forall h: HeapType, h': HeapType, current: ref, new_observers: Set (ref), o: ref :: { HeapSucc(h, h'), fun0.LAMP_2.in_observers(h, current, new_observers, o), fun0.LAMP_2.in_observers(h', current, new_observers, o) } ((HeapSucc(h, h')) && (pre.fun.LAMP_2.in_observers(h, current, new_observers, o)) && (pre.fun.LAMP_2.in_observers(h', current, new_observers, o)) && (same_inside(h, h', read.fun.LAMP_2.in_observers(h, current, new_observers, o)))) ==> ((fun0.LAMP_2.in_observers(h, current, new_observers, o)) == (fun0.LAMP_2.in_observers(h', current, new_observers, o)))));
...
function modify.LAMP_2.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T8> $o: ref, $f: Field T8 :: { modify.LAMP_2.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.LAMP_2.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.LAMP_2.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T9> $o: ref, $f: Field T9 :: { read.fun.LAMP_2.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.LAMP_2.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.LAMP_2.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool) {
  true
}

function trigger.fun.LAMP_2.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);
