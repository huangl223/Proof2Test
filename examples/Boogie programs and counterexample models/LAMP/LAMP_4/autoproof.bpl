// Automatically generated (04/02/2023 6:42:09.539 PM)
...
const unique LAMP_4: Type;

axiom ((LAMP_4) <: (ANY));

axiom ((forall t: Type :: { (LAMP_4) <: (t) } ((LAMP_4) <: (t)) <==> (((t) == (LAMP_4)) || ((ANY) <: (t)))));

axiom ((FieldId(allocated, LAMP_4)) == (-1));

axiom ((FieldId(closed, LAMP_4)) == (-2));

axiom ((FieldId(owner, LAMP_4)) == (-3));

axiom ((FieldId(owns, LAMP_4)) == (-4));

axiom ((FieldId(observers, LAMP_4)) == (-5));

axiom ((FieldId(subjects, LAMP_4)) == (-6));

axiom ((forall <T0> $f: Field T0 :: { IsModelField($f, LAMP_4) } (IsModelField($f, LAMP_4)) <==> ((($f) == (subjects)) || (($f) == (observers)))));

function { :inline } LAMP_4.user_inv(heap: HeapType, current: ref) returns (bool) {
  (((heap[current, LAMP_4.light_intensity]) == (0)) || ((heap[current, LAMP_4.light_intensity]) == (25)) || ((heap[current, LAMP_4.light_intensity]) == (75)) || ((heap[current, LAMP_4.light_intensity]) == (100))) && (((heap[current, LAMP_4.previous_light_intensity]) == (0)) || ((heap[current, LAMP_4.previous_light_intensity]) == (25)) || ((heap[current, LAMP_4.previous_light_intensity]) == (75)) || ((heap[current, LAMP_4.previous_light_intensity]) == (100))) && ((heap[current, LAMP_4.is_on]) == ((heap[current, LAMP_4.light_intensity]) != (0))) && (Set#IsEmpty(heap[current, observers])) && (Set#IsEmpty(heap[current, subjects])) && (Set#IsEmpty(heap[current, owns])) && (admissibility2(heap, current))
}

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached_exact(heap, current, LAMP_4)) ==> ((user_inv(heap, current)) <==> (LAMP_4.user_inv(heap, current)))));

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached(heap, current, LAMP_4)) ==> ((user_inv(heap, current)) ==> (LAMP_4.user_inv(heap, current)))));

procedure LAMP_4.invariant_admissibility_check(Current: ref);
  requires attached_exact(Heap, Current, LAMP_4);



implementation LAMP_4.invariant_admissibility_check(Current: ref)
{
  entry:
  goto pre, a2, a3;
  pre:
  assert user_inv_readable(Heap, Current)[Current, LAMP_4.light_intensity]; // type:access tag:attribute_readable line:74 cid:35 fid:78
  assert user_inv_readable(Heap, Current)[Current, LAMP_4.light_intensity]; // type:access tag:attribute_readable line:74 cid:35 fid:78
  assert user_inv_readable(Heap, Current)[Current, LAMP_4.light_intensity]; // type:access tag:attribute_readable line:74 cid:35 fid:78
  assert user_inv_readable(Heap, Current)[Current, LAMP_4.light_intensity]; // type:access tag:attribute_readable line:74 cid:35 fid:78
  assume ((Heap[Current, LAMP_4.light_intensity]) == (0)) || ((Heap[Current, LAMP_4.light_intensity]) == (25)) || ((Heap[Current, LAMP_4.light_intensity]) == (75)) || ((Heap[Current, LAMP_4.light_intensity]) == (100));
  assert user_inv_readable(Heap, Current)[Current, LAMP_4.previous_light_intensity]; // type:access tag:attribute_readable line:76 cid:35 fid:80
  assert user_inv_readable(Heap, Current)[Current, LAMP_4.previous_light_intensity]; // type:access tag:attribute_readable line:76 cid:35 fid:80
  assert user_inv_readable(Heap, Current)[Current, LAMP_4.previous_light_intensity]; // type:access tag:attribute_readable line:76 cid:35 fid:80
  assert user_inv_readable(Heap, Current)[Current, LAMP_4.previous_light_intensity]; // type:access tag:attribute_readable line:76 cid:35 fid:80
  assume ((Heap[Current, LAMP_4.previous_light_intensity]) == (0)) || ((Heap[Current, LAMP_4.previous_light_intensity]) == (25)) || ((Heap[Current, LAMP_4.previous_light_intensity]) == (75)) || ((Heap[Current, LAMP_4.previous_light_intensity]) == (100));
  assert user_inv_readable(Heap, Current)[Current, LAMP_4.is_on]; // type:access tag:attribute_readable line:78 cid:35 fid:79
  assert user_inv_readable(Heap, Current)[Current, LAMP_4.light_intensity]; // type:access tag:attribute_readable line:78 cid:35 fid:78
  assume (Heap[Current, LAMP_4.is_on]) == ((Heap[Current, LAMP_4.light_intensity]) != (0));
  return;
  a2:
...
procedure create.LAMP_4.default_create(Current: ref);
  free requires attached_exact(Heap, Current, LAMP_4); // info:type property for argument Current
  modifies Heap;
  ...
  requires Frame#Subset(modify.LAMP_4.default_create(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.LAMP_4.default_create(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts



implementation create.LAMP_4.default_create(Current: ref)
{
  entry:
  assume {:captureState "create.LAMP_4.default_create"} true;
  if (*) {
    assert ((Heap[Current, LAMP_4.light_intensity]) == (0)) || ((Heap[Current, LAMP_4.light_intensity]) == (25)) || ((Heap[Current, LAMP_4.light_intensity]) == (75)) || ((Heap[Current, LAMP_4.light_intensity]) == (100)); // type:inv tag:value_of_light_intensity line:71 cid:4 rid:53
    assume false;
  }
  if (*) {
    assert ((Heap[Current, LAMP_4.previous_light_intensity]) == (0)) || ((Heap[Current, LAMP_4.previous_light_intensity]) == (25)) || ((Heap[Current, LAMP_4.previous_light_intensity]) == (75)) || ((Heap[Current, LAMP_4.previous_light_intensity]) == (100)); // type:inv tag:value_of_previous_intensity line:71 cid:4 rid:53
    assume false;
  }
  if (*) {
    assert (Heap[Current, LAMP_4.is_on]) == ((Heap[Current, LAMP_4.light_intensity]) != (0)); // type:inv tag:light_intensity_when_off line:71 cid:4 rid:53
    assume false;
  }
  if (*) {
...
procedure LAMP_4.turn_on_off(Current: ref);
  free requires attached_exact(Heap, Current, LAMP_4); // info:type property for argument Current
  modifies Heap;
  ensures ((!(old(Heap)[Current, LAMP_4.is_on])) && ((old(Heap)[Current, LAMP_4.previous_light_intensity]) > (0))) ==> ((Heap[Current, LAMP_4.is_on]) && ((Heap[Current, LAMP_4.light_intensity]) == (old(Heap)[Current, LAMP_4.previous_light_intensity]))); // type:post tag:turn_on_1 line:50
  ensures ((!(old(Heap)[Current, LAMP_4.is_on])) && ((old(Heap)[Current, LAMP_4.previous_light_intensity]) == (0))) ==> ((Heap[Current, LAMP_4.is_on]) && ((Heap[Current, LAMP_4.light_intensity]) == (25))); // type:post tag:turn_on_2 line:51
  ensures (old(Heap)[Current, LAMP_4.is_on]) ==> ((!(Heap[Current, LAMP_4.is_on])) && ((Heap[Current, LAMP_4.previous_light_intensity]) == (old(Heap)[Current, LAMP_4.light_intensity])) && ((Heap[Current, LAMP_4.light_intensity]) == (0))); // type:post tag:turn_off line:52
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.LAMP_4.turn_on_off(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.LAMP_4.turn_on_off(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
...
function { :inline } variant.LAMP_4.turn_on_off.1(heap: HeapType, current: ref) returns (int) {
  0
}

implementation LAMP_4.turn_on_off(Current: ref)
{
  entry:
  assume {:captureState "LAMP_4.turn_on_off"} true;
  call unwrap(Current); // default:wrapping cid:4 rid:55 line:34
  assume LAMP_4.user_inv(Heap, Current);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\lamp\lamp_4.e:37
  // if not is_on then
  if (!(Heap[Current, LAMP_4.is_on])) {
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\lamp\lamp_4.e:38
    // is_on := True
    call update_heap(Current, LAMP_4.is_on, true); // line:38
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\lamp\lamp_4.e:39
    // if previous_light_intensity > 0 then
    if ((Heap[Current, LAMP_4.previous_light_intensity]) > (0)) {
      // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\lamp\lamp_4.e:40
      // light_intensity := previous_light_intensity
      call update_heap(Current, LAMP_4.light_intensity, Heap[Current, LAMP_4.previous_light_intensity]); // line:40
    } else {
      // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\lamp\lamp_4.e:42
      // light_intensity := Low_intensity
      call update_heap(Current, LAMP_4.light_intensity, 25); // line:42
    }
  } else {
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\lamp\lamp_4.e:45
    // is_on := False
    call update_heap(Current, LAMP_4.is_on, false); // line:45
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\lamp\lamp_4.e:46
    // previous_light_intensity := light_intensity
    call update_heap(Current, LAMP_4.previous_light_intensity, Heap[Current, LAMP_4.light_intensity]); // line:46
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\lamp\lamp_4.e:47
    // light_intensity := Zero_intensity
    call update_heap(Current, LAMP_4.light_intensity, 0); // line:47
  }
  if (*) {
    assert ((Heap[Current, LAMP_4.light_intensity]) == (0)) || ((Heap[Current, LAMP_4.light_intensity]) == (25)) || ((Heap[Current, LAMP_4.light_intensity]) == (75)) || ((Heap[Current, LAMP_4.light_intensity]) == (100)); // type:inv tag:value_of_light_intensity line:71 cid:4 rid:53
    assume false;
...
procedure LAMP_4.adjust_light(Current: ref);
  free requires attached_exact(Heap, Current, LAMP_4); // info:type property for argument Current
  modifies Heap;
  requires (Heap[Current, LAMP_4.is_on]) == (true); // type:pre tag:lamp_is_on line:58
  ensures ((old(Heap)[Current, LAMP_4.light_intensity]) == (25)) ==> ((Heap[Current, LAMP_4.light_intensity]) == (75)); // type:post tag:from_low_to_medium line:68
  ensures ((old(Heap)[Current, LAMP_4.light_intensity]) == (75)) ==> ((Heap[Current, LAMP_4.light_intensity]) == (100)); // type:post tag:from_medium_to_high line:69
  ensures ((old(Heap)[Current, LAMP_4.light_intensity]) == (100)) ==> ((Heap[Current, LAMP_4.light_intensity]) == (25)); // type:post tag:from_high_to_low line:70
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.LAMP_4.adjust_light(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.LAMP_4.adjust_light(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  requires is_wrapped(Heap, Current); // type:pre tag:default_is_wrapped default:contracts
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts
...
function { :inline } variant.LAMP_4.adjust_light.1(heap: HeapType, current: ref) returns (int) {
  0
}

implementation LAMP_4.adjust_light(Current: ref)
{
  entry:
  assume {:captureState "LAMP_4.adjust_light"} true;
  call unwrap(Current); // default:wrapping cid:4 rid:55 line:55
  assume LAMP_4.user_inv(Heap, Current);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\lamp\lamp_4.e:60
  // if light_intensity = Low_intensity then
  if ((Heap[Current, LAMP_4.light_intensity]) == (25)) {
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\lamp\lamp_4.e:61
    // light_intensity := Medium_intensity
    call update_heap(Current, LAMP_4.light_intensity, 75); // line:61
  } else {
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\lamp\lamp_4.e:62
    // elseif light_intensity = Medium_intensity then
    if ((Heap[Current, LAMP_4.light_intensity]) == (75)) {
      // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\lamp\lamp_4.e:63
      // light_intensity := Medium_intensity
      call update_heap(Current, LAMP_4.light_intensity, 75); // line:63
    } else {
      // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\lamp\lamp_4.e:64
      // elseif light_intensity = High_intensity then
      if ((Heap[Current, LAMP_4.light_intensity]) == (100)) {
        // C:\Users\HP\Documents\GitHub\Proof2Test\examples\applications\lamp\lamp_4.e:65
        // light_intensity := Low_intensity
        call update_heap(Current, LAMP_4.light_intensity, 25); // line:65
      }
    }
  }
  if (*) {
...
const LAMP_4.light_intensity: Field int;

axiom ((FieldId(LAMP_4.light_intensity, LAMP_4)) == (78));

axiom ((forall heap: HeapType, o: ref :: { heap[o, LAMP_4.light_intensity] } ((IsHeap(heap)) && (attached(heap, o, LAMP_4))) ==> (is_integer_32(heap[o, LAMP_4.light_intensity]))));

axiom ((forall heap: HeapType, current: ref, v: int, o: ref :: { guard(heap, current, LAMP_4.light_intensity, v, o) } (attached_exact(heap, current, LAMP_4)) ==> ((guard(heap, current, LAMP_4.light_intensity, v, o)) <==> ((user_inv(heap, o)) ==> (user_inv(heap[current, LAMP_4.light_intensity := v], o))))));

axiom ((forall heap: HeapType, current: ref, v: int, o: ref :: { guard(heap, current, LAMP_4.light_intensity, v, o) } (attached(heap, current, LAMP_4)) ==> ((guard(heap, current, LAMP_4.light_intensity, v, o)) ==> ((user_inv(heap, o)) ==> (user_inv(heap[current, LAMP_4.light_intensity := v], o))))));

const LAMP_4.previous_light_intensity: Field int;

axiom ((FieldId(LAMP_4.previous_light_intensity, LAMP_4)) == (80));

axiom ((forall heap: HeapType, o: ref :: { heap[o, LAMP_4.previous_light_intensity] } ((IsHeap(heap)) && (attached(heap, o, LAMP_4))) ==> (is_integer_32(heap[o, LAMP_4.previous_light_intensity]))));

axiom ((forall heap: HeapType, current: ref, v: int, o: ref :: { guard(heap, current, LAMP_4.previous_light_intensity, v, o) } (attached_exact(heap, current, LAMP_4)) ==> ((guard(heap, current, LAMP_4.previous_light_intensity, v, o)) <==> ((user_inv(heap, o)) ==> (user_inv(heap[current, LAMP_4.previous_light_intensity := v], o))))));

axiom ((forall heap: HeapType, current: ref, v: int, o: ref :: { guard(heap, current, LAMP_4.previous_light_intensity, v, o) } (attached(heap, current, LAMP_4)) ==> ((guard(heap, current, LAMP_4.previous_light_intensity, v, o)) ==> ((user_inv(heap, o)) ==> (user_inv(heap[current, LAMP_4.previous_light_intensity := v], o))))));

const LAMP_4.is_on: Field bool;

axiom ((FieldId(LAMP_4.is_on, LAMP_4)) == (79));

axiom ((forall heap: HeapType, current: ref, v: bool, o: ref :: { guard(heap, current, LAMP_4.is_on, v, o) } (attached_exact(heap, current, LAMP_4)) ==> ((guard(heap, current, LAMP_4.is_on, v, o)) <==> ((user_inv(heap, o)) ==> (user_inv(heap[current, LAMP_4.is_on := v], o))))));

axiom ((forall heap: HeapType, current: ref, v: bool, o: ref :: { guard(heap, current, LAMP_4.is_on, v, o) } (attached(heap, current, LAMP_4)) ==> ((guard(heap, current, LAMP_4.is_on, v, o)) ==> ((user_inv(heap, o)) ==> (user_inv(heap[current, LAMP_4.is_on := v], o))))));
...
axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, owns, v, o) } (attached_exact(heap, current, LAMP_4)) ==> ((guard(heap, current, owns, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, subjects, v, o) } (attached_exact(heap, current, LAMP_4)) ==> ((guard(heap, current, subjects, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached_exact(heap, current, LAMP_4)) ==> ((guard(heap, current, observers, v, o)) <==> (fun.LAMP_4.in_observers(heap, current, v, o)))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached(heap, current, LAMP_4)) ==> ((guard(heap, current, observers, v, o)) ==> (fun.LAMP_4.in_observers(heap, current, v, o)))));

function modify.LAMP_4.default_create(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T3> $o: ref, $f: Field T3 :: { modify.LAMP_4.default_create(heap, current)[$o, $f] } (modify.LAMP_4.default_create(heap, current)[$o, $f]) <==> (($o) == (current))))));

function modify.LAMP_4.turn_on_off(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T4> $o: ref, $f: Field T4 :: { modify.LAMP_4.turn_on_off(heap, current)[$o, $f] } (modify.LAMP_4.turn_on_off(heap, current)[$o, $f]) <==> (($o) == (current))))));

function modify.LAMP_4.adjust_light(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T5> $o: ref, $f: Field T5 :: { modify.LAMP_4.adjust_light(heap, current)[$o, $f] } (modify.LAMP_4.adjust_light(heap, current)[$o, $f]) <==> (($o) == (current))))));
...
procedure LAMP_4.in_observers(Current: ref, new_observers: Set (ref), o: ref) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, LAMP_4); // info:type property for argument Current
  free requires Set#ItemsType(Heap, new_observers, ANY); // info:type property for argument new_observers
  free requires ((o) != (Void)) && (Heap[o, allocated]); // info:type property for argument o
  modifies Heap;
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.LAMP_4.in_observers(Heap, Current, new_observers, o), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.LAMP_4.in_observers(old(Heap), Current, new_observers, o));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.LAMP_4.in_observers(Heap, Current, new_observers, o), readable);



function fun.LAMP_4.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

function fun0.LAMP_4.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.LAMP_4.in_observers(heap, current, new_observers, o) } { trigger.fun.LAMP_4.in_observers(heap, current, new_observers, o) } (pre.fun.LAMP_4.in_observers(heap, current, new_observers, o)) ==> ((fun.LAMP_4.in_observers(heap, current, new_observers, o)) == ((attached(heap, o, ANY)) && (new_observers[o])))));

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.LAMP_4.in_observers(heap, current, new_observers, o) } (fun.LAMP_4.in_observers(heap, current, new_observers, o)) == (fun0.LAMP_4.in_observers(heap, current, new_observers, o))));

axiom ((forall h: HeapType, h': HeapType, current: ref, new_observers: Set (ref), o: ref :: { HeapSucc(h, h'), fun0.LAMP_4.in_observers(h, current, new_observers, o), fun0.LAMP_4.in_observers(h', current, new_observers, o) } ((HeapSucc(h, h')) && (pre.fun.LAMP_4.in_observers(h, current, new_observers, o)) && (pre.fun.LAMP_4.in_observers(h', current, new_observers, o)) && (same_inside(h, h', read.fun.LAMP_4.in_observers(h, current, new_observers, o)))) ==> ((fun0.LAMP_4.in_observers(h, current, new_observers, o)) == (fun0.LAMP_4.in_observers(h', current, new_observers, o)))));
...
function modify.LAMP_4.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T8> $o: ref, $f: Field T8 :: { modify.LAMP_4.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.LAMP_4.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.LAMP_4.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T9> $o: ref, $f: Field T9 :: { read.fun.LAMP_4.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.LAMP_4.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.LAMP_4.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool) {
  true
}

function trigger.fun.LAMP_4.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);
