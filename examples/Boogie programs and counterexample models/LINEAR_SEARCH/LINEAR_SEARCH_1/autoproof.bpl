// Automatically generated (04/03/2023 8:45:47.418 AM)
...
const unique LINEAR_SEARCH_1: Type;

axiom ((LINEAR_SEARCH_1) <: (ANY));

axiom ((forall t: Type :: { (LINEAR_SEARCH_1) <: (t) } ((LINEAR_SEARCH_1) <: (t)) <==> (((t) == (LINEAR_SEARCH_1)) || ((ANY) <: (t)))));

axiom ((FieldId(allocated, LINEAR_SEARCH_1)) == (-1));

axiom ((FieldId(closed, LINEAR_SEARCH_1)) == (-2));

axiom ((FieldId(owner, LINEAR_SEARCH_1)) == (-3));

axiom ((FieldId(owns, LINEAR_SEARCH_1)) == (-4));

axiom ((FieldId(observers, LINEAR_SEARCH_1)) == (-5));

axiom ((FieldId(subjects, LINEAR_SEARCH_1)) == (-6));

axiom ((forall <T0> $f: Field T0 :: { IsModelField($f, LINEAR_SEARCH_1) } (IsModelField($f, LINEAR_SEARCH_1)) <==> ((($f) == (subjects)) || (($f) == (observers)))));

function { :inline } LINEAR_SEARCH_1.user_inv(heap: HeapType, current: ref) returns (bool) {
...
axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached_exact(heap, current, LINEAR_SEARCH_1)) ==> ((user_inv(heap, current)) <==> (LINEAR_SEARCH_1.user_inv(heap, current)))));

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached(heap, current, LINEAR_SEARCH_1)) ==> ((user_inv(heap, current)) ==> (LINEAR_SEARCH_1.user_inv(heap, current)))));

procedure LINEAR_SEARCH_1.invariant_admissibility_check(Current: ref);
  requires attached_exact(Heap, Current, LINEAR_SEARCH_1);



implementation LINEAR_SEARCH_1.invariant_admissibility_check(Current: ref)
{
  entry:
  goto pre, a2, a3;
  pre:
...
procedure create.LINEAR_SEARCH_1.default_create(Current: ref);
  free requires attached_exact(Heap, Current, LINEAR_SEARCH_1); // info:type property for argument Current
  modifies Heap;
  ...
  requires Frame#Subset(modify.LINEAR_SEARCH_1.default_create(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.LINEAR_SEARCH_1.default_create(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts



implementation create.LINEAR_SEARCH_1.default_create(Current: ref)
{
  entry:
  assume {:captureState "create.LINEAR_SEARCH_1.default_create"} true;
  if (*) {
...
procedure LINEAR_SEARCH_1.linear_search(Current: ref, a: ref, value: int) returns (Result: int where is_integer_32(Result));
  free requires attached_exact(Heap, Current, LINEAR_SEARCH_1); // info:type property for argument Current
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.LINEAR_SEARCH_1.linear_search(Heap, Current, a, value), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.LINEAR_SEARCH_1.linear_search(old(Heap), Current, a, value));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.LINEAR_SEARCH_1.linear_search(Heap, Current, a, value), readable);
  ...
  free ensures (Result) == (fun.LINEAR_SEARCH_1.linear_search(old(Heap), Current, a, value));



function fun.LINEAR_SEARCH_1.linear_search(heap: HeapType, current: ref, a: ref, value: int) returns (int);

axiom ((forall heap: HeapType, current: ref, a: ref, value: int :: { fun.LINEAR_SEARCH_1.linear_search(heap, current, a, value) } (pre.fun.LINEAR_SEARCH_1.linear_search(heap, current, a, value)) ==> (((1) <= (fun.LINEAR_SEARCH_1.linear_search(heap, current, a, value))) && ((fun.LINEAR_SEARCH_1.linear_search(heap, current, a, value)) <= ((fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a)) + (1))) && ((Seq#Has(heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], value)) == ((fun.LINEAR_SEARCH_1.linear_search(heap, current, a, value)) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a)))) && (((fun.LINEAR_SEARCH_1.linear_search(heap, current, a, value)) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a))) ==> ((Seq#Item(heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], fun.LINEAR_SEARCH_1.linear_search(heap, current, a, value))) == (value))) && ((forall i_2: int :: (((1) <= (i_2)) && ((i_2) <= ((fun.LINEAR_SEARCH_1.linear_search(heap, current, a, value)) - (1)))) ==> ((Seq#Item(heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_2)) != (value)))) && (is_integer_32(fun.LINEAR_SEARCH_1.linear_search(heap, current, a, value))))));

axiom ((forall h: HeapType, h': HeapType, current: ref, a: ref, value: int :: { HeapSucc(h, h'), fun.LINEAR_SEARCH_1.linear_search(h, current, a, value), fun.LINEAR_SEARCH_1.linear_search(h', current, a, value) } ((HeapSucc(h, h')) && (pre.fun.LINEAR_SEARCH_1.linear_search(h, current, a, value)) && (pre.fun.LINEAR_SEARCH_1.linear_search(h', current, a, value)) && (same_inside(h, h', read.fun.LINEAR_SEARCH_1.linear_search(h, current, a, value)))) ==> ((fun.LINEAR_SEARCH_1.linear_search(h, current, a, value)) == (fun.LINEAR_SEARCH_1.linear_search(h', current, a, value)))));

function { :inline } variant.LINEAR_SEARCH_1.linear_search.1(heap: HeapType, current: ref, a: ref, value: int) returns (ref) {
  a
}

function { :inline } variant.LINEAR_SEARCH_1.linear_search.2(heap: HeapType, current: ref, a: ref, value: int) returns (int) {
  value
}

implementation LINEAR_SEARCH_1.linear_search(Current: ref, a: ref, value: int) returns (Result: int)
{
  ...
  entry:
  assume {:captureState "LINEAR_SEARCH_1.linear_search"} true;
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\linear_search\linear_search_1.e:15
  // Result := 0
  Result := 0;
  PreLoopHeap_6 := Heap;
  goto loop_head_3;
  loop_head_3:
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\linear_search\linear_search_1.e:17
  ...
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\linear_search\linear_search_1.e:18
  ...
  assume same_outside(old(Heap), Heap, modify.LINEAR_SEARCH_1.linear_search(old(Heap), Current, a, value));
  assume global(Heap);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\linear_search\linear_search_1.e:-1
  ...
  assert {:subsumption 0} (!((Result) == ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1)))) ==> ((a) != (Void)); // type:attached line:-1
  assert (!((Result) == ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1)))) ==> (Frame#Subset(read.fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, Result), readable)); // type:access tag:frame_readable line:-1 cid:77 rid:3826
  assert (!((Result) == ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1)))) ==> (pre.fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, Result)); // type:check tag:function_precondition line:-1 cid:77 rid:3826
  goto loop_body_4, loop_end_5;
  loop_body_4:
  assume !(((Result) == ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1))) || ((fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, Result)) == (value)));
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\linear_search\linear_search_1.e:24
  // a.count - Result + 1
  variant_8 := ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (Result)) + (1);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\linear_search\linear_search_1.e:22
  // Result := Result + 1
  Result := (Result) + (1);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\linear_search\linear_search_1.e:24
  // a.count - Result + 1
...
axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, owns, v, o) } (attached_exact(heap, current, LINEAR_SEARCH_1)) ==> ((guard(heap, current, owns, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, subjects, v, o) } (attached_exact(heap, current, LINEAR_SEARCH_1)) ==> ((guard(heap, current, subjects, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached_exact(heap, current, LINEAR_SEARCH_1)) ==> ((guard(heap, current, observers, v, o)) <==> (fun.LINEAR_SEARCH_1.in_observers(heap, current, v, o)))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached(heap, current, LINEAR_SEARCH_1)) ==> ((guard(heap, current, observers, v, o)) ==> (fun.LINEAR_SEARCH_1.in_observers(heap, current, v, o)))));

function modify.LINEAR_SEARCH_1.default_create(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T5> $o: ref, $f: Field T5 :: { modify.LINEAR_SEARCH_1.default_create(heap, current)[$o, $f] } (modify.LINEAR_SEARCH_1.default_create(heap, current)[$o, $f]) <==> (($o) == (current))))));
...
function modify.LINEAR_SEARCH_1.linear_search(heap: HeapType, current: ref, a: ref, value: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: ref, value: int :: (IsHeap(heap)) ==> ((forall <T7> $o: ref, $f: Field T7 :: { modify.LINEAR_SEARCH_1.linear_search(heap, current, a, value)[$o, $f] } (modify.LINEAR_SEARCH_1.linear_search(heap, current, a, value)[$o, $f]) <==> (false)))));

function read.fun.LINEAR_SEARCH_1.linear_search(heap: HeapType, current: ref, a: ref, value: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: ref, value: int :: (IsHeap(heap)) ==> ((forall <T8> $o: ref, $f: Field T8 :: { read.fun.LINEAR_SEARCH_1.linear_search(heap, current, a, value)[$o, $f] } (read.fun.LINEAR_SEARCH_1.linear_search(heap, current, a, value)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.LINEAR_SEARCH_1.linear_search(heap: HeapType, current: ref, a: ref, value: int) returns (bool) {
...
function trigger.fun.LINEAR_SEARCH_1.linear_search(heap: HeapType, current: ref, a: ref, value: int) returns (bool);
...
procedure LINEAR_SEARCH_1.in_observers(Current: ref, new_observers: Set (ref), o: ref) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, LINEAR_SEARCH_1); // info:type property for argument Current
  free requires Set#ItemsType(Heap, new_observers, ANY); // info:type property for argument new_observers
  free requires ((o) != (Void)) && (Heap[o, allocated]); // info:type property for argument o
  modifies Heap;
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.LINEAR_SEARCH_1.in_observers(Heap, Current, new_observers, o), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.LINEAR_SEARCH_1.in_observers(old(Heap), Current, new_observers, o));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.LINEAR_SEARCH_1.in_observers(Heap, Current, new_observers, o), readable);



function fun.LINEAR_SEARCH_1.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

function fun0.LINEAR_SEARCH_1.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.LINEAR_SEARCH_1.in_observers(heap, current, new_observers, o) } { trigger.fun.LINEAR_SEARCH_1.in_observers(heap, current, new_observers, o) } (pre.fun.LINEAR_SEARCH_1.in_observers(heap, current, new_observers, o)) ==> ((fun.LINEAR_SEARCH_1.in_observers(heap, current, new_observers, o)) == ((attached(heap, o, ANY)) && (new_observers[o])))));

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.LINEAR_SEARCH_1.in_observers(heap, current, new_observers, o) } (fun.LINEAR_SEARCH_1.in_observers(heap, current, new_observers, o)) == (fun0.LINEAR_SEARCH_1.in_observers(heap, current, new_observers, o))));

axiom ((forall h: HeapType, h': HeapType, current: ref, new_observers: Set (ref), o: ref :: { HeapSucc(h, h'), fun0.LINEAR_SEARCH_1.in_observers(h, current, new_observers, o), fun0.LINEAR_SEARCH_1.in_observers(h', current, new_observers, o) } ((HeapSucc(h, h')) && (pre.fun.LINEAR_SEARCH_1.in_observers(h, current, new_observers, o)) && (pre.fun.LINEAR_SEARCH_1.in_observers(h', current, new_observers, o)) && (same_inside(h, h', read.fun.LINEAR_SEARCH_1.in_observers(h, current, new_observers, o)))) ==> ((fun0.LINEAR_SEARCH_1.in_observers(h, current, new_observers, o)) == (fun0.LINEAR_SEARCH_1.in_observers(h', current, new_observers, o)))));
...
function modify.LINEAR_SEARCH_1.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T15> $o: ref, $f: Field T15 :: { modify.LINEAR_SEARCH_1.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.LINEAR_SEARCH_1.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.LINEAR_SEARCH_1.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T16> $o: ref, $f: Field T16 :: { read.fun.LINEAR_SEARCH_1.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.LINEAR_SEARCH_1.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.LINEAR_SEARCH_1.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool) {
  true
}

function trigger.fun.LINEAR_SEARCH_1.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);
...
axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T17> $o: ref, $f: Field T17 :: { modify.SIMPLE_ARRAY^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.SIMPLE_ARRAY^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));
...
axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T18> $o: ref, $f: Field T18 :: { read.fun.SIMPLE_ARRAY^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.SIMPLE_ARRAY^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));
