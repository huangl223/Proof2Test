// Automatically generated (04/03/2023 9:13:16.474 AM)
...
const unique LINEAR_SEARCH_2: Type;

axiom ((LINEAR_SEARCH_2) <: (ANY));

axiom ((forall t: Type :: { (LINEAR_SEARCH_2) <: (t) } ((LINEAR_SEARCH_2) <: (t)) <==> (((t) == (LINEAR_SEARCH_2)) || ((ANY) <: (t)))));

axiom ((FieldId(allocated, LINEAR_SEARCH_2)) == (-1));

axiom ((FieldId(closed, LINEAR_SEARCH_2)) == (-2));

axiom ((FieldId(owner, LINEAR_SEARCH_2)) == (-3));

axiom ((FieldId(owns, LINEAR_SEARCH_2)) == (-4));

axiom ((FieldId(observers, LINEAR_SEARCH_2)) == (-5));

axiom ((FieldId(subjects, LINEAR_SEARCH_2)) == (-6));

axiom ((forall <T0> $f: Field T0 :: { IsModelField($f, LINEAR_SEARCH_2) } (IsModelField($f, LINEAR_SEARCH_2)) <==> ((($f) == (subjects)) || (($f) == (observers)))));

function { :inline } LINEAR_SEARCH_2.user_inv(heap: HeapType, current: ref) returns (bool) {
...
axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached_exact(heap, current, LINEAR_SEARCH_2)) ==> ((user_inv(heap, current)) <==> (LINEAR_SEARCH_2.user_inv(heap, current)))));

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached(heap, current, LINEAR_SEARCH_2)) ==> ((user_inv(heap, current)) ==> (LINEAR_SEARCH_2.user_inv(heap, current)))));

procedure LINEAR_SEARCH_2.invariant_admissibility_check(Current: ref);
  requires attached_exact(Heap, Current, LINEAR_SEARCH_2);



implementation LINEAR_SEARCH_2.invariant_admissibility_check(Current: ref)
{
  entry:
  goto pre, a2, a3;
  pre:
...
procedure create.LINEAR_SEARCH_2.default_create(Current: ref);
  free requires attached_exact(Heap, Current, LINEAR_SEARCH_2); // info:type property for argument Current
  modifies Heap;
  ...
  requires Frame#Subset(modify.LINEAR_SEARCH_2.default_create(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.LINEAR_SEARCH_2.default_create(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts



implementation create.LINEAR_SEARCH_2.default_create(Current: ref)
{
  entry:
  assume {:captureState "create.LINEAR_SEARCH_2.default_create"} true;
  if (*) {
...
procedure LINEAR_SEARCH_2.linear_search(Current: ref, a: ref, value: int) returns (Result: int where is_integer_32(Result));
  free requires attached_exact(Heap, Current, LINEAR_SEARCH_2); // info:type property for argument Current
  ...
  modifies Heap;
  requires (a) != (Void); // type:attached tag:array_size line:12
  requires pre.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a); // type:check tag:function_precondition line:12 cid:77 rid:3825
  requires ((2) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a))) && ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) <= (10)); // type:pre tag:array_size line:12
  ensures (a) != (Void); // type:attached tag:result_in_bound line:27
  ensures pre.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a); // type:check tag:function_precondition line:27 cid:77 rid:3825
  ensures ((1) <= (Result)) && ((Result) <= ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1))); // type:post tag:result_in_bound line:27
  ensures (Seq#Has(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], value)) == ((Result) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a))); // type:post tag:present line:28
  ensures ((Result) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a))) ==> ((a) != (Void)); // type:attached tag:found_if_present line:29
  ensures ((Result) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], Result)); // type:check tag:function_precondition line:29 cid:76 rid:3838
  ensures ((Result) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a))) ==> ((Seq#Item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], Result)) == (value)); // type:post tag:found_if_present line:29
  ensures (forall i_1: int :: (((1) <= (i_1)) && ((i_1) <= ((Result) - (1)))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_1))); // type:check tag:function_precondition line:30 cid:76 rid:3838
  ensures (forall i_1: int :: (((1) <= (i_1)) && ((i_1) <= ((Result) - (1)))) ==> ((Seq#Item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_1)) != (value))); // type:post tag:first_from_front line:30
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.LINEAR_SEARCH_2.linear_search(Heap, Current, a, value), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.LINEAR_SEARCH_2.linear_search(old(Heap), Current, a, value));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.LINEAR_SEARCH_2.linear_search(Heap, Current, a, value), readable);
  ...
  free ensures (Result) == (fun.LINEAR_SEARCH_2.linear_search(old(Heap), Current, a, value));



function fun.LINEAR_SEARCH_2.linear_search(heap: HeapType, current: ref, a: ref, value: int) returns (int);

axiom ((forall heap: HeapType, current: ref, a: ref, value: int :: { fun.LINEAR_SEARCH_2.linear_search(heap, current, a, value) } (pre.fun.LINEAR_SEARCH_2.linear_search(heap, current, a, value)) ==> (((1) <= (fun.LINEAR_SEARCH_2.linear_search(heap, current, a, value))) && ((fun.LINEAR_SEARCH_2.linear_search(heap, current, a, value)) <= ((fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a)) + (1))) && ((Seq#Has(heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], value)) == ((fun.LINEAR_SEARCH_2.linear_search(heap, current, a, value)) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a)))) && (((fun.LINEAR_SEARCH_2.linear_search(heap, current, a, value)) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a))) ==> ((Seq#Item(heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], fun.LINEAR_SEARCH_2.linear_search(heap, current, a, value))) == (value))) && ((forall i_2: int :: (((1) <= (i_2)) && ((i_2) <= ((fun.LINEAR_SEARCH_2.linear_search(heap, current, a, value)) - (1)))) ==> ((Seq#Item(heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_2)) != (value)))) && (is_integer_32(fun.LINEAR_SEARCH_2.linear_search(heap, current, a, value))))));

axiom ((forall h: HeapType, h': HeapType, current: ref, a: ref, value: int :: { HeapSucc(h, h'), fun.LINEAR_SEARCH_2.linear_search(h, current, a, value), fun.LINEAR_SEARCH_2.linear_search(h', current, a, value) } ((HeapSucc(h, h')) && (pre.fun.LINEAR_SEARCH_2.linear_search(h, current, a, value)) && (pre.fun.LINEAR_SEARCH_2.linear_search(h', current, a, value)) && (same_inside(h, h', read.fun.LINEAR_SEARCH_2.linear_search(h, current, a, value)))) ==> ((fun.LINEAR_SEARCH_2.linear_search(h, current, a, value)) == (fun.LINEAR_SEARCH_2.linear_search(h', current, a, value)))));

function { :inline } variant.LINEAR_SEARCH_2.linear_search.1(heap: HeapType, current: ref, a: ref, value: int) returns (ref) {
  a
}

function { :inline } variant.LINEAR_SEARCH_2.linear_search.2(heap: HeapType, current: ref, a: ref, value: int) returns (int) {
  value
}

implementation LINEAR_SEARCH_2.linear_search(Current: ref, a: ref, value: int) returns (Result: int)
{
  ...
  entry:
  assume {:captureState "LINEAR_SEARCH_2.linear_search"} true;
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\linear_search\linear_search_2.e:15
  // Result := 1
  Result := 1;
  PreLoopHeap_6 := Heap;
  goto loop_head_3;
  loop_head_3:
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\linear_search\linear_search_2.e:17
  // result_in_bound: 1 <= Result and Result <= a.count + 1
  assert {:subsumption 0} (a) != (Void); // type:attached line:17
  assert Frame#Subset(read.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a), readable); // type:access tag:frame_readable line:17 cid:77 rid:3825
  assert pre.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a); // type:check tag:function_precondition line:17 cid:77 rid:3825
  assert ((1) <= (Result)) && ((Result) <= ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1))); // type:loop_inv tag:result_in_bound line:17
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\linear_search\linear_search_2.e:18
  // not_present_so_far: across 1 |..| (Result - 1) as i all a.sequence[i] /= value end
  assert {:subsumption 0} (a) != (Void); // type:attached line:18
  assert readable[a, SIMPLE_ARRAY^INTEGER_32^.sequence]; // type:access tag:attribute_readable line:18 cid:77 fid:82
  assert (forall i_7: int :: (((1) <= (i_7)) && ((i_7) <= ((Result) - (1)))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_7))); // type:check tag:function_precondition line:18 cid:76 rid:3838
  assert (forall i_7: int :: (((1) <= (i_7)) && ((i_7) <= ((Result) - (1)))) ==> ((Seq#Item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_7)) != (value))); // type:loop_inv tag:not_present_so_far line:18
  assume HeapSucc(PreLoopHeap_6, Heap);
  assume same_outside(old(Heap), Heap, modify.LINEAR_SEARCH_2.linear_search(old(Heap), Current, a, value));
  assume global(Heap);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\linear_search\linear_search_2.e:-1
  assert {:subsumption 0} (a) != (Void); // type:attached line:-1
  assert Frame#Subset(read.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a), readable); // type:access tag:frame_readable line:-1 cid:77 rid:3825
  assert pre.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a); // type:check tag:function_precondition line:-1 cid:77 rid:3825
  assert {:subsumption 0} (!((Result) == (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)))) ==> ((a) != (Void)); // type:attached line:-1
  assert (!((Result) == (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)))) ==> (Frame#Subset(read.fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, Result), readable)); // type:access tag:frame_readable line:-1 cid:77 rid:3826
  assert (!((Result) == (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)))) ==> (pre.fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, Result)); // type:check tag:function_precondition line:-1 cid:77 rid:3826
  goto loop_body_4, loop_end_5;
  loop_body_4:
  assume !(((Result) == (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a))) || ((fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, Result)) == (value)));
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\linear_search\linear_search_2.e:24
  // a.count - Result + 1
  variant_8 := ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (Result)) + (1);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\linear_search\linear_search_2.e:22
  // Result := Result + 1
  Result := (Result) + (1);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\linear_search\linear_search_2.e:24
  // a.count - Result + 1
  assert {:subsumption 0} (((((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (Result)) + (1)) <= (variant_8)) && ((variant_8) <= (((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (Result)) + (1)))) || ((0) <= (variant_8)); // type:termination tag:bounded line:24 varid:1
  assert {:subsumption 0} ((((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (Result)) + (1)) <= (variant_8)) && (!((variant_8) <= (((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (Result)) + (1)))); // type:termination tag:variant_decreases line:24
  goto loop_head_3;
  loop_end_5:
  assume ((Result) == (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a))) || ((fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, Result)) == (value));
}
...
axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, owns, v, o) } (attached_exact(heap, current, LINEAR_SEARCH_2)) ==> ((guard(heap, current, owns, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, subjects, v, o) } (attached_exact(heap, current, LINEAR_SEARCH_2)) ==> ((guard(heap, current, subjects, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached_exact(heap, current, LINEAR_SEARCH_2)) ==> ((guard(heap, current, observers, v, o)) <==> (fun.LINEAR_SEARCH_2.in_observers(heap, current, v, o)))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached(heap, current, LINEAR_SEARCH_2)) ==> ((guard(heap, current, observers, v, o)) ==> (fun.LINEAR_SEARCH_2.in_observers(heap, current, v, o)))));

function modify.LINEAR_SEARCH_2.default_create(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T3> $o: ref, $f: Field T3 :: { modify.LINEAR_SEARCH_2.default_create(heap, current)[$o, $f] } (modify.LINEAR_SEARCH_2.default_create(heap, current)[$o, $f]) <==> (($o) == (current))))));
...
function modify.LINEAR_SEARCH_2.linear_search(heap: HeapType, current: ref, a: ref, value: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: ref, value: int :: (IsHeap(heap)) ==> ((forall <T5> $o: ref, $f: Field T5 :: { modify.LINEAR_SEARCH_2.linear_search(heap, current, a, value)[$o, $f] } (modify.LINEAR_SEARCH_2.linear_search(heap, current, a, value)[$o, $f]) <==> (false)))));

function read.fun.LINEAR_SEARCH_2.linear_search(heap: HeapType, current: ref, a: ref, value: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: ref, value: int :: (IsHeap(heap)) ==> ((forall <T6> $o: ref, $f: Field T6 :: { read.fun.LINEAR_SEARCH_2.linear_search(heap, current, a, value)[$o, $f] } (read.fun.LINEAR_SEARCH_2.linear_search(heap, current, a, value)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.LINEAR_SEARCH_2.linear_search(heap: HeapType, current: ref, a: ref, value: int) returns (bool) {
  ((2) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a))) && ((fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a)) <= (10)) && (is_closed(heap, current)) && (is_closed(heap, a))
}

function trigger.fun.LINEAR_SEARCH_2.linear_search(heap: HeapType, current: ref, a: ref, value: int) returns (bool);
...
procedure SIMPLE_ARRAY^INTEGER_32^.item(Current: ref, i: int) returns (Result: int where is_integer_32(Result));
  ...
  modifies Heap;
  ensures pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[Current, SIMPLE_ARRAY^INTEGER_32^.sequence], i); // type:check tag:function_precondition line:89 cid:76 rid:3838
...
procedure LINEAR_SEARCH_2.in_observers(Current: ref, new_observers: Set (ref), o: ref) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, LINEAR_SEARCH_2); // info:type property for argument Current
  free requires Set#ItemsType(Heap, new_observers, ANY); // info:type property for argument new_observers
  free requires ((o) != (Void)) && (Heap[o, allocated]); // info:type property for argument o
  modifies Heap;
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.LINEAR_SEARCH_2.in_observers(Heap, Current, new_observers, o), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.LINEAR_SEARCH_2.in_observers(old(Heap), Current, new_observers, o));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.LINEAR_SEARCH_2.in_observers(Heap, Current, new_observers, o), readable);



function fun.LINEAR_SEARCH_2.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

function fun0.LINEAR_SEARCH_2.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.LINEAR_SEARCH_2.in_observers(heap, current, new_observers, o) } { trigger.fun.LINEAR_SEARCH_2.in_observers(heap, current, new_observers, o) } (pre.fun.LINEAR_SEARCH_2.in_observers(heap, current, new_observers, o)) ==> ((fun.LINEAR_SEARCH_2.in_observers(heap, current, new_observers, o)) == ((attached(heap, o, ANY)) && (new_observers[o])))));

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.LINEAR_SEARCH_2.in_observers(heap, current, new_observers, o) } (fun.LINEAR_SEARCH_2.in_observers(heap, current, new_observers, o)) == (fun0.LINEAR_SEARCH_2.in_observers(heap, current, new_observers, o))));

axiom ((forall h: HeapType, h': HeapType, current: ref, new_observers: Set (ref), o: ref :: { HeapSucc(h, h'), fun0.LINEAR_SEARCH_2.in_observers(h, current, new_observers, o), fun0.LINEAR_SEARCH_2.in_observers(h', current, new_observers, o) } ((HeapSucc(h, h')) && (pre.fun.LINEAR_SEARCH_2.in_observers(h, current, new_observers, o)) && (pre.fun.LINEAR_SEARCH_2.in_observers(h', current, new_observers, o)) && (same_inside(h, h', read.fun.LINEAR_SEARCH_2.in_observers(h, current, new_observers, o)))) ==> ((fun0.LINEAR_SEARCH_2.in_observers(h, current, new_observers, o)) == (fun0.LINEAR_SEARCH_2.in_observers(h', current, new_observers, o)))));
...
function modify.LINEAR_SEARCH_2.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T13> $o: ref, $f: Field T13 :: { modify.LINEAR_SEARCH_2.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.LINEAR_SEARCH_2.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.LINEAR_SEARCH_2.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T14> $o: ref, $f: Field T14 :: { read.fun.LINEAR_SEARCH_2.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.LINEAR_SEARCH_2.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.LINEAR_SEARCH_2.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool) {
  true
}

function trigger.fun.LINEAR_SEARCH_2.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);
