// Automatically generated (04/03/2023 11:06:15.891 AM)
...
const unique MAX_IN_ARRAY_1: Type;

axiom ((MAX_IN_ARRAY_1) <: (ANY));

axiom ((forall t: Type :: { (MAX_IN_ARRAY_1) <: (t) } ((MAX_IN_ARRAY_1) <: (t)) <==> (((t) == (MAX_IN_ARRAY_1)) || ((ANY) <: (t)))));

axiom ((FieldId(allocated, MAX_IN_ARRAY_1)) == (-1));

axiom ((FieldId(closed, MAX_IN_ARRAY_1)) == (-2));

axiom ((FieldId(owner, MAX_IN_ARRAY_1)) == (-3));

axiom ((FieldId(owns, MAX_IN_ARRAY_1)) == (-4));

axiom ((FieldId(observers, MAX_IN_ARRAY_1)) == (-5));

axiom ((FieldId(subjects, MAX_IN_ARRAY_1)) == (-6));

axiom ((forall <T0> $f: Field T0 :: { IsModelField($f, MAX_IN_ARRAY_1) } (IsModelField($f, MAX_IN_ARRAY_1)) <==> ((($f) == (subjects)) || (($f) == (observers)))));

function { :inline } MAX_IN_ARRAY_1.user_inv(heap: HeapType, current: ref) returns (bool) {
...
axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached_exact(heap, current, MAX_IN_ARRAY_1)) ==> ((user_inv(heap, current)) <==> (MAX_IN_ARRAY_1.user_inv(heap, current)))));

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached(heap, current, MAX_IN_ARRAY_1)) ==> ((user_inv(heap, current)) ==> (MAX_IN_ARRAY_1.user_inv(heap, current)))));

procedure MAX_IN_ARRAY_1.invariant_admissibility_check(Current: ref);
  requires attached_exact(Heap, Current, MAX_IN_ARRAY_1);



implementation MAX_IN_ARRAY_1.invariant_admissibility_check(Current: ref)
{
  entry:
  goto pre, a2, a3;
  pre:
...
procedure create.MAX_IN_ARRAY_1.default_create(Current: ref);
  free requires attached_exact(Heap, Current, MAX_IN_ARRAY_1); // info:type property for argument Current
  modifies Heap;
  ...
  requires Frame#Subset(modify.MAX_IN_ARRAY_1.default_create(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.MAX_IN_ARRAY_1.default_create(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts



implementation create.MAX_IN_ARRAY_1.default_create(Current: ref)
{
  entry:
  assume {:captureState "create.MAX_IN_ARRAY_1.default_create"} true;
  if (*) {
...
procedure MAX_IN_ARRAY_1.max_in_array(Current: ref, a: ref) returns (Result: int where is_integer_32(Result));
  free requires attached_exact(Heap, Current, MAX_IN_ARRAY_1); // info:type property for argument Current
  free requires attached_exact(Heap, a, SIMPLE_ARRAY^INTEGER_32^); // info:type property for argument a
  modifies Heap;
  requires (a) != (Void); // type:attached tag:array_not_empty line:12
  requires pre.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a); // type:check tag:function_precondition line:12 cid:80 rid:3797
  requires (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) > (0); // type:pre tag:array_not_empty line:12
  requires ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) >= (2)) && ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) <= (5)); // type:pre tag:array_szie line:13
  ensures (a) != (Void); // type:attached tag:is_maximum line:36
  ensures pre.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a); // type:check tag:function_precondition line:36 cid:80 rid:3797
  ensures (forall i_1: int :: (((1) <= (i_1)) && ((i_1) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_1))); // type:check tag:function_precondition line:36 cid:79 rid:3810
  ensures (forall i_1: int :: (((1) <= (i_1)) && ((i_1) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)))) ==> ((Seq#Item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_1)) <= (Result))); // type:post tag:is_maximum line:36
  ensures (forall i_2: int :: (((1) <= (i_2)) && ((i_2) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_2))); // type:check tag:function_precondition line:37 cid:79 rid:3810
  ensures (exists i_2: int :: ((1) <= (i_2)) && ((i_2) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a))) && ((Seq#Item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_2)) == (Result))); // type:post tag:result_in_array line:37
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.MAX_IN_ARRAY_1.max_in_array(Heap, Current, a), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.MAX_IN_ARRAY_1.max_in_array(old(Heap), Current, a));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.MAX_IN_ARRAY_1.max_in_array(Heap, Current, a), readable);
  ...
  free ensures (Result) == (fun.MAX_IN_ARRAY_1.max_in_array(old(Heap), Current, a));



function fun.MAX_IN_ARRAY_1.max_in_array(heap: HeapType, current: ref, a: ref) returns (int);

axiom ((forall heap: HeapType, current: ref, a: ref :: { fun.MAX_IN_ARRAY_1.max_in_array(heap, current, a) } (pre.fun.MAX_IN_ARRAY_1.max_in_array(heap, current, a)) ==> (((forall i_3: int :: (((1) <= (i_3)) && ((i_3) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a)))) ==> ((Seq#Item(heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_3)) <= (fun.MAX_IN_ARRAY_1.max_in_array(heap, current, a))))) && ((exists i_4: int :: ((1) <= (i_4)) && ((i_4) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a))) && ((Seq#Item(heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_4)) == (fun.MAX_IN_ARRAY_1.max_in_array(heap, current, a))))) && (is_integer_32(fun.MAX_IN_ARRAY_1.max_in_array(heap, current, a))))));

axiom ((forall h: HeapType, h': HeapType, current: ref, a: ref :: { HeapSucc(h, h'), fun.MAX_IN_ARRAY_1.max_in_array(h, current, a), fun.MAX_IN_ARRAY_1.max_in_array(h', current, a) } ((HeapSucc(h, h')) && (pre.fun.MAX_IN_ARRAY_1.max_in_array(h, current, a)) && (pre.fun.MAX_IN_ARRAY_1.max_in_array(h', current, a)) && (same_inside(h, h', read.fun.MAX_IN_ARRAY_1.max_in_array(h, current, a)))) ==> ((fun.MAX_IN_ARRAY_1.max_in_array(h, current, a)) == (fun.MAX_IN_ARRAY_1.max_in_array(h', current, a)))));

function { :inline } variant.MAX_IN_ARRAY_1.max_in_array.1(heap: HeapType, current: ref, a: ref) returns (ref) {
  a
}

implementation MAX_IN_ARRAY_1.max_in_array(Current: ref, a: ref) returns (Result: int)
{
  var temp_5: int;
  ...
  entry:
  assume {:captureState "MAX_IN_ARRAY_1.max_in_array"} true;
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\max_in_array\max_in_array_1.e:17
  // Result := a [1]
  assert {:subsumption 0} (a) != (Void); // type:attached line:17
  assert Frame#Subset(read.fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, 1), readable); // type:access tag:frame_readable line:17 cid:80 rid:3798
  call temp_5 := SIMPLE_ARRAY^INTEGER_32^.item(a, 1); // line:17 cid:80 rid:3798
  Result := temp_5;
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\max_in_array\max_in_array_1.e:20
  // i := 2
  local1 := 2;
  PreLoopHeap_9 := Heap;
  goto loop_head_6;
  loop_head_6:
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\max_in_array\max_in_array_1.e:22
  // i_in_bounds: 2 <= i and i <= a.count + 1
  assert {:subsumption 0} (a) != (Void); // type:attached line:22
  assert Frame#Subset(read.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a), readable); // type:access tag:frame_readable line:22 cid:80 rid:3797
  assert pre.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a); // type:check tag:function_precondition line:22 cid:80 rid:3797
  assert ((2) <= (local1)) && ((local1) <= ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1))); // type:loop_inv tag:i_in_bounds line:22
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\max_in_array\max_in_array_1.e:23
  // max_so_far: across 1 |..| (i - 1) as c all a.sequence [c] <= Result end
  assert {:subsumption 0} (a) != (Void); // type:attached line:23
  assert readable[a, SIMPLE_ARRAY^INTEGER_32^.sequence]; // type:access tag:attribute_readable line:23 cid:80 fid:82
  assert (forall i_10: int :: (((1) <= (i_10)) && ((i_10) <= ((local1) - (1)))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_10))); // type:check tag:function_precondition line:23 cid:79 rid:3810
  assert (forall i_10: int :: (((1) <= (i_10)) && ((i_10) <= ((local1) - (1)))) ==> ((Seq#Item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_10)) <= (Result))); // type:loop_inv tag:max_so_far line:23
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\max_in_array\max_in_array_1.e:24
  // result_in_array: across 1 |..| (i - 1) as c some a.sequence [c] = Result end
  assert {:subsumption 0} (a) != (Void); // type:attached line:24
  assert readable[a, SIMPLE_ARRAY^INTEGER_32^.sequence]; // type:access tag:attribute_readable line:24 cid:80 fid:82
  assert (forall i_11: int :: (((1) <= (i_11)) && ((i_11) <= ((local1) - (1)))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_11))); // type:check tag:function_precondition line:24 cid:79 rid:3810
  assert (exists i_11: int :: ((1) <= (i_11)) && ((i_11) <= ((local1) - (1))) && ((Seq#Item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_11)) == (Result))); // type:loop_inv tag:result_in_array line:24
  assume HeapSucc(PreLoopHeap_9, Heap);
  assume same_outside(old(Heap), Heap, modify.MAX_IN_ARRAY_1.max_in_array(old(Heap), Current, a));
  assume global(Heap);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\max_in_array\max_in_array_1.e:-1
  ...
  loop_body_7:
  assume !((local1) == ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1)));
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\max_in_array\max_in_array_1.e:33
  // a.count - i
  variant_12 := (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (local1);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\max_in_array\max_in_array_1.e:28
  // if a [i] < Result then
  assert {:subsumption 0} (a) != (Void); // type:attached line:28
  assert Frame#Subset(read.fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, local1), readable); // type:access tag:frame_readable line:28 cid:80 rid:3798
  call temp_13 := SIMPLE_ARRAY^INTEGER_32^.item(a, local1); // line:28 cid:80 rid:3798
  if ((temp_13) < (Result)) {
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\max_in_array\max_in_array_1.e:29
    // Result := a [i]
    assert {:subsumption 0} (a) != (Void); // type:attached line:29
    assert Frame#Subset(read.fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, local1), readable); // type:access tag:frame_readable line:29 cid:80 rid:3798
    call temp_14 := SIMPLE_ARRAY^INTEGER_32^.item(a, local1); // line:29 cid:80 rid:3798
    Result := temp_14;
  }
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\max_in_array\max_in_array_1.e:31
  // i := i + 1
  local1 := (local1) + (1);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\max_in_array\max_in_array_1.e:33
  // a.count - i
  assert {:subsumption 0} ((((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (local1)) <= (variant_12)) && ((variant_12) <= ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (local1)))) || ((0) <= (variant_12)); // type:termination tag:bounded line:33 varid:1
  assert {:subsumption 0} (((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (local1)) <= (variant_12)) && (!((variant_12) <= ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (local1)))); // type:termination tag:variant_decreases line:33
  goto loop_head_6;
  loop_end_8:
  assume (local1) == ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1));
}
...
axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, owns, v, o) } (attached_exact(heap, current, MAX_IN_ARRAY_1)) ==> ((guard(heap, current, owns, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, subjects, v, o) } (attached_exact(heap, current, MAX_IN_ARRAY_1)) ==> ((guard(heap, current, subjects, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached_exact(heap, current, MAX_IN_ARRAY_1)) ==> ((guard(heap, current, observers, v, o)) <==> (fun.MAX_IN_ARRAY_1.in_observers(heap, current, v, o)))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached(heap, current, MAX_IN_ARRAY_1)) ==> ((guard(heap, current, observers, v, o)) ==> (fun.MAX_IN_ARRAY_1.in_observers(heap, current, v, o)))));

function modify.MAX_IN_ARRAY_1.default_create(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T3> $o: ref, $f: Field T3 :: { modify.MAX_IN_ARRAY_1.default_create(heap, current)[$o, $f] } (modify.MAX_IN_ARRAY_1.default_create(heap, current)[$o, $f]) <==> (($o) == (current))))));
...
function modify.MAX_IN_ARRAY_1.max_in_array(heap: HeapType, current: ref, a: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: ref :: (IsHeap(heap)) ==> ((forall <T5> $o: ref, $f: Field T5 :: { modify.MAX_IN_ARRAY_1.max_in_array(heap, current, a)[$o, $f] } (modify.MAX_IN_ARRAY_1.max_in_array(heap, current, a)[$o, $f]) <==> (false)))));

function read.fun.MAX_IN_ARRAY_1.max_in_array(heap: HeapType, current: ref, a: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: ref :: (IsHeap(heap)) ==> ((forall <T6> $o: ref, $f: Field T6 :: { read.fun.MAX_IN_ARRAY_1.max_in_array(heap, current, a)[$o, $f] } (read.fun.MAX_IN_ARRAY_1.max_in_array(heap, current, a)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.MAX_IN_ARRAY_1.max_in_array(heap: HeapType, current: ref, a: ref) returns (bool) {
...
function trigger.fun.MAX_IN_ARRAY_1.max_in_array(heap: HeapType, current: ref, a: ref) returns (bool);
...
procedure MAX_IN_ARRAY_1.in_observers(Current: ref, new_observers: Set (ref), o: ref) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, MAX_IN_ARRAY_1); // info:type property for argument Current
  free requires Set#ItemsType(Heap, new_observers, ANY); // info:type property for argument new_observers
  free requires ((o) != (Void)) && (Heap[o, allocated]); // info:type property for argument o
  modifies Heap;
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.MAX_IN_ARRAY_1.in_observers(Heap, Current, new_observers, o), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.MAX_IN_ARRAY_1.in_observers(old(Heap), Current, new_observers, o));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.MAX_IN_ARRAY_1.in_observers(Heap, Current, new_observers, o), readable);



function fun.MAX_IN_ARRAY_1.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

function fun0.MAX_IN_ARRAY_1.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.MAX_IN_ARRAY_1.in_observers(heap, current, new_observers, o) } { trigger.fun.MAX_IN_ARRAY_1.in_observers(heap, current, new_observers, o) } (pre.fun.MAX_IN_ARRAY_1.in_observers(heap, current, new_observers, o)) ==> ((fun.MAX_IN_ARRAY_1.in_observers(heap, current, new_observers, o)) == ((attached(heap, o, ANY)) && (new_observers[o])))));

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.MAX_IN_ARRAY_1.in_observers(heap, current, new_observers, o) } (fun.MAX_IN_ARRAY_1.in_observers(heap, current, new_observers, o)) == (fun0.MAX_IN_ARRAY_1.in_observers(heap, current, new_observers, o))));

axiom ((forall h: HeapType, h': HeapType, current: ref, new_observers: Set (ref), o: ref :: { HeapSucc(h, h'), fun0.MAX_IN_ARRAY_1.in_observers(h, current, new_observers, o), fun0.MAX_IN_ARRAY_1.in_observers(h', current, new_observers, o) } ((HeapSucc(h, h')) && (pre.fun.MAX_IN_ARRAY_1.in_observers(h, current, new_observers, o)) && (pre.fun.MAX_IN_ARRAY_1.in_observers(h', current, new_observers, o)) && (same_inside(h, h', read.fun.MAX_IN_ARRAY_1.in_observers(h, current, new_observers, o)))) ==> ((fun0.MAX_IN_ARRAY_1.in_observers(h, current, new_observers, o)) == (fun0.MAX_IN_ARRAY_1.in_observers(h', current, new_observers, o)))));
...
function modify.MAX_IN_ARRAY_1.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T13> $o: ref, $f: Field T13 :: { modify.MAX_IN_ARRAY_1.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.MAX_IN_ARRAY_1.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.MAX_IN_ARRAY_1.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T14> $o: ref, $f: Field T14 :: { read.fun.MAX_IN_ARRAY_1.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.MAX_IN_ARRAY_1.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.MAX_IN_ARRAY_1.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool) {
  true
}

function trigger.fun.MAX_IN_ARRAY_1.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);
