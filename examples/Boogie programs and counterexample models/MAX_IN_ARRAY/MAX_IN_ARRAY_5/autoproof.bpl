// Automatically generated (04/03/2023 11:42:31.583 AM)
...
const unique MAX_IN_ARRAY_5: Type;

axiom ((MAX_IN_ARRAY_5) <: (ANY));

axiom ((forall t: Type :: { (MAX_IN_ARRAY_5) <: (t) } ((MAX_IN_ARRAY_5) <: (t)) <==> (((t) == (MAX_IN_ARRAY_5)) || ((ANY) <: (t)))));

axiom ((FieldId(allocated, MAX_IN_ARRAY_5)) == (-1));

axiom ((FieldId(closed, MAX_IN_ARRAY_5)) == (-2));

axiom ((FieldId(owner, MAX_IN_ARRAY_5)) == (-3));

axiom ((FieldId(owns, MAX_IN_ARRAY_5)) == (-4));

axiom ((FieldId(observers, MAX_IN_ARRAY_5)) == (-5));

axiom ((FieldId(subjects, MAX_IN_ARRAY_5)) == (-6));

axiom ((forall <T0> $f: Field T0 :: { IsModelField($f, MAX_IN_ARRAY_5) } (IsModelField($f, MAX_IN_ARRAY_5)) <==> ((($f) == (subjects)) || (($f) == (observers)))));

function { :inline } MAX_IN_ARRAY_5.user_inv(heap: HeapType, current: ref) returns (bool) {
...
axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached_exact(heap, current, MAX_IN_ARRAY_5)) ==> ((user_inv(heap, current)) <==> (MAX_IN_ARRAY_5.user_inv(heap, current)))));

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached(heap, current, MAX_IN_ARRAY_5)) ==> ((user_inv(heap, current)) ==> (MAX_IN_ARRAY_5.user_inv(heap, current)))));

procedure MAX_IN_ARRAY_5.invariant_admissibility_check(Current: ref);
  requires attached_exact(Heap, Current, MAX_IN_ARRAY_5);



implementation MAX_IN_ARRAY_5.invariant_admissibility_check(Current: ref)
{
  entry:
  goto pre, a2, a3;
  pre:
...
procedure create.MAX_IN_ARRAY_5.default_create(Current: ref);
  free requires attached_exact(Heap, Current, MAX_IN_ARRAY_5); // info:type property for argument Current
  modifies Heap;
  ...
  requires Frame#Subset(modify.MAX_IN_ARRAY_5.default_create(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.MAX_IN_ARRAY_5.default_create(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts



implementation create.MAX_IN_ARRAY_5.default_create(Current: ref)
{
  entry:
  assume {:captureState "create.MAX_IN_ARRAY_5.default_create"} true;
  if (*) {
...
procedure MAX_IN_ARRAY_5.max_in_array(Current: ref, a: ref) returns (Result: int where is_integer_32(Result));
  free requires attached_exact(Heap, Current, MAX_IN_ARRAY_5); // info:type property for argument Current
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.MAX_IN_ARRAY_5.max_in_array(Heap, Current, a), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.MAX_IN_ARRAY_5.max_in_array(old(Heap), Current, a));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.MAX_IN_ARRAY_5.max_in_array(Heap, Current, a), readable);
  ...
  free ensures (Result) == (fun.MAX_IN_ARRAY_5.max_in_array(old(Heap), Current, a));



function fun.MAX_IN_ARRAY_5.max_in_array(heap: HeapType, current: ref, a: ref) returns (int);

axiom ((forall heap: HeapType, current: ref, a: ref :: { fun.MAX_IN_ARRAY_5.max_in_array(heap, current, a) } (pre.fun.MAX_IN_ARRAY_5.max_in_array(heap, current, a)) ==> (((forall i_3: int :: (((1) <= (i_3)) && ((i_3) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a)))) ==> ((Seq#Item(heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_3)) <= (fun.MAX_IN_ARRAY_5.max_in_array(heap, current, a))))) && ((exists i_4: int :: ((1) <= (i_4)) && ((i_4) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a))) && ((Seq#Item(heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_4)) == (fun.MAX_IN_ARRAY_5.max_in_array(heap, current, a))))) && (is_integer_32(fun.MAX_IN_ARRAY_5.max_in_array(heap, current, a))))));

axiom ((forall h: HeapType, h': HeapType, current: ref, a: ref :: { HeapSucc(h, h'), fun.MAX_IN_ARRAY_5.max_in_array(h, current, a), fun.MAX_IN_ARRAY_5.max_in_array(h', current, a) } ((HeapSucc(h, h')) && (pre.fun.MAX_IN_ARRAY_5.max_in_array(h, current, a)) && (pre.fun.MAX_IN_ARRAY_5.max_in_array(h', current, a)) && (same_inside(h, h', read.fun.MAX_IN_ARRAY_5.max_in_array(h, current, a)))) ==> ((fun.MAX_IN_ARRAY_5.max_in_array(h, current, a)) == (fun.MAX_IN_ARRAY_5.max_in_array(h', current, a)))));

function { :inline } variant.MAX_IN_ARRAY_5.max_in_array.1(heap: HeapType, current: ref, a: ref) returns (ref) {
  a
}

implementation MAX_IN_ARRAY_5.max_in_array(Current: ref, a: ref) returns (Result: int)
{
  ...
  entry:
  assume {:captureState "MAX_IN_ARRAY_5.max_in_array"} true;
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\max_in_array\max_in_array_5.e:14
  // Result := 0 -- a [1]
  Result := 0;
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\max_in_array\max_in_array_5.e:16
  // i := 2
  local1 := 2;
  PreLoopHeap_8 := Heap;
  goto loop_head_5;
  loop_head_5:
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\max_in_array\max_in_array_5.e:18
  ...
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\max_in_array\max_in_array_5.e:19
  ...
  assert (forall i_9: int :: (((1) <= (i_9)) && ((i_9) <= ((local1) - (1)))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_9))); // type:check tag:function_precondition line:19 cid:79 rid:3810
  assert (forall i_9: int :: (((1) <= (i_9)) && ((i_9) <= ((local1) - (1)))) ==> ((Seq#Item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_9)) <= (Result))); // type:loop_inv tag:max_so_far line:19
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\max_in_array\max_in_array_5.e:20
  ...
  assert (forall i_10: int :: (((1) <= (i_10)) && ((i_10) <= ((local1) - (1)))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_10))); // type:check tag:function_precondition line:20 cid:79 rid:3810
  assert (exists i_10: int :: ((1) <= (i_10)) && ((i_10) <= ((local1) - (1))) && ((Seq#Item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_10)) == (Result))); // type:loop_inv tag:result_in_array line:20
  assume HeapSucc(PreLoopHeap_8, Heap);
  assume same_outside(old(Heap), Heap, modify.MAX_IN_ARRAY_5.max_in_array(old(Heap), Current, a));
  assume global(Heap);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\max_in_array\max_in_array_5.e:-1
  ...
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\max_in_array\max_in_array_5.e:29
  // a.count - i + 1
  variant_11 := ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (local1)) + (1);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\max_in_array\max_in_array_5.e:24
  // if a [i] > Result then
  ...
  call temp_12 := SIMPLE_ARRAY^INTEGER_32^.item(a, local1); // line:24 cid:80 rid:3798
  if ((temp_12) > (Result)) {
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\max_in_array\max_in_array_5.e:25
    // Result := a [i]
    ...
    call temp_13 := SIMPLE_ARRAY^INTEGER_32^.item(a, local1); // line:25 cid:80 rid:3798
    Result := temp_13;
  }
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\max_in_array\max_in_array_5.e:27
  // i := i + 1
  local1 := (local1) + (1);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\max_in_array\max_in_array_5.e:29
  // a.count - i + 1
  assert {:subsumption 0} (((((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (local1)) + (1)) <= (variant_11)) && ((variant_11) <= (((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (local1)) + (1)))) || ((0) <= (variant_11)); // type:termination tag:bounded line:29 varid:1
  assert {:subsumption 0} ((((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (local1)) + (1)) <= (variant_11)) && (!((variant_11) <= (((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (local1)) + (1)))); // type:termination tag:variant_decreases line:29
  goto loop_head_5;
  loop_end_7:
  assume (local1) > (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a));
}
...
axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, owns, v, o) } (attached_exact(heap, current, MAX_IN_ARRAY_5)) ==> ((guard(heap, current, owns, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, subjects, v, o) } (attached_exact(heap, current, MAX_IN_ARRAY_5)) ==> ((guard(heap, current, subjects, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached_exact(heap, current, MAX_IN_ARRAY_5)) ==> ((guard(heap, current, observers, v, o)) <==> (fun.MAX_IN_ARRAY_5.in_observers(heap, current, v, o)))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached(heap, current, MAX_IN_ARRAY_5)) ==> ((guard(heap, current, observers, v, o)) ==> (fun.MAX_IN_ARRAY_5.in_observers(heap, current, v, o)))));

function modify.MAX_IN_ARRAY_5.default_create(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T3> $o: ref, $f: Field T3 :: { modify.MAX_IN_ARRAY_5.default_create(heap, current)[$o, $f] } (modify.MAX_IN_ARRAY_5.default_create(heap, current)[$o, $f]) <==> (($o) == (current))))));
...
function modify.MAX_IN_ARRAY_5.max_in_array(heap: HeapType, current: ref, a: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: ref :: (IsHeap(heap)) ==> ((forall <T5> $o: ref, $f: Field T5 :: { modify.MAX_IN_ARRAY_5.max_in_array(heap, current, a)[$o, $f] } (modify.MAX_IN_ARRAY_5.max_in_array(heap, current, a)[$o, $f]) <==> (false)))));

function read.fun.MAX_IN_ARRAY_5.max_in_array(heap: HeapType, current: ref, a: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: ref :: (IsHeap(heap)) ==> ((forall <T6> $o: ref, $f: Field T6 :: { read.fun.MAX_IN_ARRAY_5.max_in_array(heap, current, a)[$o, $f] } (read.fun.MAX_IN_ARRAY_5.max_in_array(heap, current, a)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.MAX_IN_ARRAY_5.max_in_array(heap: HeapType, current: ref, a: ref) returns (bool) {
...
function trigger.fun.MAX_IN_ARRAY_5.max_in_array(heap: HeapType, current: ref, a: ref) returns (bool);
...
procedure MAX_IN_ARRAY_5.in_observers(Current: ref, new_observers: Set (ref), o: ref) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, MAX_IN_ARRAY_5); // info:type property for argument Current
  free requires Set#ItemsType(Heap, new_observers, ANY); // info:type property for argument new_observers
  free requires ((o) != (Void)) && (Heap[o, allocated]); // info:type property for argument o
  modifies Heap;
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.MAX_IN_ARRAY_5.in_observers(Heap, Current, new_observers, o), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.MAX_IN_ARRAY_5.in_observers(old(Heap), Current, new_observers, o));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.MAX_IN_ARRAY_5.in_observers(Heap, Current, new_observers, o), readable);



function fun.MAX_IN_ARRAY_5.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

function fun0.MAX_IN_ARRAY_5.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.MAX_IN_ARRAY_5.in_observers(heap, current, new_observers, o) } { trigger.fun.MAX_IN_ARRAY_5.in_observers(heap, current, new_observers, o) } (pre.fun.MAX_IN_ARRAY_5.in_observers(heap, current, new_observers, o)) ==> ((fun.MAX_IN_ARRAY_5.in_observers(heap, current, new_observers, o)) == ((attached(heap, o, ANY)) && (new_observers[o])))));

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.MAX_IN_ARRAY_5.in_observers(heap, current, new_observers, o) } (fun.MAX_IN_ARRAY_5.in_observers(heap, current, new_observers, o)) == (fun0.MAX_IN_ARRAY_5.in_observers(heap, current, new_observers, o))));

axiom ((forall h: HeapType, h': HeapType, current: ref, new_observers: Set (ref), o: ref :: { HeapSucc(h, h'), fun0.MAX_IN_ARRAY_5.in_observers(h, current, new_observers, o), fun0.MAX_IN_ARRAY_5.in_observers(h', current, new_observers, o) } ((HeapSucc(h, h')) && (pre.fun.MAX_IN_ARRAY_5.in_observers(h, current, new_observers, o)) && (pre.fun.MAX_IN_ARRAY_5.in_observers(h', current, new_observers, o)) && (same_inside(h, h', read.fun.MAX_IN_ARRAY_5.in_observers(h, current, new_observers, o)))) ==> ((fun0.MAX_IN_ARRAY_5.in_observers(h, current, new_observers, o)) == (fun0.MAX_IN_ARRAY_5.in_observers(h', current, new_observers, o)))));
...
function modify.MAX_IN_ARRAY_5.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T13> $o: ref, $f: Field T13 :: { modify.MAX_IN_ARRAY_5.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.MAX_IN_ARRAY_5.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.MAX_IN_ARRAY_5.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T14> $o: ref, $f: Field T14 :: { read.fun.MAX_IN_ARRAY_5.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.MAX_IN_ARRAY_5.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.MAX_IN_ARRAY_5.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool) {
  true
}

function trigger.fun.MAX_IN_ARRAY_5.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);
