// Automatically generated (04/03/2023 9:12:04.015 PM)
...
const unique SQUARE_ROOT_4: Type;

axiom ((SQUARE_ROOT_4) <: (ANY));

axiom ((forall t: Type :: { (SQUARE_ROOT_4) <: (t) } ((SQUARE_ROOT_4) <: (t)) <==> (((t) == (SQUARE_ROOT_4)) || ((ANY) <: (t)))));

axiom ((FieldId(allocated, SQUARE_ROOT_4)) == (-1));

axiom ((FieldId(closed, SQUARE_ROOT_4)) == (-2));

axiom ((FieldId(owner, SQUARE_ROOT_4)) == (-3));

axiom ((FieldId(owns, SQUARE_ROOT_4)) == (-4));

axiom ((FieldId(observers, SQUARE_ROOT_4)) == (-5));

axiom ((FieldId(subjects, SQUARE_ROOT_4)) == (-6));

axiom ((forall <T0> $f: Field T0 :: { IsModelField($f, SQUARE_ROOT_4) } (IsModelField($f, SQUARE_ROOT_4)) <==> ((($f) == (subjects)) || (($f) == (observers)))));

function { :inline } SQUARE_ROOT_4.user_inv(heap: HeapType, current: ref) returns (bool) {
...
axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached_exact(heap, current, SQUARE_ROOT_4)) ==> ((user_inv(heap, current)) <==> (SQUARE_ROOT_4.user_inv(heap, current)))));

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached(heap, current, SQUARE_ROOT_4)) ==> ((user_inv(heap, current)) ==> (SQUARE_ROOT_4.user_inv(heap, current)))));

procedure SQUARE_ROOT_4.invariant_admissibility_check(Current: ref);
  requires attached_exact(Heap, Current, SQUARE_ROOT_4);



implementation SQUARE_ROOT_4.invariant_admissibility_check(Current: ref)
{
  entry:
  goto pre, a2, a3;
  pre:
...
procedure create.SQUARE_ROOT_4.default_create(Current: ref);
  free requires attached_exact(Heap, Current, SQUARE_ROOT_4); // info:type property for argument Current
  modifies Heap;
  ...
  requires Frame#Subset(modify.SQUARE_ROOT_4.default_create(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.SQUARE_ROOT_4.default_create(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts



implementation create.SQUARE_ROOT_4.default_create(Current: ref)
{
  entry:
  assume {:captureState "create.SQUARE_ROOT_4.default_create"} true;
  if (*) {
...
procedure SQUARE_ROOT_4.square_root(Current: ref, n: int) returns (Result: ref where attached(Heap, Result, TUPLE^INTEGER_32#INTEGER_32^));
  free requires attached_exact(Heap, Current, SQUARE_ROOT_4); // info:type property for argument Current
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.SQUARE_ROOT_4.square_root(Heap, Current, n), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.SQUARE_ROOT_4.square_root(old(Heap), Current, n));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.SQUARE_ROOT_4.square_root(Heap, Current, n), readable);
  requires is_closed(Heap, Current); // type:pre tag:default_is_closed default:contracts
  free ensures (Result) == (fun.SQUARE_ROOT_4.square_root(old(Heap), Current, n));



function fun.SQUARE_ROOT_4.square_root(heap: HeapType, current: ref, n: int) returns (ref);

axiom ((forall heap: HeapType, current: ref, n: int :: { fun.SQUARE_ROOT_4.square_root(heap, current, n) } (pre.fun.SQUARE_ROOT_4.square_root(heap, current, n)) ==> (((((heap[fun.SQUARE_ROOT_4.square_root(heap, current, n), TUPLE^INTEGER_32#INTEGER_32^.field_1]) == (heap[fun.SQUARE_ROOT_4.square_root(heap, current, n), TUPLE^INTEGER_32#INTEGER_32^.field_2])) && (((heap[fun.SQUARE_ROOT_4.square_root(heap, current, n), TUPLE^INTEGER_32#INTEGER_32^.field_1]) * (heap[fun.SQUARE_ROOT_4.square_root(heap, current, n), TUPLE^INTEGER_32#INTEGER_32^.field_1])) == (n))) || ((((heap[fun.SQUARE_ROOT_4.square_root(heap, current, n), TUPLE^INTEGER_32#INTEGER_32^.field_1]) + (1)) == (heap[fun.SQUARE_ROOT_4.square_root(heap, current, n), TUPLE^INTEGER_32#INTEGER_32^.field_2])) && (((heap[fun.SQUARE_ROOT_4.square_root(heap, current, n), TUPLE^INTEGER_32#INTEGER_32^.field_1]) * (heap[fun.SQUARE_ROOT_4.square_root(heap, current, n), TUPLE^INTEGER_32#INTEGER_32^.field_1])) < (n)) && (((heap[fun.SQUARE_ROOT_4.square_root(heap, current, n), TUPLE^INTEGER_32#INTEGER_32^.field_2]) * (heap[fun.SQUARE_ROOT_4.square_root(heap, current, n), TUPLE^INTEGER_32#INTEGER_32^.field_2])) >= (n)))) && (attached(heap, fun.SQUARE_ROOT_4.square_root(heap, current, n), TUPLE^INTEGER_32#INTEGER_32^)))));

axiom ((forall h: HeapType, h': HeapType, current: ref, n: int :: { HeapSucc(h, h'), fun.SQUARE_ROOT_4.square_root(h, current, n), fun.SQUARE_ROOT_4.square_root(h', current, n) } ((HeapSucc(h, h')) && (pre.fun.SQUARE_ROOT_4.square_root(h, current, n)) && (pre.fun.SQUARE_ROOT_4.square_root(h', current, n)) && (same_inside(h, h', read.fun.SQUARE_ROOT_4.square_root(h, current, n)))) ==> ((fun.SQUARE_ROOT_4.square_root(h, current, n)) == (fun.SQUARE_ROOT_4.square_root(h', current, n)))));

function { :inline } variant.SQUARE_ROOT_4.square_root.1(heap: HeapType, current: ref, n: int) returns (int) {
  n
}

implementation SQUARE_ROOT_4.square_root(Current: ref, n: int) returns (Result: ref)
{
  ...
  entry:
  assume {:captureState "SQUARE_ROOT_4.square_root"} true;
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\square_root\square_root_4.e:18
  // x1 := 0
  local1 := 0;
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\square_root\square_root_4.e:19
  // x2 := n
  local2 := n;
  PreLoopHeap_4 := Heap;
  goto loop_head_1;
  loop_head_1:
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\square_root\square_root_4.e:21
  ...
  assume same_outside(old(Heap), Heap, modify.SQUARE_ROOT_4.square_root(old(Heap), Current, n));
  assume global(Heap);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\square_root\square_root_4.e:-1
  goto loop_body_2, loop_end_3;
  loop_body_2:
  assume !((((local2) - (local1)) <= (1)) || ((local1) == (local2)));
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\square_root\square_root_4.e:37
  // x2 - x1
  variant_5 := (local2) - (local1);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\square_root\square_root_4.e:25
  // mid := (x1 + x2) // 2 -- integer division
  local3 := ((local1) + (local2)) div (2);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\square_root\square_root_4.e:26
  // if mid * mid = n then
  if (((local3) * (local3)) == (n)) {
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\square_root\square_root_4.e:27
    // x1 := mid
    local1 := local3;
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\square_root\square_root_4.e:28
    // x2 := mid
    local2 := local3;
  } else {
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\square_root\square_root_4.e:30
    // if mid * mid > n then
    if (((local3) * (local3)) > (n)) {
      // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\square_root\square_root_4.e:31
      // x1 := mid
      local1 := local3;
    } else {
      // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\square_root\square_root_4.e:33
      // x2 := mid
      local2 := local3;
    }
  }
  ...
  loop_end_3:
  assume (((local2) - (local1)) <= (1)) || ((local1) == (local2));
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\square_root\square_root_4.e:39
  // Result := [x1, x2]
...
axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, owns, v, o) } (attached_exact(heap, current, SQUARE_ROOT_4)) ==> ((guard(heap, current, owns, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, subjects, v, o) } (attached_exact(heap, current, SQUARE_ROOT_4)) ==> ((guard(heap, current, subjects, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached_exact(heap, current, SQUARE_ROOT_4)) ==> ((guard(heap, current, observers, v, o)) <==> (fun.SQUARE_ROOT_4.in_observers(heap, current, v, o)))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached(heap, current, SQUARE_ROOT_4)) ==> ((guard(heap, current, observers, v, o)) ==> (fun.SQUARE_ROOT_4.in_observers(heap, current, v, o)))));

function modify.SQUARE_ROOT_4.default_create(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T3> $o: ref, $f: Field T3 :: { modify.SQUARE_ROOT_4.default_create(heap, current)[$o, $f] } (modify.SQUARE_ROOT_4.default_create(heap, current)[$o, $f]) <==> (($o) == (current))))));
...
function modify.SQUARE_ROOT_4.square_root(heap: HeapType, current: ref, n: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, n: int :: (IsHeap(heap)) ==> ((forall <T5> $o: ref, $f: Field T5 :: { modify.SQUARE_ROOT_4.square_root(heap, current, n)[$o, $f] } (modify.SQUARE_ROOT_4.square_root(heap, current, n)[$o, $f]) <==> (false)))));

function read.fun.SQUARE_ROOT_4.square_root(heap: HeapType, current: ref, n: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, n: int :: (IsHeap(heap)) ==> ((forall <T6> $o: ref, $f: Field T6 :: { read.fun.SQUARE_ROOT_4.square_root(heap, current, n)[$o, $f] } (read.fun.SQUARE_ROOT_4.square_root(heap, current, n)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.SQUARE_ROOT_4.square_root(heap: HeapType, current: ref, n: int) returns (bool) {
  ((n) >= (0)) && (is_closed(heap, current))
}

function trigger.fun.SQUARE_ROOT_4.square_root(heap: HeapType, current: ref, n: int) returns (bool);
...
procedure SQUARE_ROOT_4.in_observers(Current: ref, new_observers: Set (ref), o: ref) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, SQUARE_ROOT_4); // info:type property for argument Current
  free requires Set#ItemsType(Heap, new_observers, ANY); // info:type property for argument new_observers
  free requires ((o) != (Void)) && (Heap[o, allocated]); // info:type property for argument o
  modifies Heap;
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.SQUARE_ROOT_4.in_observers(Heap, Current, new_observers, o), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.SQUARE_ROOT_4.in_observers(old(Heap), Current, new_observers, o));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.SQUARE_ROOT_4.in_observers(Heap, Current, new_observers, o), readable);



function fun.SQUARE_ROOT_4.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

function fun0.SQUARE_ROOT_4.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.SQUARE_ROOT_4.in_observers(heap, current, new_observers, o) } { trigger.fun.SQUARE_ROOT_4.in_observers(heap, current, new_observers, o) } (pre.fun.SQUARE_ROOT_4.in_observers(heap, current, new_observers, o)) ==> ((fun.SQUARE_ROOT_4.in_observers(heap, current, new_observers, o)) == ((attached(heap, o, ANY)) && (new_observers[o])))));

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.SQUARE_ROOT_4.in_observers(heap, current, new_observers, o) } (fun.SQUARE_ROOT_4.in_observers(heap, current, new_observers, o)) == (fun0.SQUARE_ROOT_4.in_observers(heap, current, new_observers, o))));

axiom ((forall h: HeapType, h': HeapType, current: ref, new_observers: Set (ref), o: ref :: { HeapSucc(h, h'), fun0.SQUARE_ROOT_4.in_observers(h, current, new_observers, o), fun0.SQUARE_ROOT_4.in_observers(h', current, new_observers, o) } ((HeapSucc(h, h')) && (pre.fun.SQUARE_ROOT_4.in_observers(h, current, new_observers, o)) && (pre.fun.SQUARE_ROOT_4.in_observers(h', current, new_observers, o)) && (same_inside(h, h', read.fun.SQUARE_ROOT_4.in_observers(h, current, new_observers, o)))) ==> ((fun0.SQUARE_ROOT_4.in_observers(h, current, new_observers, o)) == (fun0.SQUARE_ROOT_4.in_observers(h', current, new_observers, o)))));
...
function modify.SQUARE_ROOT_4.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T9> $o: ref, $f: Field T9 :: { modify.SQUARE_ROOT_4.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.SQUARE_ROOT_4.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.SQUARE_ROOT_4.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T10> $o: ref, $f: Field T10 :: { read.fun.SQUARE_ROOT_4.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.SQUARE_ROOT_4.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.SQUARE_ROOT_4.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool) {
  true
}

function trigger.fun.SQUARE_ROOT_4.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);
