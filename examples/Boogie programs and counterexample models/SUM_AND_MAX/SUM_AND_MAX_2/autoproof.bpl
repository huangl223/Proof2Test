// Automatically generated (04/03/2023 9:54:48.001 PM)
...
const unique SUM_AND_MAX_2: Type;

axiom ((SUM_AND_MAX_2) <: (ANY));

axiom ((forall t: Type :: { (SUM_AND_MAX_2) <: (t) } ((SUM_AND_MAX_2) <: (t)) <==> (((t) == (SUM_AND_MAX_2)) || ((ANY) <: (t)))));

axiom ((FieldId(allocated, SUM_AND_MAX_2)) == (-1));

axiom ((FieldId(closed, SUM_AND_MAX_2)) == (-2));

axiom ((FieldId(owner, SUM_AND_MAX_2)) == (-3));

axiom ((FieldId(owns, SUM_AND_MAX_2)) == (-4));

axiom ((FieldId(observers, SUM_AND_MAX_2)) == (-5));

axiom ((FieldId(subjects, SUM_AND_MAX_2)) == (-6));

axiom ((forall <T0> $f: Field T0 :: { IsModelField($f, SUM_AND_MAX_2) } (IsModelField($f, SUM_AND_MAX_2)) <==> ((($f) == (subjects)) || (($f) == (observers)))));

function { :inline } SUM_AND_MAX_2.user_inv(heap: HeapType, current: ref) returns (bool) {
...
axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached_exact(heap, current, SUM_AND_MAX_2)) ==> ((user_inv(heap, current)) <==> (SUM_AND_MAX_2.user_inv(heap, current)))));

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached(heap, current, SUM_AND_MAX_2)) ==> ((user_inv(heap, current)) ==> (SUM_AND_MAX_2.user_inv(heap, current)))));

procedure SUM_AND_MAX_2.invariant_admissibility_check(Current: ref);
  requires attached_exact(Heap, Current, SUM_AND_MAX_2);



implementation SUM_AND_MAX_2.invariant_admissibility_check(Current: ref)
{
  entry:
  goto pre, a2, a3;
  pre:
...
procedure create.SUM_AND_MAX_2.default_create(Current: ref);
  free requires attached_exact(Heap, Current, SUM_AND_MAX_2); // info:type property for argument Current
  modifies Heap;
  ...
  requires Frame#Subset(modify.SUM_AND_MAX_2.default_create(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.SUM_AND_MAX_2.default_create(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts



implementation create.SUM_AND_MAX_2.default_create(Current: ref)
{
  entry:
  assume {:captureState "create.SUM_AND_MAX_2.default_create"} true;
  if (*) {
...
procedure SUM_AND_MAX_2.sum_and_max(Current: ref, a: ref) returns (Result: ref where attached(Heap, Result, TUPLE^INTEGER_32#INTEGER_32^));
  free requires attached_exact(Heap, Current, SUM_AND_MAX_2); // info:type property for argument Current
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.SUM_AND_MAX_2.sum_and_max(Heap, Current, a), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.SUM_AND_MAX_2.sum_and_max(old(Heap), Current, a));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.SUM_AND_MAX_2.sum_and_max(Heap, Current, a), readable);
  ...
  free ensures (Result) == (fun.SUM_AND_MAX_2.sum_and_max(old(Heap), Current, a));



function fun.SUM_AND_MAX_2.sum_and_max(heap: HeapType, current: ref, a: ref) returns (ref);

axiom ((forall heap: HeapType, current: ref, a: ref :: { fun.SUM_AND_MAX_2.sum_and_max(heap, current, a) } (pre.fun.SUM_AND_MAX_2.sum_and_max(heap, current, a)) ==> (((heap[fun.SUM_AND_MAX_2.sum_and_max(heap, current, a), TUPLE^INTEGER_32#INTEGER_32^.field_1]) <= ((fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a)) * (heap[fun.SUM_AND_MAX_2.sum_and_max(heap, current, a), TUPLE^INTEGER_32#INTEGER_32^.field_2]))) && ((forall i_4: int :: (((1) <= (i_4)) && ((i_4) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a)))) ==> ((heap[fun.SUM_AND_MAX_2.sum_and_max(heap, current, a), TUPLE^INTEGER_32#INTEGER_32^.field_2]) >= (Seq#Item(heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_4))))) && (attached(heap, fun.SUM_AND_MAX_2.sum_and_max(heap, current, a), TUPLE^INTEGER_32#INTEGER_32^)))));

axiom ((forall h: HeapType, h': HeapType, current: ref, a: ref :: { HeapSucc(h, h'), fun.SUM_AND_MAX_2.sum_and_max(h, current, a), fun.SUM_AND_MAX_2.sum_and_max(h', current, a) } ((HeapSucc(h, h')) && (pre.fun.SUM_AND_MAX_2.sum_and_max(h, current, a)) && (pre.fun.SUM_AND_MAX_2.sum_and_max(h', current, a)) && (same_inside(h, h', read.fun.SUM_AND_MAX_2.sum_and_max(h, current, a)))) ==> ((fun.SUM_AND_MAX_2.sum_and_max(h, current, a)) == (fun.SUM_AND_MAX_2.sum_and_max(h', current, a)))));

function { :inline } variant.SUM_AND_MAX_2.sum_and_max.1(heap: HeapType, current: ref, a: ref) returns (ref) {
  a
}

implementation SUM_AND_MAX_2.sum_and_max(Current: ref, a: ref) returns (Result: ref)
{
  ...
  entry:
  assume {:captureState "SUM_AND_MAX_2.sum_and_max"} true;
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_2.e:22
  // i := 1
  local1 := 1;
  PreLoopHeap_8 := Heap;
  goto loop_head_5;
  loop_head_5:
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_2.e:25
  ...
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_2.e:26
  // sum_and_max_not_negative: sum >= 0 and max >= 0
  assert ((local2) >= (0)) && ((local3) >= (0)); // type:loop_inv tag:sum_and_max_not_negative line:26
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_2.e:27
  // partial_sum_and_max: sum <= (i - 1) * max
  assert (local2) <= (((local1) - (1)) * (local3)); // type:loop_inv tag:partial_sum_and_max line:27
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_2.e:28
  ...
  assume same_outside(old(Heap), Heap, modify.SUM_AND_MAX_2.sum_and_max(old(Heap), Current, a));
  assume global(Heap);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_2.e:-1
  ...
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_2.e:33
  // if a [i] > max then
  ...
  if ((temp_11) > (local3)) {
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_2.e:34
    // max := a [i]
  ...
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_2.e:36
  // sum := sum + a [i]
  ...
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_2.e:37
  // i := i + 1
  local1 := (local1) + (1);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_2.e:33
  // if a [i] > max then
  ...
  loop_end_7:
  assume (local1) >= (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a));
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_2.e:39
  // Result := [sum, max]
...
axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, owns, v, o) } (attached_exact(heap, current, SUM_AND_MAX_2)) ==> ((guard(heap, current, owns, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, subjects, v, o) } (attached_exact(heap, current, SUM_AND_MAX_2)) ==> ((guard(heap, current, subjects, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached_exact(heap, current, SUM_AND_MAX_2)) ==> ((guard(heap, current, observers, v, o)) <==> (fun.SUM_AND_MAX_2.in_observers(heap, current, v, o)))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached(heap, current, SUM_AND_MAX_2)) ==> ((guard(heap, current, observers, v, o)) ==> (fun.SUM_AND_MAX_2.in_observers(heap, current, v, o)))));

function modify.SUM_AND_MAX_2.default_create(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T3> $o: ref, $f: Field T3 :: { modify.SUM_AND_MAX_2.default_create(heap, current)[$o, $f] } (modify.SUM_AND_MAX_2.default_create(heap, current)[$o, $f]) <==> (($o) == (current))))));
...
function modify.SUM_AND_MAX_2.sum_and_max(heap: HeapType, current: ref, a: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: ref :: (IsHeap(heap)) ==> ((forall <T6> $o: ref, $f: Field T6 :: { modify.SUM_AND_MAX_2.sum_and_max(heap, current, a)[$o, $f] } (modify.SUM_AND_MAX_2.sum_and_max(heap, current, a)[$o, $f]) <==> (false)))));

function read.fun.SUM_AND_MAX_2.sum_and_max(heap: HeapType, current: ref, a: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: ref :: (IsHeap(heap)) ==> ((forall <T7> $o: ref, $f: Field T7 :: { read.fun.SUM_AND_MAX_2.sum_and_max(heap, current, a)[$o, $f] } (read.fun.SUM_AND_MAX_2.sum_and_max(heap, current, a)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.SUM_AND_MAX_2.sum_and_max(heap: HeapType, current: ref, a: ref) returns (bool) {
  ((a) != (Void)) && ((forall i_15: int :: (((1) <= (i_15)) && ((i_15) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a)))) ==> ((Seq#Item(heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_15)) >= (0)))) && (is_closed(heap, current)) && (is_closed(heap, a))
}

function trigger.fun.SUM_AND_MAX_2.sum_and_max(heap: HeapType, current: ref, a: ref) returns (bool);
...
procedure SUM_AND_MAX_2.in_observers(Current: ref, new_observers: Set (ref), o: ref) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, SUM_AND_MAX_2); // info:type property for argument Current
  free requires Set#ItemsType(Heap, new_observers, ANY); // info:type property for argument new_observers
  free requires ((o) != (Void)) && (Heap[o, allocated]); // info:type property for argument o
  modifies Heap;
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.SUM_AND_MAX_2.in_observers(Heap, Current, new_observers, o), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.SUM_AND_MAX_2.in_observers(old(Heap), Current, new_observers, o));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.SUM_AND_MAX_2.in_observers(Heap, Current, new_observers, o), readable);



function fun.SUM_AND_MAX_2.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

function fun0.SUM_AND_MAX_2.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.SUM_AND_MAX_2.in_observers(heap, current, new_observers, o) } { trigger.fun.SUM_AND_MAX_2.in_observers(heap, current, new_observers, o) } (pre.fun.SUM_AND_MAX_2.in_observers(heap, current, new_observers, o)) ==> ((fun.SUM_AND_MAX_2.in_observers(heap, current, new_observers, o)) == ((attached(heap, o, ANY)) && (new_observers[o])))));

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.SUM_AND_MAX_2.in_observers(heap, current, new_observers, o) } (fun.SUM_AND_MAX_2.in_observers(heap, current, new_observers, o)) == (fun0.SUM_AND_MAX_2.in_observers(heap, current, new_observers, o))));

axiom ((forall h: HeapType, h': HeapType, current: ref, new_observers: Set (ref), o: ref :: { HeapSucc(h, h'), fun0.SUM_AND_MAX_2.in_observers(h, current, new_observers, o), fun0.SUM_AND_MAX_2.in_observers(h', current, new_observers, o) } ((HeapSucc(h, h')) && (pre.fun.SUM_AND_MAX_2.in_observers(h, current, new_observers, o)) && (pre.fun.SUM_AND_MAX_2.in_observers(h', current, new_observers, o)) && (same_inside(h, h', read.fun.SUM_AND_MAX_2.in_observers(h, current, new_observers, o)))) ==> ((fun0.SUM_AND_MAX_2.in_observers(h, current, new_observers, o)) == (fun0.SUM_AND_MAX_2.in_observers(h', current, new_observers, o)))));
...
function modify.SUM_AND_MAX_2.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T14> $o: ref, $f: Field T14 :: { modify.SUM_AND_MAX_2.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.SUM_AND_MAX_2.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.SUM_AND_MAX_2.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T15> $o: ref, $f: Field T15 :: { read.fun.SUM_AND_MAX_2.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.SUM_AND_MAX_2.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.SUM_AND_MAX_2.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool) {
  true
}

function trigger.fun.SUM_AND_MAX_2.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);
