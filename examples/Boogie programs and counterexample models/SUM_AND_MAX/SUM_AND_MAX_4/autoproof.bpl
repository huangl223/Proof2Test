// Automatically generated (04/04/2023 8:50:12.966 AM)
...
const unique SUM_AND_MAX_4: Type;

axiom ((SUM_AND_MAX_4) <: (ANY));

axiom ((forall t: Type :: { (SUM_AND_MAX_4) <: (t) } ((SUM_AND_MAX_4) <: (t)) <==> (((t) == (SUM_AND_MAX_4)) || ((ANY) <: (t)))));

axiom ((FieldId(allocated, SUM_AND_MAX_4)) == (-1));

axiom ((FieldId(closed, SUM_AND_MAX_4)) == (-2));

axiom ((FieldId(owner, SUM_AND_MAX_4)) == (-3));

axiom ((FieldId(owns, SUM_AND_MAX_4)) == (-4));

axiom ((FieldId(observers, SUM_AND_MAX_4)) == (-5));

axiom ((FieldId(subjects, SUM_AND_MAX_4)) == (-6));

axiom ((forall <T0> $f: Field T0 :: { IsModelField($f, SUM_AND_MAX_4) } (IsModelField($f, SUM_AND_MAX_4)) <==> ((($f) == (subjects)) || (($f) == (observers)))));

function { :inline } SUM_AND_MAX_4.user_inv(heap: HeapType, current: ref) returns (bool) {
...
axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached_exact(heap, current, SUM_AND_MAX_4)) ==> ((user_inv(heap, current)) <==> (SUM_AND_MAX_4.user_inv(heap, current)))));

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached(heap, current, SUM_AND_MAX_4)) ==> ((user_inv(heap, current)) ==> (SUM_AND_MAX_4.user_inv(heap, current)))));

procedure SUM_AND_MAX_4.invariant_admissibility_check(Current: ref);
  requires attached_exact(Heap, Current, SUM_AND_MAX_4);



implementation SUM_AND_MAX_4.invariant_admissibility_check(Current: ref)
{
  entry:
  goto pre, a2, a3;
  pre:
...
procedure create.SUM_AND_MAX_4.default_create(Current: ref);
  free requires attached_exact(Heap, Current, SUM_AND_MAX_4); // info:type property for argument Current
  modifies Heap;
  ...
  requires Frame#Subset(modify.SUM_AND_MAX_4.default_create(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.SUM_AND_MAX_4.default_create(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts



implementation create.SUM_AND_MAX_4.default_create(Current: ref)
{
  entry:
  assume {:captureState "create.SUM_AND_MAX_4.default_create"} true;
  if (*) {
...
procedure SUM_AND_MAX_4.sum_and_max(Current: ref, a: ref) returns (Result: ref where attached(Heap, Result, TUPLE^INTEGER_32#INTEGER_32^));
  free requires attached_exact(Heap, Current, SUM_AND_MAX_4); // info:type property for argument Current
  ...
  requires pre.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a); // type:check tag:function_precondition line:15 cid:82 rid:3798
  requires (forall i_1: int :: (((1) <= (i_1)) && ((i_1) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_1))); // type:check tag:function_precondition line:15 cid:81 rid:3811
  ...
  requires (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) > (0); // type:pre tag:array_not_empty line:16
  ensures (Result) != (Void); // type:attached tag:sum_in_range line:40
  ensures (a) != (Void); // type:attached tag:sum_in_range line:40
  ensures pre.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a); // type:check tag:function_precondition line:40 cid:82 rid:3798
  ensures (Heap[Result, TUPLE^INTEGER_32#INTEGER_32^.field_1]) <= ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) * (Heap[Result, TUPLE^INTEGER_32#INTEGER_32^.field_2])); // type:post tag:sum_in_range line:40
  ensures (forall i_2: int :: (((1) <= (i_2)) && ((i_2) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_2))); // type:check tag:function_precondition line:41 cid:81 rid:3811
  ensures (forall i_2: int :: (((1) <= (i_2)) && ((i_2) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)))) ==> ((Heap[Result, TUPLE^INTEGER_32#INTEGER_32^.field_2]) >= (Seq#Item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_2)))); // type:post tag:is_maximum line:41
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.SUM_AND_MAX_4.sum_and_max(Heap, Current, a), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.SUM_AND_MAX_4.sum_and_max(old(Heap), Current, a));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.SUM_AND_MAX_4.sum_and_max(Heap, Current, a), readable);
  ...
  free ensures (Result) == (fun.SUM_AND_MAX_4.sum_and_max(old(Heap), Current, a));



function fun.SUM_AND_MAX_4.sum_and_max(heap: HeapType, current: ref, a: ref) returns (ref);

axiom ((forall heap: HeapType, current: ref, a: ref :: { fun.SUM_AND_MAX_4.sum_and_max(heap, current, a) } (pre.fun.SUM_AND_MAX_4.sum_and_max(heap, current, a)) ==> (((heap[fun.SUM_AND_MAX_4.sum_and_max(heap, current, a), TUPLE^INTEGER_32#INTEGER_32^.field_1]) <= ((fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a)) * (heap[fun.SUM_AND_MAX_4.sum_and_max(heap, current, a), TUPLE^INTEGER_32#INTEGER_32^.field_2]))) && ((forall i_4: int :: (((1) <= (i_4)) && ((i_4) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a)))) ==> ((heap[fun.SUM_AND_MAX_4.sum_and_max(heap, current, a), TUPLE^INTEGER_32#INTEGER_32^.field_2]) >= (Seq#Item(heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_4))))) && (attached(heap, fun.SUM_AND_MAX_4.sum_and_max(heap, current, a), TUPLE^INTEGER_32#INTEGER_32^)))));

axiom ((forall h: HeapType, h': HeapType, current: ref, a: ref :: { HeapSucc(h, h'), fun.SUM_AND_MAX_4.sum_and_max(h, current, a), fun.SUM_AND_MAX_4.sum_and_max(h', current, a) } ((HeapSucc(h, h')) && (pre.fun.SUM_AND_MAX_4.sum_and_max(h, current, a)) && (pre.fun.SUM_AND_MAX_4.sum_and_max(h', current, a)) && (same_inside(h, h', read.fun.SUM_AND_MAX_4.sum_and_max(h, current, a)))) ==> ((fun.SUM_AND_MAX_4.sum_and_max(h, current, a)) == (fun.SUM_AND_MAX_4.sum_and_max(h', current, a)))));

function { :inline } variant.SUM_AND_MAX_4.sum_and_max.1(heap: HeapType, current: ref, a: ref) returns (ref) {
  a
}

implementation SUM_AND_MAX_4.sum_and_max(Current: ref, a: ref) returns (Result: ref)
{
  var temp_8: int;
  var temp_9: int;
  ...
  entry:
  assume {:captureState "SUM_AND_MAX_4.sum_and_max"} true;
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_4.e:22
  // i := 1; max := a[1]; sum := a[1]
  local1 := 1;
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_4.e:22
  // i := 1; max := a[1]; sum := a[1]
  assert {:subsumption 0} (a) != (Void); // type:attached line:22
  assert Frame#Subset(read.fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, 1), readable); // type:access tag:frame_readable line:22 cid:82 rid:3799
  call temp_8 := SIMPLE_ARRAY^INTEGER_32^.item(a, 1); // line:22 cid:82 rid:3799
  local3 := temp_8;
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_4.e:22
  // i := 1; max := a[1]; sum := a[1]
  assert {:subsumption 0} (a) != (Void); // type:attached line:22
  assert Frame#Subset(read.fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, 1), readable); // type:access tag:frame_readable line:22 cid:82 rid:3799
  call temp_9 := SIMPLE_ARRAY^INTEGER_32^.item(a, 1); // line:22 cid:82 rid:3799
  local2 := temp_9;
  PreLoopHeap_10 := Heap;
  goto loop_head_5;
  loop_head_5:
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_4.e:24
  // i_in_range: 1 <= i and i <= a.count + 1
  assert {:subsumption 0} (a) != (Void); // type:attached line:24
  assert Frame#Subset(read.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a), readable); // type:access tag:frame_readable line:24 cid:82 rid:3798
  assert pre.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a); // type:check tag:function_precondition line:24 cid:82 rid:3798
  assert ((1) <= (local1)) && ((local1) <= ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1))); // type:loop_inv tag:i_in_range line:24
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_4.e:25
  // sum_and_max_not_negative: sum >= 0 and max >= 0
  assert ((local2) >= (0)) && ((local3) >= (0)); // type:loop_inv tag:sum_and_max_not_negative line:25
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_4.e:26
  // partial_sum_and_max: sum <= (i - 1) * max
  assert (local2) <= (((local1) - (1)) * (local3)); // type:loop_inv tag:partial_sum_and_max line:26
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_4.e:27
  ...
  assert (forall i_11: int :: (((1) <= (i_11)) && ((i_11) <= ((local1) - (1)))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_11))); // type:check tag:function_precondition line:27 cid:81 rid:3811
  assert (forall i_11: int :: (((1) <= (i_11)) && ((i_11) <= ((local1) - (1)))) ==> ((local3) >= (Seq#Item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_11)))); // type:loop_inv tag:max_so_far line:27
  assume HeapSucc(PreLoopHeap_10, Heap);
  assume same_outside(old(Heap), Heap, modify.SUM_AND_MAX_4.sum_and_max(old(Heap), Current, a));
  assume global(Heap);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_4.e:-1
  assert {:subsumption 0} (a) != (Void); // type:attached line:-1
  assert Frame#Subset(read.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a), readable); // type:access tag:frame_readable line:-1 cid:82 rid:3798
  assert pre.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a); // type:check tag:function_precondition line:-1 cid:82 rid:3798
  goto loop_body_6, loop_end_7;
  loop_body_6:
  assume !((local1) > (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)));
  variant_12 := (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (local1);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_4.e:32
  // if a [i] > max then
  assert {:subsumption 0} (a) != (Void); // type:attached line:32
  assert Frame#Subset(read.fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, local1), readable); // type:access tag:frame_readable line:32 cid:82 rid:3799
  call temp_13 := SIMPLE_ARRAY^INTEGER_32^.item(a, local1); // line:32 cid:82 rid:3799
  if ((temp_13) > (local3)) {
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_4.e:33
    // max := a [i]
    assert {:subsumption 0} (a) != (Void); // type:attached line:33
    assert Frame#Subset(read.fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, local1), readable); // type:access tag:frame_readable line:33 cid:82 rid:3799
    call temp_14 := SIMPLE_ARRAY^INTEGER_32^.item(a, local1); // line:33 cid:82 rid:3799
    local3 := temp_14;
  }
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_4.e:35
  // sum := sum + a [i]
  assert {:subsumption 0} (a) != (Void); // type:attached line:35
  assert Frame#Subset(read.fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, local1), readable); // type:access tag:frame_readable line:35 cid:82 rid:3799
  call temp_15 := SIMPLE_ARRAY^INTEGER_32^.item(a, local1); // line:35 cid:82 rid:3799
  local2 := (local2) + (temp_15);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_4.e:36
  // i := i + 1
  local1 := (local1) + (1);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_4.e:32
  // if a [i] > max then
  assert {:subsumption 0} ((((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (local1)) <= (variant_12)) && ((variant_12) <= ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (local1)))) || ((0) <= (variant_12)); // type:termination tag:bounded line:32 varid:1
  assert {:subsumption 0} (((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (local1)) <= (variant_12)) && (!((variant_12) <= ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (local1)))); // type:termination tag:variant_decreases line:32
  goto loop_head_5;
  loop_end_7:
  assume (local1) > (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a));
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_4.e:38
  // Result := [sum, max]
  call temp_16 := allocate(TUPLE^INTEGER_32#INTEGER_32^); // line:-1
  call create.TUPLE^INTEGER_32#INTEGER_32^.make(temp_16, local2, local3);
  Result := temp_16;
}
...
axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, owns, v, o) } (attached_exact(heap, current, SUM_AND_MAX_4)) ==> ((guard(heap, current, owns, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, subjects, v, o) } (attached_exact(heap, current, SUM_AND_MAX_4)) ==> ((guard(heap, current, subjects, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached_exact(heap, current, SUM_AND_MAX_4)) ==> ((guard(heap, current, observers, v, o)) <==> (fun.SUM_AND_MAX_4.in_observers(heap, current, v, o)))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached(heap, current, SUM_AND_MAX_4)) ==> ((guard(heap, current, observers, v, o)) ==> (fun.SUM_AND_MAX_4.in_observers(heap, current, v, o)))));

function modify.SUM_AND_MAX_4.default_create(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T3> $o: ref, $f: Field T3 :: { modify.SUM_AND_MAX_4.default_create(heap, current)[$o, $f] } (modify.SUM_AND_MAX_4.default_create(heap, current)[$o, $f]) <==> (($o) == (current))))));
...
function modify.SUM_AND_MAX_4.sum_and_max(heap: HeapType, current: ref, a: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: ref :: (IsHeap(heap)) ==> ((forall <T6> $o: ref, $f: Field T6 :: { modify.SUM_AND_MAX_4.sum_and_max(heap, current, a)[$o, $f] } (modify.SUM_AND_MAX_4.sum_and_max(heap, current, a)[$o, $f]) <==> (false)))));

function read.fun.SUM_AND_MAX_4.sum_and_max(heap: HeapType, current: ref, a: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: ref :: (IsHeap(heap)) ==> ((forall <T7> $o: ref, $f: Field T7 :: { read.fun.SUM_AND_MAX_4.sum_and_max(heap, current, a)[$o, $f] } (read.fun.SUM_AND_MAX_4.sum_and_max(heap, current, a)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.SUM_AND_MAX_4.sum_and_max(heap: HeapType, current: ref, a: ref) returns (bool) {
  ((a) != (Void)) && ((forall i_17: int :: (((1) <= (i_17)) && ((i_17) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a)))) ==> ((Seq#Item(heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_17)) >= (0)))) && ((fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a)) > (0)) && (is_closed(heap, current)) && (is_closed(heap, a))
}

function trigger.fun.SUM_AND_MAX_4.sum_and_max(heap: HeapType, current: ref, a: ref) returns (bool);
...
procedure SUM_AND_MAX_4.in_observers(Current: ref, new_observers: Set (ref), o: ref) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, SUM_AND_MAX_4); // info:type property for argument Current
  free requires Set#ItemsType(Heap, new_observers, ANY); // info:type property for argument new_observers
  free requires ((o) != (Void)) && (Heap[o, allocated]); // info:type property for argument o
  modifies Heap;
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.SUM_AND_MAX_4.in_observers(Heap, Current, new_observers, o), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.SUM_AND_MAX_4.in_observers(old(Heap), Current, new_observers, o));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.SUM_AND_MAX_4.in_observers(Heap, Current, new_observers, o), readable);



function fun.SUM_AND_MAX_4.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

function fun0.SUM_AND_MAX_4.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.SUM_AND_MAX_4.in_observers(heap, current, new_observers, o) } { trigger.fun.SUM_AND_MAX_4.in_observers(heap, current, new_observers, o) } (pre.fun.SUM_AND_MAX_4.in_observers(heap, current, new_observers, o)) ==> ((fun.SUM_AND_MAX_4.in_observers(heap, current, new_observers, o)) == ((attached(heap, o, ANY)) && (new_observers[o])))));

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.SUM_AND_MAX_4.in_observers(heap, current, new_observers, o) } (fun.SUM_AND_MAX_4.in_observers(heap, current, new_observers, o)) == (fun0.SUM_AND_MAX_4.in_observers(heap, current, new_observers, o))));

axiom ((forall h: HeapType, h': HeapType, current: ref, new_observers: Set (ref), o: ref :: { HeapSucc(h, h'), fun0.SUM_AND_MAX_4.in_observers(h, current, new_observers, o), fun0.SUM_AND_MAX_4.in_observers(h', current, new_observers, o) } ((HeapSucc(h, h')) && (pre.fun.SUM_AND_MAX_4.in_observers(h, current, new_observers, o)) && (pre.fun.SUM_AND_MAX_4.in_observers(h', current, new_observers, o)) && (same_inside(h, h', read.fun.SUM_AND_MAX_4.in_observers(h, current, new_observers, o)))) ==> ((fun0.SUM_AND_MAX_4.in_observers(h, current, new_observers, o)) == (fun0.SUM_AND_MAX_4.in_observers(h', current, new_observers, o)))));
...
axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T8> $o: ref, $f: Field T8 :: { modify.SIMPLE_ARRAY^INTEGER_32^.count(heap, current)[$o, $f] } (modify.SIMPLE_ARRAY^INTEGER_32^.count(heap, current)[$o, $f]) <==> (false)))));

function read.fun.SIMPLE_ARRAY^INTEGER_32^.count(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T9> $o: ref, $f: Field T9 :: { read.fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, current)[$o, $f] } (read.fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, current)[$o, $f]) <==> ((($o) == (current)) && (($f) != (closed)) && (($f) != (owner)))))));
...
axiom ((forall heap: HeapType, current: ref, i: int :: (IsHeap(heap)) ==> ((forall <T10> $o: ref, $f: Field T10 :: { modify.SIMPLE_ARRAY^INTEGER_32^.item(heap, current, i)[$o, $f] } (modify.SIMPLE_ARRAY^INTEGER_32^.item(heap, current, i)[$o, $f]) <==> (false)))));

function read.fun.SIMPLE_ARRAY^INTEGER_32^.item(heap: HeapType, current: ref, i: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, i: int :: (IsHeap(heap)) ==> ((forall <T11> $o: ref, $f: Field T11 :: { read.fun.SIMPLE_ARRAY^INTEGER_32^.item(heap, current, i)[$o, $f] } (read.fun.SIMPLE_ARRAY^INTEGER_32^.item(heap, current, i)[$o, $f]) <==> ((($o) == (current)) && (($f) != (closed)) && (($f) != (owner)))))));
...
function modify.SUM_AND_MAX_4.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T14> $o: ref, $f: Field T14 :: { modify.SUM_AND_MAX_4.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.SUM_AND_MAX_4.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.SUM_AND_MAX_4.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T15> $o: ref, $f: Field T15 :: { read.fun.SUM_AND_MAX_4.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.SUM_AND_MAX_4.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.SUM_AND_MAX_4.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool) {
  true
}

function trigger.fun.SUM_AND_MAX_4.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);
...
axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T16> $o: ref, $f: Field T16 :: { modify.SIMPLE_ARRAY^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.SIMPLE_ARRAY^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));
...
axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T17> $o: ref, $f: Field T17 :: { read.fun.SIMPLE_ARRAY^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.SIMPLE_ARRAY^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));
...
axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T18> $o: ref, $f: Field T18 :: { modify.TUPLE^INTEGER_32#INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.TUPLE^INTEGER_32#INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));
...
axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T19> $o: ref, $f: Field T19 :: { read.fun.TUPLE^INTEGER_32#INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.TUPLE^INTEGER_32#INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));
