// Automatically generated (04/04/2023 9:00:15.362 AM)
...
const unique SUM_AND_MAX_5: Type;

axiom ((SUM_AND_MAX_5) <: (ANY));

axiom ((forall t: Type :: { (SUM_AND_MAX_5) <: (t) } ((SUM_AND_MAX_5) <: (t)) <==> (((t) == (SUM_AND_MAX_5)) || ((ANY) <: (t)))));

axiom ((FieldId(allocated, SUM_AND_MAX_5)) == (-1));

axiom ((FieldId(closed, SUM_AND_MAX_5)) == (-2));

axiom ((FieldId(owner, SUM_AND_MAX_5)) == (-3));

axiom ((FieldId(owns, SUM_AND_MAX_5)) == (-4));

axiom ((FieldId(observers, SUM_AND_MAX_5)) == (-5));

axiom ((FieldId(subjects, SUM_AND_MAX_5)) == (-6));

axiom ((forall <T0> $f: Field T0 :: { IsModelField($f, SUM_AND_MAX_5) } (IsModelField($f, SUM_AND_MAX_5)) <==> ((($f) == (subjects)) || (($f) == (observers)))));

function { :inline } SUM_AND_MAX_5.user_inv(heap: HeapType, current: ref) returns (bool) {
...
axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached_exact(heap, current, SUM_AND_MAX_5)) ==> ((user_inv(heap, current)) <==> (SUM_AND_MAX_5.user_inv(heap, current)))));

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached(heap, current, SUM_AND_MAX_5)) ==> ((user_inv(heap, current)) ==> (SUM_AND_MAX_5.user_inv(heap, current)))));

procedure SUM_AND_MAX_5.invariant_admissibility_check(Current: ref);
  requires attached_exact(Heap, Current, SUM_AND_MAX_5);



implementation SUM_AND_MAX_5.invariant_admissibility_check(Current: ref)
{
  entry:
  goto pre, a2, a3;
  pre:
...
procedure create.SUM_AND_MAX_5.default_create(Current: ref);
  free requires attached_exact(Heap, Current, SUM_AND_MAX_5); // info:type property for argument Current
  modifies Heap;
  ...
  requires Frame#Subset(modify.SUM_AND_MAX_5.default_create(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.SUM_AND_MAX_5.default_create(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts



implementation create.SUM_AND_MAX_5.default_create(Current: ref)
{
  entry:
  assume {:captureState "create.SUM_AND_MAX_5.default_create"} true;
  if (*) {
...
procedure SUM_AND_MAX_5.sum_and_max(Current: ref, a: ref) returns (Result: ref where attached(Heap, Result, TUPLE^INTEGER_32#INTEGER_32^));
  free requires attached_exact(Heap, Current, SUM_AND_MAX_5); // info:type property for argument Current
  ...
  requires pre.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a); // type:check tag:function_precondition line:16 cid:82 rid:3798
  ...
  ensures (forall i_1: int :: (((1) <= (i_1)) && ((i_1) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_1))); // type:check tag:function_precondition line:41 cid:81 rid:3811
  ensures (forall i_1: int :: (((1) <= (i_1)) && ((i_1) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)))) ==> ((Heap[Result, TUPLE^INTEGER_32#INTEGER_32^.field_2]) >= (Seq#Item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_1)))); // type:post tag:is_maximum line:41
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.SUM_AND_MAX_5.sum_and_max(Heap, Current, a), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.SUM_AND_MAX_5.sum_and_max(old(Heap), Current, a));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.SUM_AND_MAX_5.sum_and_max(Heap, Current, a), readable);
  ...
  free ensures (Result) == (fun.SUM_AND_MAX_5.sum_and_max(old(Heap), Current, a));



function fun.SUM_AND_MAX_5.sum_and_max(heap: HeapType, current: ref, a: ref) returns (ref);

axiom ((forall heap: HeapType, current: ref, a: ref :: { fun.SUM_AND_MAX_5.sum_and_max(heap, current, a) } (pre.fun.SUM_AND_MAX_5.sum_and_max(heap, current, a)) ==> (((heap[fun.SUM_AND_MAX_5.sum_and_max(heap, current, a), TUPLE^INTEGER_32#INTEGER_32^.field_1]) <= ((fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a)) * (heap[fun.SUM_AND_MAX_5.sum_and_max(heap, current, a), TUPLE^INTEGER_32#INTEGER_32^.field_2]))) && ((forall i_2: int :: (((1) <= (i_2)) && ((i_2) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a)))) ==> ((heap[fun.SUM_AND_MAX_5.sum_and_max(heap, current, a), TUPLE^INTEGER_32#INTEGER_32^.field_2]) >= (Seq#Item(heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_2))))) && (attached(heap, fun.SUM_AND_MAX_5.sum_and_max(heap, current, a), TUPLE^INTEGER_32#INTEGER_32^)))));

axiom ((forall h: HeapType, h': HeapType, current: ref, a: ref :: { HeapSucc(h, h'), fun.SUM_AND_MAX_5.sum_and_max(h, current, a), fun.SUM_AND_MAX_5.sum_and_max(h', current, a) } ((HeapSucc(h, h')) && (pre.fun.SUM_AND_MAX_5.sum_and_max(h, current, a)) && (pre.fun.SUM_AND_MAX_5.sum_and_max(h', current, a)) && (same_inside(h, h', read.fun.SUM_AND_MAX_5.sum_and_max(h, current, a)))) ==> ((fun.SUM_AND_MAX_5.sum_and_max(h, current, a)) == (fun.SUM_AND_MAX_5.sum_and_max(h', current, a)))));

function { :inline } variant.SUM_AND_MAX_5.sum_and_max.1(heap: HeapType, current: ref, a: ref) returns (ref) {
  a
}

implementation SUM_AND_MAX_5.sum_and_max(Current: ref, a: ref) returns (Result: ref)
{
  ...
  entry:
  assume {:captureState "SUM_AND_MAX_5.sum_and_max"} true;
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_5.e:22
  // i := 1
  local1 := 1;
  PreLoopHeap_6 := Heap;
  goto loop_head_3;
  loop_head_3:
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_5.e:25
  ...
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_5.e:26
  // sum_and_max_not_negative: sum >= 0 and max >= 0
  assert ((local2) >= (0)) && ((local3) >= (0)); // type:loop_inv tag:sum_and_max_not_negative line:26
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_5.e:27
  // partial_sum_and_max: sum <= (i - 1) * max
  assert (local2) <= (((local1) - (1)) * (local3)); // type:loop_inv tag:partial_sum_and_max line:27
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_5.e:28
  ...
  assert (forall i_7: int :: (((1) <= (i_7)) && ((i_7) <= ((local1) - (1)))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_7))); // type:check tag:function_precondition line:28 cid:81 rid:3811
  assert (forall i_7: int :: (((1) <= (i_7)) && ((i_7) <= ((local1) - (1)))) ==> ((local3) >= (Seq#Item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_7)))); // type:loop_inv tag:max_so_far line:28
  assume HeapSucc(PreLoopHeap_6, Heap);
  assume same_outside(old(Heap), Heap, modify.SUM_AND_MAX_5.sum_and_max(old(Heap), Current, a));
  assume global(Heap);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_5.e:-1
  ...
  variant_8 := (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (local1);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_5.e:32
  // if a [i] > max then
  ...
  call temp_9 := SIMPLE_ARRAY^INTEGER_32^.item(a, local1); // line:32 cid:82 rid:3799
  if ((temp_9) > (local3)) {
    // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_5.e:33
    // max := a [i]
    ...
    call temp_10 := SIMPLE_ARRAY^INTEGER_32^.item(a, local1); // line:33 cid:82 rid:3799
    local3 := temp_10;
  }
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_5.e:35
  // sum := sum + a [i]
  ...
  call temp_11 := SIMPLE_ARRAY^INTEGER_32^.item(a, local1); // line:35 cid:82 rid:3799
  local2 := (local2) + (temp_11);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_5.e:36
  // i := i + 1
  local1 := (local1) + (1);
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_5.e:32
  // if a [i] > max then
  assert {:subsumption 0} ((((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (local1)) <= (variant_8)) && ((variant_8) <= ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (local1)))) || ((0) <= (variant_8)); // type:termination tag:bounded line:32 varid:1
  assert {:subsumption 0} (((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (local1)) <= (variant_8)) && (!((variant_8) <= ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (local1)))); // type:termination tag:variant_decreases line:32
  goto loop_head_3;
  loop_end_5:
  assume (local1) > (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a));
  // C:\Users\HP\Documents\GitHub\Proof2Test\examples\algorithms\sum_and_max\sum_and_max_5.e:38
  // Result := [sum, max]
  call temp_12 := allocate(TUPLE^INTEGER_32#INTEGER_32^); // line:-1
  call create.TUPLE^INTEGER_32#INTEGER_32^.make(temp_12, local2, local3);
  Result := temp_12;
}
...
axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, owns, v, o) } (attached_exact(heap, current, SUM_AND_MAX_5)) ==> ((guard(heap, current, owns, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, subjects, v, o) } (attached_exact(heap, current, SUM_AND_MAX_5)) ==> ((guard(heap, current, subjects, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached_exact(heap, current, SUM_AND_MAX_5)) ==> ((guard(heap, current, observers, v, o)) <==> (fun.SUM_AND_MAX_5.in_observers(heap, current, v, o)))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached(heap, current, SUM_AND_MAX_5)) ==> ((guard(heap, current, observers, v, o)) ==> (fun.SUM_AND_MAX_5.in_observers(heap, current, v, o)))));

function modify.SUM_AND_MAX_5.default_create(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T3> $o: ref, $f: Field T3 :: { modify.SUM_AND_MAX_5.default_create(heap, current)[$o, $f] } (modify.SUM_AND_MAX_5.default_create(heap, current)[$o, $f]) <==> (($o) == (current))))));
...
function modify.SUM_AND_MAX_5.sum_and_max(heap: HeapType, current: ref, a: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: ref :: (IsHeap(heap)) ==> ((forall <T6> $o: ref, $f: Field T6 :: { modify.SUM_AND_MAX_5.sum_and_max(heap, current, a)[$o, $f] } (modify.SUM_AND_MAX_5.sum_and_max(heap, current, a)[$o, $f]) <==> (false)))));

function read.fun.SUM_AND_MAX_5.sum_and_max(heap: HeapType, current: ref, a: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: ref :: (IsHeap(heap)) ==> ((forall <T7> $o: ref, $f: Field T7 :: { read.fun.SUM_AND_MAX_5.sum_and_max(heap, current, a)[$o, $f] } (read.fun.SUM_AND_MAX_5.sum_and_max(heap, current, a)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.SUM_AND_MAX_5.sum_and_max(heap: HeapType, current: ref, a: ref) returns (bool) {
  ((a) != (Void)) && ((fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a)) > (0)) && (is_closed(heap, current)) && (is_closed(heap, a))
}

function trigger.fun.SUM_AND_MAX_5.sum_and_max(heap: HeapType, current: ref, a: ref) returns (bool);
...
procedure SUM_AND_MAX_5.in_observers(Current: ref, new_observers: Set (ref), o: ref) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, SUM_AND_MAX_5); // info:type property for argument Current
  free requires Set#ItemsType(Heap, new_observers, ANY); // info:type property for argument new_observers
  free requires ((o) != (Void)) && (Heap[o, allocated]); // info:type property for argument o
  modifies Heap;
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.SUM_AND_MAX_5.in_observers(Heap, Current, new_observers, o), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.SUM_AND_MAX_5.in_observers(old(Heap), Current, new_observers, o));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.SUM_AND_MAX_5.in_observers(Heap, Current, new_observers, o), readable);



function fun.SUM_AND_MAX_5.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

function fun0.SUM_AND_MAX_5.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.SUM_AND_MAX_5.in_observers(heap, current, new_observers, o) } { trigger.fun.SUM_AND_MAX_5.in_observers(heap, current, new_observers, o) } (pre.fun.SUM_AND_MAX_5.in_observers(heap, current, new_observers, o)) ==> ((fun.SUM_AND_MAX_5.in_observers(heap, current, new_observers, o)) == ((attached(heap, o, ANY)) && (new_observers[o])))));

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.SUM_AND_MAX_5.in_observers(heap, current, new_observers, o) } (fun.SUM_AND_MAX_5.in_observers(heap, current, new_observers, o)) == (fun0.SUM_AND_MAX_5.in_observers(heap, current, new_observers, o))));

axiom ((forall h: HeapType, h': HeapType, current: ref, new_observers: Set (ref), o: ref :: { HeapSucc(h, h'), fun0.SUM_AND_MAX_5.in_observers(h, current, new_observers, o), fun0.SUM_AND_MAX_5.in_observers(h', current, new_observers, o) } ((HeapSucc(h, h')) && (pre.fun.SUM_AND_MAX_5.in_observers(h, current, new_observers, o)) && (pre.fun.SUM_AND_MAX_5.in_observers(h', current, new_observers, o)) && (same_inside(h, h', read.fun.SUM_AND_MAX_5.in_observers(h, current, new_observers, o)))) ==> ((fun0.SUM_AND_MAX_5.in_observers(h, current, new_observers, o)) == (fun0.SUM_AND_MAX_5.in_observers(h', current, new_observers, o)))));
...
function modify.SUM_AND_MAX_5.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T14> $o: ref, $f: Field T14 :: { modify.SUM_AND_MAX_5.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.SUM_AND_MAX_5.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.SUM_AND_MAX_5.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T15> $o: ref, $f: Field T15 :: { read.fun.SUM_AND_MAX_5.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.SUM_AND_MAX_5.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.SUM_AND_MAX_5.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool) {
  true
}

function trigger.fun.SUM_AND_MAX_5.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);
