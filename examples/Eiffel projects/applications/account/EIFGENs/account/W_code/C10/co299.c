...
extern EIF_TYPED_VALUE F299_5150(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F299_5153(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F299_5155(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F299_5150 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 298, Current, 0, 1, 12560);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(298, Current, 12560);
	RTCC(arg1, 298, l_feature_name, 1, RTWCT(3758, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {COLLECTION}.fill */
void F299_5153 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 298, Current, 1, 1, 12561);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(298, Current, 12561);
	{
		...
		RTCC(arg1, 298, l_feature_name, 1, typres0, 0x01);
	}
	RTIV(Current, RTAL);
...
void F299_5155 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 298, Current, 0, 1, 12562);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(298, Current, 12562);
	RTCC(arg1, 298, l_feature_name, 1, RTWCT(3758, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
