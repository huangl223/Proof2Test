/*
 * Code for class TYPED_INDEXABLE_ITERATION_CURSOR [TYPED_POINTER [ANY], G#2]
 */
...
extern EIF_TYPED_VALUE F330_4686(EIF_REFERENCE);
...
EIF_TYPED_VALUE F330_4686 (EIF_REFERENCE Current)
{
	GTCX
