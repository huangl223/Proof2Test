...
extern EIF_TYPED_VALUE F355_4686(EIF_REFERENCE);
...
EIF_TYPED_VALUE F355_4686 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 354, Current, 0, 0, 9788);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(354, Current, 9788);
	RTIV(Current, RTAL);
