...
extern EIF_TYPED_VALUE F407_4686(EIF_REFERENCE);
...
EIF_TYPED_VALUE F407_4686 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 406, Current, 0, 0, 9789);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(406, Current, 9789);
	RTIV(Current, RTAL);
