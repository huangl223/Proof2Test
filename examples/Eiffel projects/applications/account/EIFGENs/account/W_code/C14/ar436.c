...
extern void F436_4778(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F436_4779(EIF_REFERENCE);
extern EIF_TYPED_VALUE F436_4780(EIF_REFERENCE);
extern EIF_TYPED_VALUE F436_4781(EIF_REFERENCE);
extern EIF_TYPED_VALUE F436_4782(EIF_REFERENCE);
extern EIF_TYPED_VALUE F436_4783(EIF_REFERENCE);
...
void F436_4778 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 435, Current, 0, 1, 11347);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(435, Current, 11347);
	RTCC(arg1, 435, l_feature_name, 1, RTWCT(3968, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 3968, 0xF80001B4, 0); /* target */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(3968, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 3955, 0xF80001DB, 0); /* area */
...
EIF_TYPED_VALUE F436_4779 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F436_4780 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 435, Current, 0, 0, 11349);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(435, Current, 11349);
	RTIV(Current, RTAL);
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
...
EIF_TYPED_VALUE F436_4781 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 435, Current, 0, 0, 11350);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(435, Current, 11350);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr2 == tr1)) {
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(3938, 474))(Current)).it_b);
		tb1 = tb2;
	}
...
EIF_TYPED_VALUE F436_4782 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F436_4783 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
