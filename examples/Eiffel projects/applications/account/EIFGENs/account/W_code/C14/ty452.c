...
extern EIF_TYPED_VALUE F452_4686(EIF_REFERENCE);
...
EIF_TYPED_VALUE F452_4686 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 451, Current, 0, 0, 9790);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(451, Current, 9790);
	RTIV(Current, RTAL);
