...
extern void F482_4778(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F482_4779(EIF_REFERENCE);
extern EIF_TYPED_VALUE F482_4780(EIF_REFERENCE);
extern EIF_TYPED_VALUE F482_4781(EIF_REFERENCE);
extern EIF_TYPED_VALUE F482_4782(EIF_REFERENCE);
extern EIF_TYPED_VALUE F482_4783(EIF_REFERENCE);
...
void F482_4778 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 481, Current, 0, 1, 11353);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(481, Current, 11353);
	RTCC(arg1, 481, l_feature_name, 1, RTWCT(3968, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 3968, 0xF80001E2, 0); /* target */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(3968, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 3955, 0xF8000209, 0); /* area */
...
EIF_TYPED_VALUE F482_4779 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F482_4780 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 481, Current, 0, 0, 11355);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(481, Current, 11355);
	RTIV(Current, RTAL);
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
...
EIF_TYPED_VALUE F482_4781 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 481, Current, 0, 0, 11356);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(481, Current, 11356);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr2 == tr1)) {
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(3938, 520))(Current)).it_b);
		tb1 = tb2;
	}
...
EIF_TYPED_VALUE F482_4782 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F482_4783 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
