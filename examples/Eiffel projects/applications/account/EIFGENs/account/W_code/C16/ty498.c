...
extern EIF_TYPED_VALUE F498_4686(EIF_REFERENCE);
...
EIF_TYPED_VALUE F498_4686 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 497, Current, 0, 0, 9791);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(497, Current, 9791);
	RTIV(Current, RTAL);
