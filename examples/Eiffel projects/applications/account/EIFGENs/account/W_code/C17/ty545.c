...
extern EIF_TYPED_VALUE F545_4686(EIF_REFERENCE);
...
EIF_TYPED_VALUE F545_4686 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 544, Current, 0, 0, 9792);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(544, Current, 9792);
	RTIV(Current, RTAL);
