...
extern EIF_TYPED_VALUE F590_4686(EIF_REFERENCE);
...
EIF_TYPED_VALUE F590_4686 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 589, Current, 0, 0, 9793);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(589, Current, 9793);
	RTIV(Current, RTAL);
