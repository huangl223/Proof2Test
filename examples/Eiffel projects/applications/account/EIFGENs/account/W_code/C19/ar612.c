...
extern void F612_4760(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F612_4761(EIF_REFERENCE);
extern EIF_TYPED_VALUE F612_4762(EIF_REFERENCE);
extern EIF_TYPED_VALUE F612_4763(EIF_REFERENCE);
extern EIF_TYPED_VALUE F612_4764(EIF_REFERENCE);
extern EIF_TYPED_VALUE F612_4765(EIF_REFERENCE);
...
void F612_4760 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 611, Current, 0, 1, 11167);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(611, Current, 11167);
	RTCC(arg1, 611, l_feature_name, 1, RTWCT(3960, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 3960, 0xF800025A, 0); /* target */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
EIF_TYPED_VALUE F612_4761 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F612_4762 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 611, Current, 0, 0, 11169);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(611, Current, 11169);
	RTIV(Current, RTAL);
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
...
EIF_TYPED_VALUE F612_4763 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 611, Current, 0, 0, 11170);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(611, Current, 11170);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F612_4764 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F612_4765 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
