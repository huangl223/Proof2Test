...
extern EIF_TYPED_VALUE F37_1308(EIF_REFERENCE);
extern EIF_TYPED_VALUE F37_1309(EIF_REFERENCE);
extern EIF_TYPED_VALUE F37_1310(EIF_REFERENCE);
extern EIF_TYPED_VALUE F37_1311(EIF_REFERENCE);
extern EIF_TYPED_VALUE F37_1312(EIF_REFERENCE);
extern EIF_TYPED_VALUE F37_1313(EIF_REFERENCE);
extern EIF_TYPED_VALUE F37_1314(EIF_REFERENCE);
extern EIF_TYPED_VALUE F37_1315(EIF_REFERENCE);
...
EIF_TYPED_VALUE F37_1308 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F37_1308,1088,RTMS_EX_H("English",7,257590376));
}

/* {DATE_TIME_TOOLS}.days_text */
RTOID (F37_1309)
EIF_TYPED_VALUE F37_1309 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 36, Current, 0, 0, 1088);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(36, Current, 1088);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {425,0xFF01,268,0xFFFF};
		EIF_TYPE typres0;
...
RTOID (F37_1310)
EIF_TYPED_VALUE F37_1310 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 36, Current, 0, 0, 1089);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(36, Current, 1089);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000126, 0,0); /* Result */
...
RTOID (F37_1311)
EIF_TYPED_VALUE F37_1311 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 36, Current, 0, 0, 1090);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(36, Current, 1090);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000126, 0,0); /* Result */
...
RTOID (F37_1312)
EIF_TYPED_VALUE F37_1312 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 36, Current, 0, 0, 1091);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(36, Current, 1091);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000126, 0,0); /* Result */
...
EIF_TYPED_VALUE F37_1313 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F37_1313,1093,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
EIF_TYPED_VALUE F37_1314 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F37_1314,1094,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
EIF_TYPED_VALUE F37_1315 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F37_1315,1095,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}
