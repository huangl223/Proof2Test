...
extern EIF_TYPED_VALUE F637_4686(EIF_REFERENCE);
...
EIF_TYPED_VALUE F637_4686 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 636, Current, 0, 0, 9794);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(636, Current, 9794);
	RTIV(Current, RTAL);
