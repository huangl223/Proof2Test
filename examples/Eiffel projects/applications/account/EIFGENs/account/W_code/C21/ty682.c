...
extern EIF_TYPED_VALUE F682_4686(EIF_REFERENCE);
...
EIF_TYPED_VALUE F682_4686 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 681, Current, 0, 0, 9795);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(681, Current, 9795);
	RTIV(Current, RTAL);
