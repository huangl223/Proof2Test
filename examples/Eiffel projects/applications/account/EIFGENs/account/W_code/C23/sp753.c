...
extern void F753_4784(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F753_4785(EIF_REFERENCE);
extern EIF_TYPED_VALUE F753_4786(EIF_REFERENCE);
extern EIF_TYPED_VALUE F753_4787(EIF_REFERENCE);
...
void F753_4784 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 752, Current, 0, 1, 11551);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(752, Current, 11551);
	RTCC(arg1, 752, l_feature_name, 1, RTWCT(3955, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 3955, 0xF80002EF, 0); /* target */
	RTAR(Current, arg1);
...
EIF_TYPED_VALUE F753_4785 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F753_4786 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 752, Current, 0, 0, 11553);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(752, Current, 11553);
	RTIV(Current, RTAL);
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
...
EIF_TYPED_VALUE F753_4787 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
