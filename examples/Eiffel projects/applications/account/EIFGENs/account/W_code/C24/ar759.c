...
extern EIF_TYPED_VALUE F759_4779(EIF_REFERENCE);
extern EIF_TYPED_VALUE F759_4780(EIF_REFERENCE);
extern EIF_TYPED_VALUE F759_4781(EIF_REFERENCE);
extern EIF_TYPED_VALUE F759_4782(EIF_REFERENCE);
extern EIF_TYPED_VALUE F759_4783(EIF_REFERENCE);
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 758, Current, 0, 1, 11389);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(758, Current, 11389);
	RTCC(arg1, 758, l_feature_name, 1, RTWCT(3968, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 3968, 0xF80002F7, 0); /* target */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
EIF_TYPED_VALUE F759_4779 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F759_4780 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 758, Current, 0, 0, 11391);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(758, Current, 11391);
	RTIV(Current, RTAL);
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
...
EIF_TYPED_VALUE F759_4781 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 758, Current, 0, 0, 11392);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(758, Current, 11392);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F759_4782 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F759_4783 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
