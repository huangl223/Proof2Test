...
extern EIF_TYPED_VALUE F821_4686(EIF_REFERENCE);
...
EIF_TYPED_VALUE F821_4686 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 820, Current, 0, 0, 9798);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(820, Current, 9798);
	RTIV(Current, RTAL);
