...
extern EIF_TYPED_VALUE F867_4686(EIF_REFERENCE);
...
EIF_TYPED_VALUE F867_4686 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 866, Current, 0, 0, 9799);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(866, Current, 9799);
	RTIV(Current, RTAL);
