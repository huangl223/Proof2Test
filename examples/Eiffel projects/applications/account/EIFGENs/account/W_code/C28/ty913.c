...
extern EIF_TYPED_VALUE F913_4686(EIF_REFERENCE);
...
EIF_TYPED_VALUE F913_4686 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 912, Current, 0, 0, 9800);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(912, Current, 9800);
	RTIV(Current, RTAL);
