...
extern EIF_TYPED_VALUE F95_2026(EIF_REFERENCE);
...
RTOID (F95_2026)
EIF_TYPED_VALUE F95_2026 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 94, Current, 0, 0, 1672);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(94, Current, 1672);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
