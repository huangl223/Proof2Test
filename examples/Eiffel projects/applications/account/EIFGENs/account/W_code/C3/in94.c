...
extern EIF_TYPED_VALUE F94_2022(EIF_REFERENCE);
extern EIF_TYPED_VALUE F94_2023(EIF_REFERENCE);
extern EIF_TYPED_VALUE F94_2024(EIF_REFERENCE);
extern void F94_2025(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_local_host_name(EIF_POINTER);
...
EIF_TYPED_VALUE F94_2022 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 93, Current, 1, 0, 1668);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(93, Current, 1668);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
RTOID (F94_2023)
EIF_TYPED_VALUE F94_2023 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 93, Current, 0, 0, 1669);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(93, Current, 1669);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F94_2024)
EIF_TYPED_VALUE F94_2024 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 93, Current, 0, 0, 1670);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(93, Current, 1670);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF800008E, 0,0); /* Result */
...
void F94_2025 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 93, Current, 0, 1, 1671);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(93, Current, 1671);
