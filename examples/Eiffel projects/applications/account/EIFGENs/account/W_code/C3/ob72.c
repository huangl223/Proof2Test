...
extern EIF_TYPED_VALUE F72_1800(EIF_REFERENCE);
...
EIF_TYPED_VALUE F72_1800 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 71, Current, 0, 0, 1457);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(71, Current, 1457);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF8000474, 0,0); /* Result */
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,1140,0xFF05,0,0xFFFF};
		EIF_TYPE typres0;
