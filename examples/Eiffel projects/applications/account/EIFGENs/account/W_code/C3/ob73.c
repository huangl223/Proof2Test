...
extern EIF_TYPED_VALUE F73_1801(EIF_REFERENCE);
...
EIF_TYPED_VALUE F73_1801 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 72, Current, 0, 0, 1458);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(72, Current, 1458);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF8000709, 0,0); /* Result */
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,1801,0xFF05,0,0xFFFF};
		EIF_TYPE typres0;
	...
	ui4_1 = ti4_1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(4266, Dtype(tr1)))(tr1, ui4_1x);
	RTNHOOK(1,1);
