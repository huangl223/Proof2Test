...
extern EIF_TYPED_VALUE F959_4686(EIF_REFERENCE);
...
EIF_TYPED_VALUE F959_4686 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 958, Current, 0, 0, 9801);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(958, Current, 9801);
	RTIV(Current, RTAL);
