...
extern EIF_TYPED_VALUE F1004_4686(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1004_4686 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1003, Current, 0, 0, 9802);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1003, Current, 9802);
	RTIV(Current, RTAL);
