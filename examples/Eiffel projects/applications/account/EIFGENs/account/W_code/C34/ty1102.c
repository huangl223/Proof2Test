/*
 * Code for class TYPED_INDEXABLE_ITERATION_CURSOR [UTF_CONVERTER, G#2]
 */
...
extern EIF_TYPED_VALUE F1102_4686(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1102_4686 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1101, Current, 0, 0, 9804);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1101, Current, 9804);
	RTIV(Current, RTAL);
