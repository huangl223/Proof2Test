/*
 * Code for class ARRAYED_LIST_ITERATION_CURSOR [TYPED_POINTER [BOOLEAN]]
 */
...
extern void F1236_4760(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1236_4761(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1236_4762(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1236_4763(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1236_4764(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1236_4765(EIF_REFERENCE);
...
void F1236_4760 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1235, Current, 0, 1, 11245);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1235, Current, 11245);
	RTCC(arg1, 1235, l_feature_name, 1, RTWCT(3960, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 3960, 0xF80004CA, 0); /* target */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(3960, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 3955, 0xF80004D5, 0); /* area */
...
EIF_TYPED_VALUE F1236_4761 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F1236_4762 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1235, Current, 0, 0, 11247);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1235, Current, 11247);
	RTIV(Current, RTAL);
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
...
EIF_TYPED_VALUE F1236_4763 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1235, Current, 0, 0, 11248);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1235, Current, 11248);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr2 == tr1)) {
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(3938, 1236))(Current)).it_b);
		tb1 = tb2;
	}
...
EIF_TYPED_VALUE F1236_4764 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1236_4765 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
