/*
 * Code for class READABLE_INDEXABLE_ITERATION_CURSOR [TYPED_POINTER [INTEGER_8]]
 */
...
extern void F1262_4692(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1262_4693(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1262_4694(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1262_4695(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1262_4696(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1262_4697(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1262_4698(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1262_4699(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1262_4700(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1262_4701(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1262_4702(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1262_4703_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1262_4703(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1262_4704(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1262_4705(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1262_4706(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1262_4707(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1262_4708(EIF_REFERENCE);
extern void F1262_4709(EIF_REFERENCE);
extern void F1262_4710(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1262_4711(EIF_REFERENCE);
extern void F1262_4712(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1262_4713(EIF_REFERENCE);
...
void F1262_4692 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1261, Current, 1, 1, 10260);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1261, Current, 10260);
	RTCC(arg1, 1261, l_feature_name, 1, RTWCT(3948, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 3948, 0xF80004EB, 0); /* target */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
EIF_TYPED_VALUE F1262_4693 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1261, Current, 0, 0, 10261);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1261, Current, 10261);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
EIF_TYPED_VALUE F1262_4694 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F1262_4695 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F1262_4696 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F1262_4697 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F1262_4698 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1261, Current, 0, 0, 10266);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1261, Current, 10266);
	RTIV(Current, RTAL);
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
...
EIF_TYPED_VALUE F1262_4699 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1261, Current, 0, 0, 10267);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1261, Current, 10267);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF80004ED, 0,0); /* Result */
...
EIF_TYPED_VALUE F1262_4700 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1261, Current, 0, 1, 10268);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1261, Current, 10268);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("n_valid", EX_PRE);
...
EIF_TYPED_VALUE F1262_4701 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1261, Current, 0, 1, 10269);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1261, Current, 10269);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("n_valid", EX_PRE);
...
EIF_TYPED_VALUE F1262_4702 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1261, Current, 0, 1, 10270);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1261, Current, 10270);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
static EIF_TYPED_VALUE F1262_4703_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1261, Current, 0, 0, 10271);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1261, Current, 10271);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1262_4703 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_UINT32;
...
EIF_TYPED_VALUE F1262_4704 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1261, Current, 0, 0, 10272);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1261, Current, 10272);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("closed", EX_PRE);
...
EIF_TYPED_VALUE F1262_4705 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F1262_4706 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1261, Current, 1, 0, 10274);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1261, Current, 10274);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	tb1 = '\01';
...
EIF_TYPED_VALUE F1262_4707 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1261, Current, 0, 0, 10275);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1261, Current, 10275);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	tb1 = '\0';
...
EIF_TYPED_VALUE F1262_4708 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1261, Current, 0, 0, 10276);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1261, Current, 10276);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	tb1 = '\0';
...
void F1262_4709 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1261, Current, 0, 0, 10277);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1261, Current, 10277);
	RTIV(Current, RTAL);
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		tb2 = *(EIF_BOOLEAN *)(Current + RTWA(3949, dtype));
...
void F1262_4710 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 1261, Current, 0, 1, 10278);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1261, Current, 10278);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F1262_4711 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1261, Current, 1, 0, 10279);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1261, Current, 10279);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1262_4712 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1261, Current, 1, 0, 10258);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1261, Current, 10258);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
EIF_TYPED_VALUE F1262_4713 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
