/*
 * Code for class INDEXABLE_ITERATION_CURSOR [TYPED_POINTER [INTEGER_16]]
 */
...
extern void F1310_9513(EIF_REFERENCE, int);
...
void F1310_9513 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1309, Current, 0, 9512);
	RTSA(dtype);
	RTME(dtype, 0);
