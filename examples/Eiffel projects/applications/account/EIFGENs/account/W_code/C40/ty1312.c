/*
 * Code for class TYPED_INDEXABLE_ITERATION_CURSOR [TYPED_POINTER [INTEGER_16], G#2]
 */
...
extern EIF_TYPED_VALUE F1312_4686(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1312_4686 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1311, Current, 0, 0, 9808);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1311, Current, 9808);
	RTIV(Current, RTAL);
