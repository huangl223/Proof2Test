/*
 * Code for class ARRAYED_LIST_ITERATION_CURSOR [TYPED_POINTER [INTEGER_64]]
 */
...
extern void F1384_4760(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1384_4761(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1384_4762(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1384_4763(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1384_4764(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1384_4765(EIF_REFERENCE);
...
void F1384_4760 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1383, Current, 0, 1, 11263);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1383, Current, 11263);
	RTCC(arg1, 1383, l_feature_name, 1, RTWCT(3960, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 3960, 0xF800055E, 0); /* target */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
EIF_TYPED_VALUE F1384_4761 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F1384_4762 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1383, Current, 0, 0, 11265);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1383, Current, 11265);
	RTIV(Current, RTAL);
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
	...
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,1383,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
			EIF_TYPE l_type;
...
EIF_TYPED_VALUE F1384_4763 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1383, Current, 0, 0, 11266);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1383, Current, 11266);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1384_4764 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1384_4765 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
