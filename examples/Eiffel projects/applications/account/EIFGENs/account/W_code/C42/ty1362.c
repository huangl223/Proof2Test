/*
 * Code for class TYPED_INDEXABLE_ITERATION_CURSOR [TYPED_POINTER [INTEGER_64], G#2]
 */
...
extern EIF_TYPED_VALUE F1362_4686(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1362_4686 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1361, Current, 0, 0, 9809);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1361, Current, 9809);
	RTIV(Current, RTAL);
