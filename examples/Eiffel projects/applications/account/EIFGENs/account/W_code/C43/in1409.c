/*
 * Code for class INDEXABLE_ITERATION_CURSOR [TYPED_POINTER [NATURAL_8]]
 */
...
extern void F1409_9513(EIF_REFERENCE, int);
...
void F1409_9513 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1408, Current, 0, 9512);
	RTSA(dtype);
	RTME(dtype, 0);
