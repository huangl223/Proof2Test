/*
 * Code for class INDEXABLE_ITERATION_CURSOR [TYPED_POINTER [NATURAL_32]]
 */
...
extern void F1507_9513(EIF_REFERENCE, int);
...
void F1507_9513 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1506, Current, 0, 9512);
	RTSA(dtype);
	RTME(dtype, 0);
