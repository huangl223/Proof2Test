/*
 * Code for class TYPED_INDEXABLE_ITERATION_CURSOR [TYPED_POINTER [NATURAL_32], G#2]
 */
...
extern EIF_TYPED_VALUE F1509_4686(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1509_4686 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1508, Current, 0, 0, 9812);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1508, Current, 9812);
	RTIV(Current, RTAL);
