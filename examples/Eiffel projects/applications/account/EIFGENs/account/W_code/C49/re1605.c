/*
 * Code for class READABLE_INDEXABLE [TYPED_POINTER [REAL_32]]
 */
...
extern EIF_TYPED_VALUE F1605_6212(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1605_6215(EIF_REFERENCE);
extern void F1605_9527(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F1605_6212 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1604, Current, 0, 0, 14479);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1604, Current, 14479);
	RTIV(Current, RTAL);
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
...
EIF_TYPED_VALUE F1605_6215 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1604, Current, 0, 0, 14480);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1604, Current, 14480);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1605_9527 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1604, Current, 0, 9526);
	RTSA(dtype);
	RTME(dtype, 0);
