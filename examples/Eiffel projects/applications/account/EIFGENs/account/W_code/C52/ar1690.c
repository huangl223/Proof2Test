/*
 * Code for class ARRAY_ITERATION_CURSOR [TYPED_POINTER [CHARACTER_32]]
 */
...
extern void F1690_4778(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1690_4779(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1690_4780(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1690_4781(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1690_4782(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1690_4783(EIF_REFERENCE);
...
void F1690_4778 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1689, Current, 0, 1, 11503);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1689, Current, 11503);
	RTCC(arg1, 1689, l_feature_name, 1, RTWCT(3968, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 3968, 0xF800069A, 0); /* target */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(3968, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(3);
	...
	*(EIF_REFERENCE *)(Current + RTWA(3955, dtype)) = (EIF_REFERENCE) tr2;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 3969, 0x10000000, 1); /* first_index */
	ti4_1 = *(EIF_INTEGER_32 *)(arg1 + RTVA(5007, "lower", arg1));
	*(EIF_INTEGER_32 *)(Current + RTWA(3969, dtype)) = (EIF_INTEGER_32) ti4_1;
	RTHOOK(5);
	RTDBGAA(Current, dtype, 3958, 0x10000000, 1); /* area_last_index */
	ti4_1 = *(EIF_INTEGER_32 *)(arg1 + RTVA(5006, "upper", arg1));
	ti4_2 = *(EIF_INTEGER_32 *)(Current + RTWA(3969, dtype));
	*(EIF_INTEGER_32 *)(Current + RTWA(3958, dtype)) = (EIF_INTEGER_32) (EIF_INTEGER_32) (ti4_1 - ti4_2);
	if (RTAL & CK_ENSURE) {
		...
		ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(3969, dtype));
...
EIF_TYPED_VALUE F1690_4779 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(3969,Dtype(Current)));
	return r;
}


/* {ARRAY_ITERATION_CURSOR}.new_cursor */
EIF_TYPED_VALUE F1690_4780 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1689, Current, 0, 0, 11505);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1689, Current, 11505);
	RTIV(Current, RTAL);
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
	...
	tr4 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(3968, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	ur1 = RTCCL(tr4);
...
EIF_TYPED_VALUE F1690_4781 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1689, Current, 0, 0, 11506);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1689, Current, 11506);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1690_4782 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1690_4783 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
