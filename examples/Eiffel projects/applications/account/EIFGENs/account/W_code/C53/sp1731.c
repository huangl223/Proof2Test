/*
 * Code for class SPECIAL_ITERATION_CURSOR [TYPED_POINTER [CHARACTER_32]]
 */
...
extern void F1731_4784(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1731_4785(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1731_4786(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1731_4787(EIF_REFERENCE);
...
void F1731_4784 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1730, Current, 0, 1, 11631);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1730, Current, 11631);
	RTCC(arg1, 1730, l_feature_name, 1, RTWCT(3955, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 3955, 0xF80006C1, 0); /* target */
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(3955, dtype)) = (EIF_REFERENCE) arg1;
	RTHOOK(3);
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(3958, dtype)) = (EIF_INTEGER_32) ti4_1;
	if (RTAL & CK_ENSURE) {
		...
		ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(4786, "upper", arg1))(arg1)).it_i4);
		if ((EIF_BOOLEAN)(ti4_1 == ti4_2)) {
			RTCK;
		} else {
			RTCF;
...
EIF_TYPED_VALUE F1731_4785 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F1731_4786 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1730, Current, 0, 0, 11633);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1730, Current, 11633);
	RTIV(Current, RTAL);
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
	...
	tr4 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(3955, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	ur1 = tr4;
...
EIF_TYPED_VALUE F1731_4787 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
