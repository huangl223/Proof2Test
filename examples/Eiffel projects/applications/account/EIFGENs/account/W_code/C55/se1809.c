...
extern EIF_TYPED_VALUE F1809_5180(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1809_5180 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1808, Current, 0, 0, 12783);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1808, Current, 12783);
	RTIV(Current, RTAL);
	RTHOOK(1);
