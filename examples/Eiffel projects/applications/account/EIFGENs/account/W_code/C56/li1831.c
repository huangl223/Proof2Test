...
extern EIF_TYPED_VALUE F1831_4720(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1831_4721(EIF_REFERENCE);
extern void F1831_4722(EIF_REFERENCE);
extern void F1831_4723(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1831_4724(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1831_4725(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1831_4720 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1830, Current, 1, 0, 10536);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1830, Current, 10536);
	RTIV(Current, RTAL);
...
body:;
	...
	if (tb1) {
		...
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(3655, 353))(Current)).it_i4);
...
EIF_TYPED_VALUE F1831_4721 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1830, Current, 0, 0, 10537);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1830, Current, 10537);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("closed", EX_PRE);
...
body:;
	...
	if (tb1) {
		...
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(3656, 353))(Current)).it_b);
...
void F1831_4722 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1830, Current, 0, 0, 10538);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1830, Current, 10538);
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(3941, 353))(Current);
	RTHOOK(2);
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(3949, dtype));
	if ((EIF_BOOLEAN) !tb1) {
		RTHOOK(3);
		RTDBGAA(Current, dtype, 3954, 0xF8000725, 0); /* active */
...
void F1831_4723 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1830, Current, 3, 0, 10539);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1830, Current, 10539);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("valid_position", EX_PRE);
...
body:;
	...
	RTHOOK(4);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(3657, 353))(Current);
	RTHOOK(5);
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(3949, dtype));
	if ((EIF_BOOLEAN) !tb1) {
		RTHOOK(6);
...
EIF_TYPED_VALUE F1831_4724 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1831_4725 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
